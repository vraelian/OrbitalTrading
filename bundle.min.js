(()=>{var y=Object.freeze({MAP:"map",NAVIGATION:"navigation",SERVICES:"services",MARKET:"market",CARGO:"cargo",HANGAR:"hangar",MISSIONS:"missions",FINANCE:"finance",INTEL:"intel"}),M=Object.freeze({SHIP:"ship",STARPORT:"starport",DATA:"data"}),A=Object.freeze({WANDERER:"starter",STALWART:"hauler_c1",MULE:"hauler_c2",PATHFINDER:"explorer_b1",NOMAD:"explorer_b2",VINDICATOR:"frigate_a1",AEGIS:"frigate_a2",ODYSSEY:"luxury_s1",MAJESTIC:"luxury_s2",TITAN_HAULER:"rare_s1",VOID_CHASER:"rare_s2",GUARDIAN:"rare_s3",STARGAZER:"rare_s4",BEHEMOTH:"rare_o1"}),b=Object.freeze({WATER_ICE:"water_ice",PLASTEEL:"plasteel",HYDROPONICS:"hydroponics",CYBERNETICS:"cybernetics",PROPELLANT:"propellant",PROCESSORS:"processors",GMO_SEEDS:"gmo_seeds",CRYO_PODS:"cryo_pods",ATMO_PROCESSORS:"atmos_processors",CLONED_ORGANS:"cloned_organs",XENO_GEOLOGICALS:"xeno_geologicals",SENTIENT_AI:"sentient_ai",ANTIMATTER:"antimatter",FOLDED_DRIVES:"folded_drives"}),g=Object.freeze({EARTH:"loc_earth",LUNA:"loc_luna",MARS:"loc_mars",VENUS:"loc_venus",BELT:"loc_belt",SATURN:"loc_saturn",JUPITER:"loc_jupiter",URANUS:"loc_uranus",NEPTUNE:"loc_neptune",PLUTO:"loc_pluto",EXCHANGE:"loc_exchange",KEPLER:"loc_kepler"}),E=Object.freeze({TRADEMASTER:"trademaster",NAVIGATOR:"navigator",VENETIAN_SYNDICATE:"venetian_syndicate",MERCHANT_GUILD_SHIP:"merchant_guild_ship"}),v=Object.freeze({SET_SCREEN:"set-screen",TRAVEL:"travel",BUY_SHIP:"buy-ship",SELL_SHIP:"sell-ship",SELECT_SHIP:"select-ship",PAY_DEBT:"pay-debt",TAKE_LOAN:"take-loan",PURCHASE_INTEL:"purchase-intel",ACQUIRE_LICENSE:"acquire-license",BUY_ITEM:"buy-item",SELL_ITEM:"sell-item",SET_MAX_BUY:"set-max-buy",SET_MAX_SELL:"set-max-sell",INCREMENT:"increment",DECREMENT:"decrement",SHOW_PRICE_GRAPH:"show-price-graph",SHOW_FINANCE_GRAPH:"show-finance-graph",TOGGLE_MARKET_CARD_VIEW:"toggle-market-card-view",TOGGLE_HANGAR_MODE:"toggle-hangar-mode",SET_HANGAR_PAGE:"set-hangar-page"}),w=Object.freeze({SCREEN_LOAD:"SCREEN_LOAD",ACTION:"ACTION",INFO:"INFO"}),_=Object.freeze({STARTING_CREDITS:5e3,STARTING_DEBT_INTEREST:125,REPAIR_COST_PER_HP:75,REPAIR_AMOUNT_PER_TICK:5,FUEL_SCALAR:3,INTEREST_INTERVAL:30,PASSIVE_REPAIR_RATE:.02,HULL_DECAY_PER_TRAVEL_DAY:1/7,SHIP_SELL_MODIFIER:.75,RARE_SHIP_CHANCE:.3,PRICE_HISTORY_LENGTH:65,FINANCE_HISTORY_LENGTH:10,DAILY_PRICE_VOLATILITY:.15,MEAN_REVERSION_STRENGTH:.07,MARKET_PRESSURE_DECAY:.7,LOAN_GARNISHMENT_DAYS:1095,LOAN_GARNISHMENT_PERCENT:.14,RANDOM_EVENT_CHANCE:.07}),pe=[{threshold:5e4,revealsTier:2},{threshold:45e4,revealsTier:3},{threshold:4e6,revealsTier:4},{threshold:35e6,revealsTier:5},{threshold:3e8,revealsTier:6},{threshold:25e8,revealsTier:7}],be="orbitalTraderSave_v2";var Te={START_YEAR:2140,START_DAY_OF_WEEK:1,DAYS_IN_MONTH:[31,28,31,30,31,30,31,31,30,31,30,31],MONTH_NAMES:["January","February","March","April","May","June","July","August","September","October","November","December"],DAY_NAMES:["Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"]},Be={NEUTRAL:{name:"Neutral System",duration:28,description:"Standard space-faring conditions. Markets are operating under normal parameters.",modifiers:{}}},d={CONFIG:{INTEL_COST_PERCENTAGE:.2,INTEL_MIN_CREDITS:5e3,INTEL_CHANCE:.3,INTEL_DEMAND_MOD:1.8,INTEL_DEPRESSION_MOD:.5},SYSTEM_STATES:Be,DATE_CONFIG:Te,INTRO_SEQUENCE_V1:{modals:[{id:"lore_1",title:"Year 2140",description:'Humanity has expanded throughout the Solar System.<br><br> <span class="hl">Commerce</span> has thrived among the numerous colonies and stations longer than living memory.',buttonText:"Begin",contentClass:"text-center"},{id:"lore_2",title:"The Price of Freedom",description:"A dead-end job in the Belt pays the bills, but it does not offer the <b class='hl-green font-bold'>prosperity</b> that you dream of.<br><br>The <span class='hl'>Merchant's Guild</span> will fund your ambition, but their price is steep.<br><br>This is no simple loan; it's a bet on yourself and your future.",buttonText:"Apply for Loan",contentClass:"text-center",buttonClass:"btn-pulse-green"},{id:"charter",title:`<span class="hl">MERCHANT'S GUILD LOAN AGREEMENT</span>`,description:`
        ...
        <div id="ship-terminal-container" class="flex flex-col h-full ${n}">
            ...
            <div class="carousel-container flex-grow overflow-hidden relative">
                <div id="hangar-carousel" class="flex h-full" style="transform: translateX(-${c*100}%)">
                    ${r.map(u=>Ye(o,u,s)).join("")||Ue(s)}
                </div>
            </div>

            <div id="hangar-pagination" class="flex justify-center items-center p-2 space-x-2 flex-nowrap overflow-x-auto">
                ${r.map((u,h)=>`<div class="pagination-dot w-2 h-2 rounded-full bg-gray-600 transition-all duration-300 ${h===c?"active":""}" data-action="${v.SET_HANGAR_PAGE}" data-index="${h}"></div>`).join("")}
            </div>
        </div>
    ...
    `}function Ye(o,e,t){let i=d.SHIPS[e],a=t?o.player.shipStates[e]:null,{player:s}=o,n="";if(t){let c=s.activeShipId===e;n=`<div class="status-badge" style="border-color: ${c?"var(--theme-color-primary)":"var(--ot-border-light)"}; color: ${c?"var(--theme-color-primary)":"var(--ot-text-secondary)"};">${c?"ACTIVE":"STORED"}</div>`}let r=`
    ...
    `}function Me(o,e,t,i,a,s){let n=t.class.toLowerCase();return s?`
        ...
        `}function _e(o,e,t,i,a){if(i){let s=t.activeShipId===o,n=t.ownedShipIds.length>1&&!s,r=Math.floor(e.price*_.SHIP_SELL_MODIFIER);return`
            <div class="grid grid-cols-2 gap-2">
                <button class="action-button" data-action="${v.SELECT_SHIP}" data-ship-id="${o}" ${s?"disabled":""} style="background-color: ${s?"#374151":"var(--ot-cyan-base)"}; color: ${s?"var(--ot-text-secondary)":"var(--ot-bg-dark)"};">
                    <span class="font-bold">${s?"ACTIVE":"BOARD"}</span>
                </button>
                <button class="action-button" data-action="${v.SELL_SHIP}" data-ship-id="${o}" ${n?"":"disabled"} style="background-color: var(--ot-hangar-red-base);">
        ...
        `}else{let s=t.credits>=e.price,n=a.activeBatchId?d.TUTORIAL_DATA[a.activeBatchId]?.steps.find(c=>c.stepId===a.activeStepId):null,r=a.activeBatchId==="intro_hangar"&&!n?.unlockPurchase,l=!s||r;return`
            <button class="action-button w-full justify-center" data-action="${v.BUY_SHIP}" data-ship-id="${o}" ${l?"disabled":""} style="background-color: var(--ot-green-accent);">
    ...
    `}function Se(o,e){return`
        <div class="spec-card">
            <p class="text-xs text-gray-400">${o}</p>
            <p class="text-lg font-bold font-orbitron">${e}</p>
        </div>
    `}function Ce(o,e,t,i){return`<div class="scroll-panel">
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">${d.COMMODITIES.filter(n=>n.tier<=o.player.revealedTier).map(n=>Ve(n,o,t,i)).join("")}</div>
            </div>`}function Ve(o,e,t,i){let{player:a,market:s,currentLocationId:n,tutorials:r,uiState:l}=e,c=a.inventories[a.activeShipId]?.[o.id],u=t(e,o.id),h=t(e,o.id,!0),m=s.galacticAverages[o.id],p=s.inventory[n]?.[o.id],f=!o.licenseId||a.unlockedLicenseIds.includes(o.licenseId),T=r.activeBatchId==="intro_missions"&&r.activeStepId==="mission_2_2",I=r.activeBatchId==="intro_missions"&&r.activeStepId==="mission_2_3",R=T&&o.id!==b.PLASTEEL||I,x=`data-tooltip="${o.lore}"`,P=c&&c.quantity>0?c.quantity:"0",G=l.marketCardMinimized[o.id],L=U({price:u,sellPrice:h,galacticAvg:m,playerItem:c}),O=c&&c.quantity>0?`<div class="avg-cost-display" id="avg-cost-${o.id}">Avg. Cost: ${S(c.avgCost,!1)}</div>`:"",C;f?C=`
            ...
            <div class="transaction-controls absolute inset-0 flex items-center justify-center p-4">
                <button class="btn w-full h-full text-center" data-action="${v.ACQUIRE_LICENSE}" data-license-id="${o.licenseId}">Acquire License</button>
    ...
    <div class="item-card-container ${f?"":"locked"} ${G?"minimized":""}" id="item-card-container-${o.id}">
        <div class="rounded-lg border ${o.styleClass} transition-colors shadow-md">
            <button class="card-toggle-btn" data-action="${v.TOGGLE_MARKET_CARD_VIEW}" data-good-id="${o.id}">${G?"+":"\u2212"}</button>
            
            <div class="max-view-content">
                <p class="font-bold commodity-name"><span class="commodity-name-tooltip" ${x}>${o.name}</span></p>
                <p class="avail-text">Avail: <span id="m-stock-${o.id}">${p.quantity}</span>, Own: <span id="p-inv-${o.id}">${P}</span></p>
                <p id="price-display-${o.id}" class="font-roboto-mono font-bold price-text" data-action="${v.SHOW_PRICE_GRAPH}" data-good-id="${o.id}" data-base-price="${u}">${S(u)}</p>
        ...
        <div class="services-scroll-panel">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl mx-auto mt-8">
                ...
                <div class="p-4 rounded-lg text-center shadow-lg panel-border border" style="border-color: ${n.borderColor}; color: ${n.textColor}; background: ${n.gradient};">
                    ...
                    <p class="mb-3">Price: <span class="font-bold">\u232C ${S(l,!1)}</span> / 5% repair</p>
    ...
    `}function Oe(o,e){let t=q(o.styleClass),a={RAW:"Raw Material",IND:"Industrial Product",AGRI:"Agricultural Good",TECH:"Technology",CIV:"Civilian Commodity",BIO:"Bioware",RARE:"Exotic Material"}[o.cat]||"Unknown",n=(o.basePriceRange[0]+o.basePriceRange[1])/2*e.quantity;return`
    ...
    `}function De(o){let{player:e,day:t,currentLocationId:i}=o,s=d.MARKETS.find(l=>l.id===i)?.navTheme||{gradient:"linear-gradient(135deg, #4a5568, #2d3748)",textColor:"#f0f0f0",borderColor:"#7a9ac0"},n;if(e.debt>0){let l="";if(e.loanStartDate){let c=_.LOAN_GARNISHMENT_DAYS-(t-e.loanStartDate);c>0&&(l=`<p class="text-xs text-red-400/70 mt-2">Garnishment in ${c} days</p>`)}n=`
            <div>
                ...
                <div class="p-4 rounded-lg flex flex-col items-center justify-center space-y-2 shadow-lg panel-border border text-center" style="border-color: ${s.borderColor}; color: ${s.textColor}; background: ${s.gradient};">
                    <button data-action="${v.PAY_DEBT}" class="btn w-full py-2 bg-red-800/80 hover:bg-red-700/80 border-red-500 font-roboto-mono" ${e.credits>=e.debt?"":"disabled"}>
                        Pay Off ${S(e.debt)}
                    </button>
                    ${l}
                </div>
            </div>`}else{let l=Math.floor(e.credits*3.5),c=Math.floor(l*.1),u=Math.floor(l*.04),m=[{key:"10000",amount:1e4,fee:600,interest:500},{key:"dynamic",...{amount:l,fee:c,interest:u}}].map(p=>`<button class="btn btn-loan w-full p-2 mt-2" data-action="${v.TAKE_LOAN}" data-loan-details='${JSON.stringify(p)}' ${e.credits<p.fee?"disabled":""}>
            ...
            <div class="grid grid-cols-4 gap-2 p-2 border-b border-slate-700 text-sm">
                ...
                <span class="${c} text-right">${u}${S(l.amount,!1)}</span>
            </div>
        `}).join("");return`
    ...
    `}function $e(){return`
        <div class="intel-scroll-panel">
            ...
            <div class="context-bar" style="background: ${T.gradient}; color: ${T.textColor};">
            ...
            </div>`,R=Object.keys(this.navStructure).map(L=>{let O=L===a,C=n[L]||Object.keys(this.navStructure[L].screens)[0],D=u&&u.navId!==L;return`<div class="tab ${O?"active":""} ${r||D?"disabled":""}" data-action="${v.SET_SCREEN}" data-nav-id="${L}" data-screen-id="${C}">${this.navStructure[L].label}</div>`}).join(""),x="";if(m&&p&&f){let L=N(f),O=p.health/m.maxHealth*100,C=p.fuel/m.maxFuel*100,D=L/m.cargoCapacity*100;x=`
                ...
                </div>`}else{let u=a.shipStates[t],h=a.inventories[t],m=N(h),p=t===a.activeShipId,f=a.ownedShipIds.length>1&&!p,T=Math.floor(n.price*_.SHIP_SELL_MODIFIER);r=`
                <div class="ship-card p-4 flex flex-col space-y-3 ${p?"border-yellow-400":""}">
                    ...
                    <div class="grid grid-cols-2 gap-2 mt-2">
                        ...
                        <button class="btn" data-action="${v.SELL_SHIP}" data-ship-id="${t}" ${f?"":"disabled"}>Sell<br>\u232C ${S(T,!1)}</button>
                    </div>
                </div>`}let l=this.cache.shipDetailModal,c=l.querySelector("#ship-detail-content");c.innerHTML=r,l.classList.remove("hidden"),l.classList.add("modal-visible")}showLaunchModal(e){let t=this.lastKnownState;if(!t)return;let i=d.MARKETS.find(p=>p.id===e);if(!i)return;let a=i.navTheme,s=t.TRAVEL_DATA[t.currentLocationId]?.[e],n=t.player.shipStates[t.player.activeShipId];if(!s)return;let r=Object.entries(i.availabilityModifier||{}).map(([p,f])=>({id:p,modifier:f,name:d.COMMODITIES.find(T=>T.id===p)?.name})).filter(p=>p.name),l=r.filter(p=>p.modifier<1).sort((p,f)=>p.modifier-f.modifier).slice(0,2).map(p=>`<span class="commodity-name">${p.name}</span>`),c=r.filter(p=>p.modifier>1).sort((p,f)=>f.modifier-p.modifier).slice(0,2).map(p=>`<span class="commodity-name">${p.name}</span>`),u="";l.length>0&&(u+=`<div class="intel-section"><b style="color: ${a.textColor};">Imports:</b>${l.join("")}</div>`),c.length>0&&(u+=`<div class="intel-section"><b style="color: ${a.textColor};">Exports:</b>${c.join("")}</div>`),u===""&&(u='<p class="text-center">Market data is unreliable.</p>');let h=`
            <div class="launch-modal-wrapper panel-border modal-content" style="background: ${a.gradient}; color: ${a.textColor}; border-color: ${a.borderColor};">
                <div class="flex-shrink-0">
                    <h3 class="font-orbitron">${i.name}</h3>
                    <p class="flavor-text italic">${i.launchFlavor}</p>
                </div>
                <div class="border-t border-b py-2 space-y-2" style="border-color: ${a.borderColor}50;">
                    ${u}
                </div>
        ...
        `;a.innerHTML=c,i.classList.remove("hidden"),requestAnimationFrame(()=>{i.classList.add("modal-visible")});let u=h=>{(!h.target.closest(".modal-content")||h.target.closest('[data-action="close-map-modal"]'))&&(this.hideMapDetailModal(),i.removeEventListener("click",u))};i.addEventListener("click",u)}hideMapDetailModal(){this.hideModal("map-detail-modal")}};var se=class{constructor(e,t,i,a){this.gameState=e,this.simulationService=t,this.uiManager=i,this.tutorialService=a}handle(e,t){let i=this.gameState.getState();if(t.hasAttribute("disabled"))return;let{action:a,...s}=t.dataset,n=null;switch(a){case v.BUY_SHIP:{let{shipId:r}=s;if(!r)return;e.stopPropagation(),this.simulationService.buyShip(r,e),n={type:"ACTION",action:v.BUY_SHIP};break}case v.SELL_SHIP:{let{shipId:r}=s;if(!r)return;e.stopPropagation(),this.simulationService.sellShip(r,e);break}case v.SELECT_SHIP:{let{shipId:r}=s;if(!r)return;this.simulationService.setActiveShip(r),n={type:"ACTION",action:v.SELECT_SHIP};break}case v.TOGGLE_HANGAR_MODE:s.mode&&this.gameState.uiState.hangarShipyardToggleState!==s.mode&&(this.gameState.uiState.hangarShipyardToggleState=s.mode,this.gameState.setState({}));break;case v.SET_HANGAR_PAGE:{let r=parseInt(s.index,10),l=this.gameState.uiState.hangarShipyardToggleState==="hangar",c=document.getElementById("hangar-carousel");if(c){let u=l?this.gameState.uiState.hangarActiveIndex:this.gameState.uiState.shipyardActiveIndex,h=Math.abs(r-u),m=Math.min(.8,.2+h*.1);c.style.transitionDuration=`${m}s`,this.simulationService.setHangarCarouselIndex(r,l?"hangar":"shipyard"),setTimeout(()=>{c&&(c.style.transitionDuration="")},m*1e3)}else this.simulationService.setHangarCarouselIndex(r,l?"hangar":"shipyard");break}case v.SET_SCREEN:s.navId===i.activeNav&&t.tagName==="DIV"?(this.gameState.subNavCollapsed=!this.gameState.subNavCollapsed,this.uiManager.render(this.gameState.getState())):(this.gameState.subNavCollapsed=!1,this.simulationService.setScreen(s.navId,s.screenId)),n={type:"ACTION",action:v.SET_SCREEN,navId:s.navId,screenId:s.screenId};break;case v.TRAVEL:this.uiManager.hideModal("launch-modal"),this.simulationService.travelTo(s.locationId),n={type:"ACTION",action:v.TRAVEL};break;case"show-mission-modal":this.uiManager.showMissionModal(s.missionId),n={type:"ACTION",action:"show-mission-modal"};break;case"show_cargo_detail":this.uiManager.showCargoDetailModal(i,s.goodId);break;case"show-launch-modal":this.uiManager.showLaunchModal(s.locationId);break;case"show-map-modal":this.uiManager.showMapDetailModal(s.locationId);break;case"close-map-modal":this.uiManager.hideMapDetailModal();break;case"accept-mission":this.simulationService.missionService.acceptMission(s.missionId),this.uiManager.hideModal("mission-modal"),n={type:"ACTION",action:"accept-mission",missionId:s.missionId};break;case"abandon-mission":this.simulationService.missionService.abandonMission(),this.uiManager.hideModal("mission-modal");break;case"complete-mission":this.simulationService.missionService.completeActiveMission(),this.uiManager.hideModal("mission-modal"),n={type:"ACTION",action:"complete-mission"};break;case v.PAY_DEBT:this.simulationService.payOffDebt();break;case v.TAKE_LOAN:this.simulationService.takeLoan(JSON.parse(s.loanDetails));break;case v.PURCHASE_INTEL:this.simulationService.purchaseIntel(parseInt(s.cost));break;case v.ACQUIRE_LICENSE:this._handleAcquireLicense(s.licenseId);break;case v.TOGGLE_MARKET_CARD_VIEW:s.goodId&&(this.gameState.uiState.marketCardMinimized[s.goodId]=!this.gameState.uiState.marketCardMinimized[s.goodId],this.gameState.setState({}));break}n&&this.tutorialService.checkState(n)}_handleAcquireLicense(e){let t=d.LICENSES[e];if(t)if(t.type==="purchase"){let i=`${t.description}<br><br>Cost: <b class='hl-yellow'>${formatCredits(t.cost)}</b>`;this.uiManager.queueModal("event-modal",`Purchase ${t.name}?`,i,null,{customSetup:(a,s)=>{let n=a.querySelector("#event-button-container");n.innerHTML=`
