(()=>{var S=Object.freeze({STATUS:"status",NAVIGATION:"navigation",SERVICES:"services",MARKET:"market",CARGO:"cargo",HANGAR:"hangar",MISSIONS:"missions",FINANCE:"finance",INTEL:"intel"}),R=Object.freeze({SHIP:"ship",STARPORT:"starport",DATA:"data"}),A=Object.freeze({WANDERER:"starter",STALWART:"hauler_c1",MULE:"hauler_c2",PATHFINDER:"explorer_b1",NOMAD:"explorer_b2",VINDICATOR:"frigate_a1",AEGIS:"frigate_a2",ODYSSEY:"luxury_s1",MAJESTIC:"luxury_s2",TITAN_HAULER:"rare_s1",VOID_CHASER:"rare_s2",GUARDIAN:"rare_s3",STARGAZER:"rare_s4",BEHEMOTH:"rare_o1"}),L=Object.freeze({WATER_ICE:"water_ice",PLASTEEL:"plasteel",HYDROPONICS:"hydroponics",CYBERNETICS:"cybernetics",PROPELLANT:"propellant",PROCESSORS:"processors",GMO_SEEDS:"gmo_seeds",CRYO_PODS:"cryo_pods",ATMO_PROCESSORS:"atmos_processors",CLONED_ORGANS:"cloned_organs",XENO_GEOLOGICALS:"xeno_geologicals",SENTIENT_AI:"sentient_ai",ANTIMATTER:"antimatter",FOLDED_DRIVES:"folded_drives"}),y=Object.freeze({EARTH:"loc_earth",LUNA:"loc_luna",MARS:"loc_mars",VENUS:"loc_venus",BELT:"loc_belt",SATURN:"loc_saturn",JUPITER:"loc_jupiter",URANUS:"loc_uranus",NEPTUNE:"loc_neptune",PLUTO:"loc_pluto",EXCHANGE:"loc_exchange",KEPLER:"loc_kepler"}),M=Object.freeze({TRADEMASTER:"trademaster",NAVIGATOR:"navigator",VENETIAN_SYNDICATE:"venetian_syndicate",MERCHANT_GUILD_SHIP:"merchant_guild_ship"}),b=Object.freeze({SET_SCREEN:"set-screen",TRAVEL:"travel",BUY_SHIP:"buy-ship",SELL_SHIP:"sell-ship",SELECT_SHIP:"select-ship",PAY_DEBT:"pay-debt",TAKE_LOAN:"take-loan",PURCHASE_INTEL:"purchase-intel",ACQUIRE_LICENSE:"acquire-license",BUY_ITEM:"buy-item",SELL_ITEM:"sell-item",SET_MAX_BUY:"set-max-buy",SET_MAX_SELL:"set-max-sell",INCREMENT:"increment",DECREMENT:"decrement",SHOW_PRICE_GRAPH:"show-price-graph",SHOW_FINANCE_GRAPH:"show-finance-graph",TOGGLE_MARKET_CARD_VIEW:"toggle-market-card-view"}),D=Object.freeze({SCREEN_LOAD:"SCREEN_LOAD",ACTION:"ACTION",INFO:"INFO"}),k=Object.freeze({STARTING_CREDITS:5e3,STARTING_DEBT_INTEREST:125,REPAIR_COST_PER_HP:75,REPAIR_AMOUNT_PER_TICK:5,FUEL_SCALAR:3,INTEREST_INTERVAL:30,PASSIVE_REPAIR_RATE:.02,HULL_DECAY_PER_TRAVEL_DAY:1/7,SHIP_SELL_MODIFIER:.75,RARE_SHIP_CHANCE:.3,PRICE_HISTORY_LENGTH:65,FINANCE_HISTORY_LENGTH:10,DAILY_PRICE_VOLATILITY:.15,MEAN_REVERSION_STRENGTH:.07,MARKET_PRESSURE_DECAY:.7,LOAN_GARNISHMENT_DAYS:1095,LOAN_GARNISHMENT_PERCENT:.14,RANDOM_EVENT_CHANCE:.07}),ce=[{threshold:5e4,revealsTier:2},{threshold:45e4,revealsTier:3},{threshold:4e6,revealsTier:4},{threshold:35e6,revealsTier:5},{threshold:3e8,revealsTier:6},{threshold:25e8,revealsTier:7}];var me="orbitalTraderSave_v2";var F={START_YEAR:2140,START_DAY_OF_WEEK:1,DAYS_IN_MONTH:[31,28,31,30,31,30,31,31,30,31,30,31],MONTH_NAMES:["January","February","March","April","May","June","July","August","September","October","November","December"],DAY_NAMES:["Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"]},Re={NEUTRAL:{name:"Neutral System",duration:28,description:"Standard space-faring conditions. Markets are operating under normal parameters.",modifiers:{}}},d={CONFIG:{INTEL_COST_PERCENTAGE:.2,INTEL_MIN_CREDITS:5e3,INTEL_CHANCE:.3,INTEL_DEMAND_MOD:1.8,INTEL_DEPRESSION_MOD:.5},SYSTEM_STATES:Re,DATE_CONFIG:F,INTRO_SEQUENCE_V1:{modals:[{id:"lore_1",title:"Year 2140",description:'Humanity has expanded throughout the Solar System.<br><br> <span class="hl">Commerce</span> has thrived among the numerous colonies and stations longer than living memory.',buttonText:"Begin",contentClass:"text-center"},{id:"lore_2",title:"The Price of Freedom",description:"A dead-end job in the Belt pays the bills, but it does not offer the <b class='hl-green font-bold'>prosperity</b> that you dream of.<br><br>The <span class='hl'>Merchant's Guild</span> will fund your ambition, but their price is steep.<br><br>This is no simple loan; it's a bet on yourself and your future.",buttonText:"Apply for Loan",contentClass:"text-center",buttonClass:"btn-pulse-green"},{id:"charter",title:`<span class="hl">MERCHANT'S GUILD LOAN AGREEMENT</span>`,description:`
        ...
        </div>`}function ve(c,e,t){let{player:i,tutorials:a}=c,s=d.SHIPS[e],o=s.class.toLowerCase(),r=`
        <div class="ship-info">
            <span class="ship-name class-${o}">${s.name}</span>
            <span class="ship-class">Class ${s.class}</span>
        </div>`,n="",l="",h="",u=`ship-bar-wrapper bg-class-${o} class-${o}`;if(t==="shipyard"){let p=i.credits>=s.price,m=a.activeBatchId==="intro_hangar"&&a.activeStepId==="hangar_1";(!p||m)&&(u+=" opacity-60 pointer-events-none"),n=`<div class="ship-price">${g(s.price)}</div>`}else{let p=i.shipStates[e],m=i.inventories[e],f=O(m),T=f/s.cargoCapacity*100,E=Math.floor(p.health/s.maxHealth*100),C=Math.floor(p.fuel/s.maxFuel*100),_=e===i.activeShipId;h=`<div class="status-sidelabel ${_?"sidelabel-active":"sidelabel-stored"}">${_?"ACTIVE":"STORED"}</div>`,n=`
            <div class="ship-stats-text">
                <span class="stat-hull">HULL: <span class="value">${E}%</span></span>
                <span class="stat-fuel">FUEL: <span class="value">${C}%</span></span>
            </div>`,l=`
            <div class="bottom-line">
                <div class="cargo-bar">${Array.from({length:Math.max(10,Math.min(25,Math.floor(s.cargoCapacity/8)))},(B,v)=>{let x=Math.round(f/s.cargoCapacity*Math.max(10,Math.min(25,Math.floor(s.cargoCapacity/8))));return`<div class="segment ${v<x?"filled":""}"></div>`}).join("")}</div>
        ...
        </div>`}function we(c){let{player:e,currentLocationId:t,market:i,introSequenceActive:a}=c;return a?e.ownedShipIds.length>0?[]:[A.WANDERER,A.STALWART,A.MULE].map(o=>[o,d.SHIPS[o]]):(i.shipyardStock[t]?.shipsForSale||[]).map(o=>[o,d.SHIPS[o]]).filter(([o,r])=>!e.ownedShipIds.includes(o))}function de(c,e,t,i){return`<div class="grid grid-cols-1 lg:grid-cols-2 gap-4">${d.COMMODITIES.filter(o=>o.tier<=c.player.revealedTier).map(o=>$e(o,c,t,i)).join("")}</div>`}function $e(c,e,t,i){let{player:a,market:s,currentLocationId:o,tutorials:r,uiState:n}=e,l=a.inventories[a.activeShipId]?.[c.id],h=t(e,c.id),u=t(e,c.id,!0),p=s.galacticAverages[c.id],m=s.inventory[o]?.[c.id],f=!c.licenseId||a.unlockedLicenseIds.includes(c.licenseId),T=r.activeBatchId==="intro_missions"&&r.activeStepId==="mission_2_2",E=r.activeBatchId==="intro_missions"&&r.activeStepId==="mission_2_3",C=T&&c.id!==L.PLASTEEL||E,_=`data-tooltip="${c.lore}"`,N=l&&l.quantity>0?l.quantity:"0",B=n.marketCardMinimized[c.id],v=z({price:h,sellPrice:u,galacticAvg:p,playerItem:l}),x=l&&l.quantity>0?`<div class="avg-cost-display" id="avg-cost-${c.id}">Avg. Cost: ${g(l.avgCost,!1)}</div>`:"",I;f?I=`
             <div class="transaction-controls" data-mode="${i[c.id]?.mode||"buy"}" data-good-id="${c.id}" ${C?"disabled":""}>
    ...
    </div>`}function Te(c){let{player:e,day:t,currentLocationId:i}=c,a=d.SHIPS[e.activeShipId],s=e.shipStates[e.activeShipId],o=e.inventories[e.activeShipId],r=O(o),l=d.MARKETS.find(T=>T.id===i)?.navTheme||{gradient:"linear-gradient(135deg, #4a5568, #2d3748)",textColor:"#f0f0f0",borderColor:"#7a9ac0"},h=a.class.toLowerCase(),u=Math.floor(s.health/a.maxHealth*100),p=Math.floor(s.fuel/a.maxFuel*100),m=Array.from({length:Math.max(10,Math.min(25,Math.floor(a.cargoCapacity/8)))},(T,E)=>{let C=Math.round(r/a.cargoCapacity*Math.max(10,Math.min(25,Math.floor(a.cargoCapacity/8))));return`<div class="segment ${E<C?"filled":""}"></div>`}).join(""),f=`
    ...
    `;return`
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 bg-black/30 p-4 rounded-lg mb-6 items-start">
            <div class="md:col-span-2 h-full p-4 rounded-lg flex items-center justify-between transition-all duration-500 panel-border border" style="border-color: ${l.borderColor}; color: ${l.textColor}; background: ${l.gradient};">
                ...
                <div class="text-right flex flex-col items-end">
                    <p class="text-xs font-roboto-mono text-right" style="color: ${l.textColor}cc;">${ge(t)}</p>
        ...
        </div>`}function Ie(c){let{player:e,currentLocationId:t,TRAVEL_DATA:i,tutorials:a}=c,{navLock:s}=a,o=s&&s.screenId===S.NAVIGATION,r=o?s.enabledElementQuery:null;return`
        <div class="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-6">
        ${d.MARKETS.filter(n=>e.unlockedLocationIds.includes(n.id)).map(n=>{let l=n.id===t,h=l?null:i[t][n.id],u=!1;if(o&&r){let m=document.createElement("div");m.innerHTML=`<div data-location-id="${n.id}"></div>`,u=!m.querySelector(r)}let p=u?"disabled-location":"";return`<div class="location-card p-6 rounded-lg text-center flex flex-col ${l?"highlight-current":""} ${n.color} ${n.bg} ${p}" 
...
Avg. Cost: ${g(n.avgCost,!1)}`;return`
    ...
    `}function _e(c){let{player:e,day:t,currentLocationId:i}=c,s=d.MARKETS.find(n=>n.id===i)?.navTheme||{gradient:"linear-gradient(135deg, #4a5568, #2d3748)",textColor:"#f0f0f0",borderColor:"#7a9ac0"},o;if(e.debt>0){let n="";if(e.loanStartDate){let l=k.LOAN_GARNISHMENT_DAYS-(t-e.loanStartDate);l>0&&(n=`<p class="text-xs text-red-400/70 mt-2">Garnishment in ${l} days</p>`)}o=`
            <div>
    ...
    `}function Ce(){return`
        <div class="text-center p-8 flex flex-col items-center gap-4">
            ...
            <div class="context-bar" style="background: ${T.gradient}; color: ${T.textColor};">
            ...
            </div>`,C=Object.keys(this.navStructure).map(v=>{let x=v===a,I=o[v]||Object.keys(this.navStructure[v].screens)[0],w=h&&h.navId!==v,$=r||w,P=x?`background: ${T.gradient}; color: ${T.textColor};`:"";return`<div class="tab ${v}-tab ${x?"active":""} ${$?"disabled":""}" style="${P}" data-action="${b.SET_SCREEN}" data-nav-id="${v}" data-screen-id="${I}">${this.navStructure[v].label}</div>`}).join(""),_="";if(p&&m&&f){let v=O(f),x=m.health/p.maxHealth*100,I=m.fuel/p.maxFuel*100,w=v/p.cargoCapacity*100;_=`
                <div class="status-pod">
                    <div class="status-bar-group hull-group" data-action="toggle-tooltip">
                        <span class="status-bar-label">H</span>
                        <div class="status-bar"><div class="fill hull-fill" style="width: ${x}%;"></div></div>
                ...
                </div>`}let N=`<div class="nav-wrapper">${C}${_}</div>`,B=Object.keys(this.navStructure).map(v=>{let x=this.navStructure[v].screens,I=v===a,w=Object.keys(x).map($=>{let P=h&&h.screenId!==$,q=$===s,H=r||P,j=`style="color: ${T.textColor};"`;return q&&(j=`style="background: ${T.gradient}; color: ${T.textColor}; opacity: 1; font-weight: 700;"`),`<a href="#" class="${H?"disabled":""}" ${j} data-action="${b.SET_SCREEN}" data-nav-id="${v}" data-screen-id="${$}" draggable="false">${x[$]}</a>`}).join("");return`<div class="nav-sub ${!I||l?"hidden":""}" id="${v}-sub">${w}</div>`}).join("");this.cache.navBar.innerHTML=E+N,this.cache.subNavBar.innerHTML=B}renderActiveScreen(e){let t=this.cache[`${e.activeScreen}Screen`];switch(this.lastActiveScreenEl&&this.lastActiveScreenEl!==t&&(this.lastActiveScreenEl.style.display="none"),t&&(t.style.display="block",this.lastActiveScreenEl=t),e.activeScreen){case S.STATUS:this.cache.statusScreen.innerHTML=Te(e);break;case S.NAVIGATION:this.cache.navigationScreen.innerHTML=Ie(e);break;case S.SERVICES:this.cache.servicesScreen.innerHTML=Ee(e);break;case S.MARKET:this._saveMarketTransactionState(),this.cache.marketScreen.innerHTML=de(e,this.isMobile,this.getItemPrice,this.marketTransactionState),this._restoreMarketTransactionState();break;case S.CARGO:this.cache.cargoScreen.innerHTML=Ae(e);break;case S.HANGAR:this.cache.hangarScreen.innerHTML=be(e,this.isMobile);break;case S.MISSIONS:this.cache.missionsScreen.innerHTML=Me(e,this.missionService);break;case S.FINANCE:this.cache.financeScreen.innerHTML=_e(e);break;case S.INTEL:this.cache.intelScreen.innerHTML=Ce();break}}updateStickyBar(e){this.cache.stickyBar.innerHTML="",this.cache.topBarContainer.classList.remove("has-sticky-bar")}updateServicesScreen(e){if(e.activeScreen!==S.SERVICES)return;let{player:t}=e,i=d.SHIPS[t.activeShipId],a=t.shipStates[t.activeShipId],s=this.cache.servicesScreen.querySelector("#fuel-bar"),o=this.cache.servicesScreen.querySelector("#refuel-btn");if(s&&o){let l=a.fuel/i.maxFuel*100;s.style.width=`${l}%`,o.disabled=a.fuel>=i.maxFuel}let r=this.cache.servicesScreen.querySelector("#repair-bar"),n=this.cache.servicesScreen.querySelector("#repair-btn");if(r&&n){let l=a.health/i.maxHealth*100;r.style.width=`${l}%`,n.disabled=a.health>=i.maxHealth}}updateMarketScreen(e){e.activeScreen===S.MARKET&&(this._saveMarketTransactionState(),this.cache.marketScreen.innerHTML=de(e,this.isMobile,this.getItemPrice,this.marketTransactionState),this._restoreMarketTransactionState())}_saveMarketTransactionState(){if(!this.lastKnownState||this.lastKnownState.activeScreen!==S.MARKET)return;this.cache.marketScreen.querySelectorAll(".transaction-controls").forEach(t=>{let i=t.dataset.goodId,a=t.querySelector("input"),s=t.dataset.mode;a&&(this.marketTransactionState[i]={quantity:a.value,mode:s})})}_restoreMarketTransactionState(){for(let e in this.marketTransactionState){let t=this.marketTransactionState[e],i=this.cache.marketScreen.querySelector(`.transaction-controls[data-good-id="${e}"]`);if(i){let a=i.querySelector("input");a&&(a.value=t.quantity,i.setAttribute("data-mode",t.mode),this.updateMarketCardDisplay(e,parseInt(t.quantity,10)||0,t.mode))}}}getItemPrice(e,t,i=!1){let a=e.market.prices[e.currentLocationId][t],s=d.MARKETS.find(r=>r.id===e.currentLocationId);i&&s.specialDemand&&s.specialDemand[t]&&(a*=s.specialDemand[t].bonus);let o=e.intel.active;return o&&o.targetMarketId===e.currentLocationId&&o.commodityId===t&&(a*=o.type==="demand"?d.CONFIG.INTEL_DEMAND_MOD:d.CONFIG.INTEL_DEPRESSION_MOD),Math.max(1,Math.round(a))}_calculateSaleDetails(e,t){let i=this.lastKnownState;if(!i)return{totalPrice:0,effectivePricePerUnit:0,netProfit:0};let a=d.COMMODITIES.find(E=>E.id===e),s=i.market.inventory[i.currentLocationId][e].quantity,o=this.getItemPrice(i,e,!0),n=i.player.inventories[i.player.activeShipId]?.[e]?.avgCost||0;if(s<=0)return{totalPrice:0,effectivePricePerUnit:0,netProfit:0};let l=s*.1;if(t<=l){let E=o*t,C=n*t,_=E-C;if(_>0){let N=(i.player.activePerks[M.TRADEMASTER]?d.PERKS[M.TRADEMASTER].profitBonus:0)+(i.player.birthdayProfitBonus||0);_+=_*N}return{totalPrice:E,effectivePricePerUnit:o,netProfit:_}}let h=t/s,u=0;a.tier<=2?u=Math.min(.1,(h-.1)*.2):a.tier<=5?u=Math.min(.25,(h-.1)*.5):u=Math.min(.4,(h-.1)*.8);let p=o*(1-u),m=Math.floor(p*t),f=n*t,T=m-f;if(T>0){let E=(i.player.activePerks[M.TRADEMASTER]?d.PERKS[M.TRADEMASTER].profitBonus:0)+(i.player.birthdayProfitBonus||0);T+=T*E}return{totalPrice:m,effectivePricePerUnit:p,netProfit:T}}updateMarketCardPrice(e,t){let i=this.cache.marketScreen.querySelector(`#price-display-${e}`);if(i){i.dataset.basePrice=t;let a=i.closest(".item-card-container").querySelector(".transaction-controls");a&&a.dataset.mode==="buy"&&(i.textContent=g(t))}}updateMarketCardDisplay(e,t,i){let a=this.cache.marketScreen.querySelector(`#price-display-${e}`),s=this.cache.marketScreen.querySelector(`#effective-price-display-${e}`),o=this.cache.marketScreen.querySelector(`#indicators-${e}`),r=this.cache.marketScreen.querySelector(`#avg-cost-${e}`);if(!a||!s||!o||!this.lastKnownState)return;let n=this.lastKnownState,l=parseInt(a.dataset.basePrice,10),h=n.player.inventories[n.player.activeShipId]?.[e];if(r&&r.classList.toggle("visible",i==="sell"),i==="buy")a.textContent=g(l),a.className="font-roboto-mono font-bold price-text",s.textContent="",o.innerHTML=z({price:l,sellPrice:this.getItemPrice(n,e,!0),galacticAvg:n.market.galacticAverages[e],playerItem:h});else{let{effectivePricePerUnit:u,netProfit:p}=this._calculateSaleDetails(e,t);if(t>0){let m=`\u232C ${p>=0?"+":""}${g(p,!1)}`;a.textContent=m,s.textContent=`(${g(u,!1)}/unit)`,a.className=`font-roboto-mono font-bold ${p>=0?"profit-text":"loss-text"}`}else a.textContent="\u232C +0",a.className="font-roboto-mono font-bold profit-text",s.textContent="";o.innerHTML=z({price:l,sellPrice:u||this.getItemPrice(n,e,!0),galacticAvg:n.market.galacticAverages[e],playerItem:h})}}showTravelAnimation(e,t,i,a,s){let o=document.getElementById("travel-animation-modal"),r=document.getElementById("travel-status-text"),n=document.getElementById("travel-arrival-lore"),l=document.getElementById("travel-canvas"),h=l.getContext("2d"),u=document.getElementById("travel-progress-container"),p=document.getElementById("travel-progress-bar"),m=document.getElementById("travel-readout-container"),f=document.getElementById("travel-info-text"),T=document.getElementById("travel-hull-damage"),E=document.getElementById("travel-confirm-button"),C=null;r.textContent=`Traveling to ${t.name}...`,n.textContent="",n.style.opacity=0,m.classList.add("hidden"),m.style.opacity=0,E.classList.add("hidden"),E.style.opacity=0,u.classList.remove("hidden"),p.style.width="0%",o.classList.remove("hidden");let _=2500,N=null,B=d.LOCATION_VISUALS[e.id]||"\u2753",v=d.LOCATION_VISUALS[t.id]||"\u2753",x="\u{1F680}",I=[],w=150;l.width=l.clientWidth,l.height=l.clientHeight;for(let P=0;P<w;P++)I.push({x:Math.random()*l.width,y:Math.random()*l.height,radius:Math.random()*1.5,speed:.2+Math.random()*.8,alpha:.5+Math.random()*.5});let $=P=>{N||(N=P);let q=P-N,H=Math.min(q/_,1);H=1-Math.pow(1-H,3),l.width=l.clientWidth,l.height=l.clientHeight,h.clearRect(0,0,l.width,l.height),h.fillStyle="#FFF";for(let le=0;le<w;le++){let U=I[le];H<1&&(U.x-=U.speed,U.x<0&&(U.x=l.width)),h.beginPath(),h.arc(U.x,U.y,U.radius,0,Math.PI*2),h.globalAlpha=U.alpha,h.fill()}h.globalAlpha=1;let j=60,W=j,pe=l.width-j,re=l.height/2;h.font="42px sans-serif",h.textAlign="center",h.textBaseline="middle",h.fillText(B,W,re),h.fillText(v,pe,re);let xe=W+(pe-W)*H;h.save(),h.translate(xe,re),h.font="17px sans-serif",h.fillText(x,0,0),h.restore(),p.style.width=`${H*100}%`,H<1?C=requestAnimationFrame($):(r.textContent=`Arrived at ${t.name}`,n.innerHTML=t.arrivalLore||"You have arrived.",f.innerHTML=`
                ...
                </div>`}else{let h=a.shipStates[t],u=a.inventories[t],p=O(u),m=t===a.activeShipId,f=a.ownedShipIds.length>1&&!m,T=Math.floor(o.price*k.SHIP_SELL_MODIFIER);r=`
