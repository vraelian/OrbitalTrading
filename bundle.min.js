(()=>{var y=Object.freeze({MAP:"map",NAVIGATION:"navigation",SERVICES:"services",MARKET:"market",CARGO:"cargo",HANGAR:"hangar",MISSIONS:"missions",FINANCE:"finance",INTEL:"intel"}),A=Object.freeze({SHIP:"ship",STARPORT:"starport",DATA:"data"}),E=Object.freeze({WANDERER:"starter",STALWART:"hauler_c1",MULE:"hauler_c2",PATHFINDER:"explorer_b1",NOMAD:"explorer_b2",VINDICATOR:"frigate_a1",AEGIS:"frigate_a2",ODYSSEY:"luxury_s1",MAJESTIC:"luxury_s2",TITAN_HAULER:"rare_s1",VOID_CHASER:"rare_s2",GUARDIAN:"rare_s3",STARGAZER:"rare_s4",BEHEMOTH:"rare_o1"}),v=Object.freeze({WATER_ICE:"water_ice",PLASTEEL:"plasteel",HYDROPONICS:"hydroponics",CYBERNETICS:"cybernetics",PROPELLANT:"propellant",PROCESSORS:"processors",GMO_SEEDS:"gmo_seeds",CRYO_PODS:"cryo_pods",ATMO_PROCESSORS:"atmos_processors",CLONED_ORGANS:"cloned_organs",XENO_GEOLOGICALS:"xeno_geologicals",SENTIENT_AI:"sentient_ai",ANTIMATTER:"antimatter",FOLDED_DRIVES:"folded_drives"}),g=Object.freeze({EARTH:"loc_earth",LUNA:"loc_luna",MARS:"loc_mars",VENUS:"loc_venus",BELT:"loc_belt",SATURN:"loc_saturn",JUPITER:"loc_jupiter",URANUS:"loc_uranus",NEPTUNE:"loc_neptune",PLUTO:"loc_pluto",EXCHANGE:"loc_exchange",KEPLER:"loc_kepler"}),I=Object.freeze({TRADEMASTER:"trademaster",NAVIGATOR:"navigator",VENETIAN_SYNDICATE:"venetian_syndicate",MERCHANT_GUILD_SHIP:"merchant_guild_ship"}),S=Object.freeze({DEBUG_SIMPLE_START:"debug-simple-start",SET_SCREEN:"set-screen",TRAVEL:"travel",BUY_SHIP:"buy-ship",SELL_SHIP:"sell-ship",SELECT_SHIP:"select-ship",PAY_DEBT:"pay-debt",TAKE_LOAN:"take-loan",PURCHASE_INTEL:"purchase-intel",ACQUIRE_LICENSE:"acquire-license",BUY_ITEM:"buy-item",SELL_ITEM:"sell-item",SET_MAX_BUY:"set-max-buy",SET_MAX_SELL:"set-max-sell",INCREMENT:"increment",DECREMENT:"decrement",SHOW_PRICE_GRAPH:"show-price-graph",SHOW_FINANCE_GRAPH:"show-finance-graph",TOGGLE_MARKET_CARD_VIEW:"toggle-market-card-view",TOGGLE_HANGAR_MODE:"toggle-hangar-mode",SET_HANGAR_PAGE:"set-hangar-page"}),w=Object.freeze({SCREEN_LOAD:"SCREEN_LOAD",ACTION:"ACTION",INFO:"INFO"}),_=Object.freeze({STARTING_CREDITS:5e3,STARTING_DEBT_INTEREST:125,REPAIR_COST_PER_HP:75,REPAIR_AMOUNT_PER_TICK:5,FUEL_SCALAR:3,INTEREST_INTERVAL:30,PASSIVE_REPAIR_RATE:.02,HULL_DECAY_PER_TRAVEL_DAY:1/7,SHIP_SELL_MODIFIER:.75,RARE_SHIP_CHANCE:.3,PRICE_HISTORY_LENGTH:65,FINANCE_HISTORY_LENGTH:25,DAILY_PRICE_VOLATILITY:.15,MEAN_REVERSION_STRENGTH:.07,MARKET_PRESSURE_DECAY:.7,LOAN_GARNISHMENT_DAYS:1095,LOAN_GARNISHMENT_PERCENT:.14,RANDOM_EVENT_CHANCE:.07}),pe=[{threshold:5e4,revealsTier:2},{threshold:45e4,revealsTier:3},{threshold:4e6,revealsTier:4},{threshold:35e6,revealsTier:5},{threshold:3e8,revealsTier:6},{threshold:25e8,revealsTier:7}],Te="orbitalTraderSave_v2";var Ie={START_YEAR:2140,START_DAY_OF_WEEK:1,DAYS_IN_MONTH:[31,28,31,30,31,30,31,31,30,31,30,31],MONTH_NAMES:["January","February","March","April","May","June","July","August","September","October","November","December"],DAY_NAMES:["Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"]},Fe={NEUTRAL:{name:"Neutral System",duration:28,description:"Standard space-faring conditions. Markets are operating under normal parameters.",modifiers:{}}},d={CONFIG:{INTEL_COST_PERCENTAGE:.2,INTEL_MIN_CREDITS:5e3,INTEL_CHANCE:.3,INTEL_DEMAND_MOD:1.8,INTEL_DEPRESSION_MOD:.5},SYSTEM_STATES:Fe,DATE_CONFIG:Ie,INTRO_SEQUENCE_V1:{modals:[{id:"lore_1",title:"Year 2140",description:'Humanity has expanded throughout the Solar System.<br><br> <span class="hl">Commerce</span> has thrived among the numerous colonies and stations longer than living memory.',buttonText:"Begin",contentClass:"text-center"},{id:"lore_2",title:"The Price of Freedom",description:"A dead-end job in the Belt pays the bills, but it does not offer the <b class='hl-green font-bold'>prosperity</b> that you dream of.<br><br>The <span class='hl'>Merchant's Guild</span> will fund your ambition, but their price is steep.<br><br>This is no simple loan; it's a bet on yourself and your future.",buttonText:"Apply for Loan",contentClass:"text-center",buttonClass:"btn-pulse-green"},{id:"charter",title:`<span class="hl">MERCHANT'S GUILD LOAN AGREEMENT</span>`,description:`
        ...
        <div id="ship-terminal-container" class="flex flex-col h-full ${n}">
            ...
            <div class="carousel-container flex-grow overflow-hidden relative">
                <div id="hangar-carousel" class="flex h-full" style="transform: translateX(-${c*100}%)">
                    ${r.map(u=>je(o,u,s)).join("")||Ve(s)}
                </div>
            </div>

            <div id="hangar-pagination" class="flex justify-center items-center p-2 space-x-2 flex-nowrap overflow-x-auto">
                ${r.map((u,h)=>`<div class="pagination-dot w-2 h-2 rounded-full bg-gray-600 transition-all duration-300 ${h===c?"active":""}" data-action="${S.SET_HANGAR_PAGE}" data-index="${h}"></div>`).join("")}
            </div>
        </div>
    `}function Ve(o){return`
    ...
    `}function je(o,e,t){let i=d.SHIPS[e],a=t?o.player.shipStates[e]:null,{player:s}=o,n="";if(t){let c=s.activeShipId===e;n=`<div class="status-badge" style="border-color: ${c?"var(--theme-color-primary)":"var(--ot-border-light)"}; color: ${c?"var(--theme-color-primary)":"var(--ot-text-secondary)"};">${c?"ACTIVE":"STORED"}</div>`}let r=`
    ...
    `}function Me(o,e,t,i,a,s){let n=t.class.toLowerCase();return s?`
            <div class="info-panel-content info-panel-hangar flex-col justify-between h-full">
                ...
                <div class="hangar-specs my-4">
                    ...
                    ${ge("Cargo",N(a.inventories[e]),t.cargoCapacity,"var(--class-s-color)")}
                </div>
        ...
        `}function xe(o,e,t,i,a){if(i){let s=t.activeShipId===o,n=t.ownedShipIds.length>1&&!s,r=Math.floor(e.price*_.SHIP_SELL_MODIFIER);return`
            <div class="grid grid-cols-2 gap-2">
                ...
                <button class="action-button" data-action="${S.SELL_SHIP}" data-ship-id="${o}" ${n?"":"disabled"} style="background-color: var(--ot-hangar-red-base);">
                    <span class="font-bold">SELL</span>
                    <span class="action-button-price font-roboto-mono">${f(r,!0)}</span>
                </button>
            </div>
        `}else{let s=t.credits>=e.price,n=a.activeBatchId?d.TUTORIAL_DATA[a.activeBatchId]?.steps.find(c=>c.stepId===a.activeStepId):null,r=a.activeBatchId==="intro_hangar"&&!n?.unlockPurchase,l=!s||r;return`
        ...
        `}}function ge(o,e,t,i){let a=t>0?e/t*100:0;return`
    ...
    `}function fe(o,e){return`
        <div class="spec-card">
            <p class="text-xs text-gray-400">${o}</p>
            <p class="text-lg font-bold font-orbitron">${e}</p>
        </div>
    `}function Re(o,e,t,i){return`<div class="scroll-panel">
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">${d.COMMODITIES.filter(n=>n.tier<=o.player.revealedTier).map(n=>Ke(n,o,t,i)).join("")}</div>
            </div>`}function Ke(o,e,t,i){let{player:a,market:s,currentLocationId:n,tutorials:r,uiState:l}=e,c=a.inventories[a.activeShipId]?.[o.id],u=t(e,o.id),h=t(e,o.id,!0),m=s.galacticAverages[o.id],p=s.inventory[n]?.[o.id],b=!o.licenseId||a.unlockedLicenseIds.includes(o.licenseId),T=r.activeBatchId==="intro_missions"&&r.activeStepId==="mission_2_2",C=r.activeBatchId==="intro_missions"&&r.activeStepId==="mission_2_3",L=T&&o.id!==v.PLASTEEL||C,M=`data-tooltip="${o.lore}"`,D=c&&c.quantity>0?c.quantity:"0",F=l.marketCardMinimized[o.id],R=U({price:u,sellPrice:h,galacticAvg:m,playerItem:c}),k=c&&c.quantity>0?`<div class="avg-cost-display" id="avg-cost-${o.id}">Avg. Cost: ${f(c.avgCost,!1)}</div>`:"",x;b?x=`
             <div class="transaction-controls" data-mode="${i[o.id]?.mode||"buy"}" data-good-id="${o.id}" ${L?"disabled":""}>
    ...
    <div class="item-card-container ${b?"":"locked"} ${F?"minimized":""}" id="item-card-container-${o.id}">
        <div class="rounded-lg border ${o.styleClass} transition-colors shadow-md">
            <button class="card-toggle-btn" data-action="${S.TOGGLE_MARKET_CARD_VIEW}" data-good-id="${o.id}">${F?"+":"\u2212"}</button>
            
            <div class="max-view-content">
                <p class="font-bold commodity-name"><span class="commodity-name-tooltip" ${M}>${o.name}</span></p>
                <p class="avail-text">Avail: <span id="m-stock-${o.id}">${p.quantity}</span>, Own: <span id="p-inv-${o.id}">${D}</span></p>
                <p id="price-display-${o.id}" class="font-roboto-mono font-bold price-text" data-action="${S.SHOW_PRICE_GRAPH}" data-good-id="${o.id}" data-base-price="${u}">${f(u)}</p>
                
                <div id="effective-price-display-${o.id}" class="effective-price-display"></div>
                
                <div class="indicator-container" id="indicators-${o.id}">${R}</div>
    ...
    </div>`}function Le(){return'<div id="map-container" class="w-full h-full"></div>'}function Ne(o){let e=d3.select("#map-container");if(!e.node()||!e.select("svg").empty())return;let t=e.append("svg").attr("id","map-svg").attr("width","100%").attr("height","100%"),a=t.append("defs").append("radialGradient").attr("id","sun-gradient");a.append("stop").attr("offset","0%").attr("stop-color","#fef08a"),a.append("stop").attr("offset","100%").attr("stop-color","#fde047"),t.append("circle").attr("class","sun").attr("cx","50%").attr("cy",-195).attr("r",225).attr("fill","url(#sun-gradient)"),t.append("line").attr("class","central-axis").attr("x1","50%").attr("y1",0).attr("x2","50%").attr("y2","100%");let s={[g.VENUS]:1.035,[g.EARTH]:1.035,[g.LUNA]:.805,[g.MARS]:.9775,[g.BELT]:.805,[g.EXCHANGE]:.805,[g.JUPITER]:1.564,[g.SATURN]:1.46625,[g.URANUS]:1.27075,[g.NEPTUNE]:1.27075,[g.KEPLER]:.8625,[g.PLUTO]:.92},n=d.MARKETS.filter(h=>o.lastKnownState.player.unlockedLocationIds.includes(h.id)).map(h=>{let p=(h.parent?8:12)*(s[h.id]||1),b=h.distance;if(h.parent){let T=d.MARKETS.find(C=>C.id===h.parent);T&&(b=T.distance+.1)}return{...h,effectiveDistance:b,finalRadius:p}}).sort((h,m)=>h.effectiveDistance-m.effectiveDistance),r=d3.scalePoint().domain(n.map(h=>h.id)).range([120,e.node().clientHeight-80]).padding(.1),l=e.node().clientWidth/2,c=t.selectAll(".poi-group").data(n).enter().append("g").attr("class","poi-group").attr("data-location-id",h=>h.id).on("click",(h,m)=>{o.showMapDetailModal(m.id)});c.filter(h=>h.id!==g.BELT).append("circle").attr("cx","50%").attr("cy",h=>r(h.id)).attr("r",h=>h.finalRadius).attr("fill",h=>h.navTheme.borderColor);let u=c.filter(h=>h.id===g.BELT);if(!u.empty()){let h=u.datum().finalRadius;u.append("path").attr("d",`M 0,${-h} L ${h},0 L 0,${h} L ${-h},0 Z`).attr("transform",m=>`translate(${l}, ${r(m.id)})`).attr("fill",m=>m.navTheme.borderColor)}c.append("line").attr("class","leader-line").attr("x1","50%").attr("y1",h=>r(h.id)).attr("x2",(h,m)=>l+(m%2===0?-46:46)).attr("y2",h=>r(h.id)),c.append("text").attr("class","poi-label").attr("x",(h,m)=>l+(m%2===0?-52:52)).attr("y",h=>r(h.id)).attr("text-anchor",(h,m)=>m%2===0?"end":"start").attr("dominant-baseline","middle").text(h=>h.name)}function we(o){let{player:e,currentLocationId:t,TRAVEL_DATA:i,tutorials:a}=o,{navLock:s}=a,n=d.MARKETS.find(u=>u.id===t),r=s&&s.screenId===y.NAVIGATION,l=r?s.enabledElementQuery:null,c=null;if(l){let u=l.match(/\[data-location-id='(.*?)'\]/);u&&u[1]&&(c=u[1])}return`
        <div class="scroll-panel navigation-scroll-panel p-1">
            <div class="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-6">
            ${d.MARKETS.filter(u=>e.unlockedLocationIds.includes(u.id)).map(u=>{let h=u.id===t,m=h?null:i[t][u.id],p=r&&c&&u.id!==c,b=p?"disabled-location":"",T=h?`style="--theme-glow-color: ${n?.navTheme.borderColor};"`:"";return`<div class="location-card p-6 rounded-lg text-center flex flex-col ${h?"highlight-current":""} ${u.color} ${u.bg} ${b}" 
                                 data-action="show-launch-modal" data-location-id="${u.id}" ${p?"disabled":""} ${T}>
                        <h3 class="text-2xl font-orbitron flex-grow">${u.name}</h3>
        ...
        </div>`}function ke(o){let{player:e,currentLocationId:t}=o,i=d.SHIPS[e.activeShipId],a=e.shipStates[e.activeShipId],s=d.MARKETS.find(h=>h.id===t),n=s?.navTheme||{gradient:"linear-gradient(135deg, #4a5568, #2d3748)",textColor:"#f0f0f0",borderColor:"#7a9ac0"},r=s.fuelPrice/2;e.activePerks[I.VENETIAN_SYNDICATE]&&t===g.VENUS&&(r*=1-d.PERKS[I.VENETIAN_SYNDICATE].fuelDiscount);let l=i.maxHealth*(_.REPAIR_AMOUNT_PER_TICK/100)*_.REPAIR_COST_PER_HP;e.activePerks[I.VENETIAN_SYNDICATE]&&t===g.VENUS&&(l*=1-d.PERKS[I.VENETIAN_SYNDICATE].repairDiscount);let c=a.fuel/i.maxFuel*100,u=a.health/i.maxHealth*100;return`
        <div class="services-scroll-panel">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl mx-auto mt-8">
                <div class="p-4 rounded-lg text-center shadow-lg panel-border border" style="border-color: ${n.borderColor}; color: ${n.textColor}; background: ${n.gradient};">
                    ...
                    <p class="mb-3">Price: <span class="font-bold">\u232C ${f(r,!1)}</span> / 5 units</p>
        ...
        </div>`}function Oe(o){let e=o.player.inventories[o.player.activeShipId];if(!e)return'<p class="text-center text-gray-500 text-lg">No active ship.</p>';let t=Object.entries(e).filter(([,a])=>a.quantity>0);return t.length===0?'<p class="text-center text-gray-500 text-lg">Your cargo hold is empty.</p>':`<div class="cargo-scroll-panel"><div class="cargo-grid">${t.map(([a,s])=>{let n=d.COMMODITIES.find(r=>r.id===a);return We(n,s)}).join("")}</div></div>`}function We(o,e){let t=q(o.styleClass);return`
    ...
    `}function De(o,e){let t=q(o.styleClass),a={RAW:"Raw Material",IND:"Industrial Product",AGRI:"Agricultural Good",TECH:"Technology",CIV:"Civilian Commodity",BIO:"Bioware",RARE:"Exotic Material"}[o.cat]||"Unknown",n=(o.basePriceRange[0]+o.basePriceRange[1])/2*e.quantity;return`
    ...
    `}function $e(o,e){let{missions:t,currentLocationId:i}=o,{activeMissionId:a,activeMissionObjectivesMet:s}=t,n=(c,u)=>{let h="";u==="active"&&(h="mission-active"),u==="completed"&&(h="mission-complete"),u==="active"&&s&&c.completion.locationId===i&&(h+=" mission-turn-in");let m=`host-${c.host.toLowerCase().replace(/[^a-z0-9]/g,"")}`,p=c.rewards.map(b=>b.type==="credits"?`\u232C ${b.amount.toLocaleString()}`:b.type.toUpperCase()).join(", ");return`
            ...
            </div>`},r="",l=a?d.MISSIONS[a]:null;return l&&(r+=n(l,"active")),e&&e.getAvailableMissions().forEach(u=>{r+=n(u,"available")}),r===""&&(r='<p class="text-center text-gray-500 text-lg">No missions available at this terminal.</p>'),`
    ...
    `}function Pe(o){let{player:e,day:t,currentLocationId:i}=o,s=d.MARKETS.find(l=>l.id===i)?.navTheme||{gradient:"linear-gradient(135deg, #4a5568, #2d3748)",textColor:"#f0f0f0",borderColor:"#7a9ac0"},n;if(e.debt>0){let l="";if(e.loanStartDate){let c=_.LOAN_GARNISHMENT_DAYS-(t-e.loanStartDate);c>0&&(l=`<p class="text-xs text-red-400/70 mt-2">Garnishment in ${c} days</p>`)}n=`
            <div>
            ...
            </div>`}else{let l=Math.floor(e.credits*3.5),c=Math.floor(l*.1),u=Math.floor(l*.04),m=[{key:"10000",amount:1e4,fee:600,interest:500},{key:"dynamic",...{amount:l,fee:c,interest:u}}].map(p=>`<button class="btn btn-loan w-full p-2 mt-2" data-action="${S.TAKE_LOAN}" data-loan-details='${JSON.stringify(p)}' ${e.credits<p.fee?"disabled":""}>
            ...
            </div>`}let r=[...e.financeLog].reverse().map(l=>{let c=l.amount>0?"text-green-400":"text-red-400",u=l.amount>0?"+":"";return`
            <div class="log-entry">
                <span class="text-gray-400 text-center">${l.day}</span>
                <span>${l.description}</span>
                <span class="${c} text-right font-roboto-mono">${u}${f(l.amount,!1)}</span>
            </div>
        `}).join("");return`
    ...
    `}function He(){return`
        <div class="intel-scroll-panel">
            ...
            <div class="context-bar" style="background: ${T.gradient}; color: ${T.textColor};">
            ...
            </div>`,L=Object.keys(this.navStructure).map(R=>{let k=R===a,x=n[R]||Object.keys(this.navStructure[R].screens)[0],$=u&&u.navId!==R,B=r||$,me=k?`background: ${T.gradient}; color: ${T.textColor};`:"";return`<div class="tab ${k?"active":""} ${B?"disabled":""}" style="${me}" data-action="${S.SET_SCREEN}" data-nav-id="${R}" data-screen-id="${x}">${this.navStructure[R].label}</div>`}).join(""),M="";if(m&&p&&b){let R=N(b),k=p.health/m.maxHealth*100,x=p.fuel/m.maxFuel*100,$=R/m.cargoCapacity*100;M=`
                ...
                </div>`}else{let u=a.shipStates[t],h=a.inventories[t],m=N(h),p=t===a.activeShipId,b=a.ownedShipIds.length>1&&!p,T=Math.floor(n.price*_.SHIP_SELL_MODIFIER);r=`
