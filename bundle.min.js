(()=>{var y=Object.freeze({STATUS:"status",NAVIGATION:"navigation",SERVICES:"services",MARKET:"market",CARGO:"cargo",HANGAR:"hangar",MISSIONS:"missions",FINANCE:"finance",INTEL:"intel"}),R=Object.freeze({SHIP:"ship",STARPORT:"starport",DATA:"data"}),A=Object.freeze({WANDERER:"starter",STALWART:"hauler_c1",MULE:"hauler_c2",PATHFINDER:"explorer_b1",NOMAD:"explorer_b2",VINDICATOR:"frigate_a1",AEGIS:"frigate_a2",ODYSSEY:"luxury_s1",MAJESTIC:"luxury_s2",TITAN_HAULER:"rare_s1",VOID_CHASER:"rare_s2",GUARDIAN:"rare_s3",STARGAZER:"rare_s4",BEHEMOTH:"rare_o1"}),L=Object.freeze({WATER_ICE:"water_ice",PLASTEEL:"plasteel",HYDROPONICS:"hydroponics",CYBERNETICS:"cybernetics",PROPELLANT:"propellant",PROCESSORS:"processors",GMO_SEEDS:"gmo_seeds",CRYO_PODS:"cryo_pods",ATMO_PROCESSORS:"atmos_processors",CLONED_ORGANS:"cloned_organs",XENO_GEOLOGICALS:"xeno_geologicals",SENTIENT_AI:"sentient_ai",ANTIMATTER:"antimatter",FOLDED_DRIVES:"folded_drives"}),S=Object.freeze({EARTH:"loc_earth",LUNA:"loc_luna",MARS:"loc_mars",VENUS:"loc_venus",BELT:"loc_belt",SATURN:"loc_saturn",JUPITER:"loc_jupiter",URANUS:"loc_uranus",NEPTUNE:"loc_neptune",PLUTO:"loc_pluto",EXCHANGE:"loc_exchange",KEPLER:"loc_kepler"}),M=Object.freeze({TRADEMASTER:"trademaster",NAVIGATOR:"navigator",VENETIAN_SYNDICATE:"venetian_syndicate",MERCHANT_GUILD_SHIP:"merchant_guild_ship"}),b=Object.freeze({SET_SCREEN:"set-screen",TRAVEL:"travel",BUY_SHIP:"buy-ship",SELL_SHIP:"sell-ship",SELECT_SHIP:"select-ship",PAY_DEBT:"pay-debt",TAKE_LOAN:"take-loan",PURCHASE_INTEL:"purchase-intel",ACQUIRE_LICENSE:"acquire-license",BUY_ITEM:"buy-item",SELL_ITEM:"sell-item",SET_MAX_BUY:"set-max-buy",SET_MAX_SELL:"set-max-sell",INCREMENT:"increment",DECREMENT:"decrement",SHOW_PRICE_GRAPH:"show-price-graph",SHOW_FINANCE_GRAPH:"show-finance-graph",TOGGLE_MARKET_CARD_VIEW:"toggle-market-card-view"}),D=Object.freeze({SCREEN_LOAD:"SCREEN_LOAD",ACTION:"ACTION",INFO:"INFO"}),k=Object.freeze({STARTING_CREDITS:5e3,STARTING_DEBT_INTEREST:125,REPAIR_COST_PER_HP:75,REPAIR_AMOUNT_PER_TICK:5,FUEL_SCALAR:3,INTEREST_INTERVAL:30,PASSIVE_REPAIR_RATE:.02,HULL_DECAY_PER_TRAVEL_DAY:1/7,SHIP_SELL_MODIFIER:.75,RARE_SHIP_CHANCE:.3,PRICE_HISTORY_LENGTH:65,FINANCE_HISTORY_LENGTH:10,DAILY_PRICE_VOLATILITY:.15,MEAN_REVERSION_STRENGTH:.07,MARKET_PRESSURE_DECAY:.7,LOAN_GARNISHMENT_DAYS:1095,LOAN_GARNISHMENT_PERCENT:.14,RANDOM_EVENT_CHANCE:.07}),ue=[{threshold:5e4,revealsTier:2},{threshold:45e4,revealsTier:3},{threshold:4e6,revealsTier:4},{threshold:35e6,revealsTier:5},{threshold:3e8,revealsTier:6},{threshold:25e8,revealsTier:7}];var Se="orbitalTraderSave_v2";var F={START_YEAR:2140,START_DAY_OF_WEEK:1,DAYS_IN_MONTH:[31,28,31,30,31,30,31,31,30,31,30,31],MONTH_NAMES:["January","February","March","April","May","June","July","August","September","October","November","December"],DAY_NAMES:["Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"]},we={NEUTRAL:{name:"Neutral System",duration:28,description:"Standard space-faring conditions. Markets are operating under normal parameters.",modifiers:{}}},d={CONFIG:{INTEL_COST_PERCENTAGE:.2,INTEL_MIN_CREDITS:5e3,INTEL_CHANCE:.3,INTEL_DEMAND_MOD:1.8,INTEL_DEPRESSION_MOD:.5},SYSTEM_STATES:we,DATE_CONFIG:F,INTRO_SEQUENCE_V1:{modals:[{id:"lore_1",title:"Year 2140",description:'Humanity has expanded throughout the Solar System.<br><br> <span class="hl">Commerce</span> has thrived among the numerous colonies and stations longer than living memory.',buttonText:"Begin",contentClass:"text-center"},{id:"lore_2",title:"The Price of Freedom",description:"A dead-end job in the Belt pays the bills, but it does not offer the <b class='hl-green font-bold'>prosperity</b> that you dream of.<br><br>The <span class='hl'>Merchant's Guild</span> will fund your ambition, but their price is steep.<br><br>This is no simple loan; it's a bet on yourself and your future.",buttonText:"Apply for Loan",contentClass:"text-center",buttonClass:"btn-pulse-green"},{id:"charter",title:`<span class="hl">MERCHANT'S GUILD LOAN AGREEMENT</span>`,description:`
    ...
    `};function Ee(l){let{player:e}=l,t=De(l),i=t.length>0?t.map(([s])=>Ie(l,s,"shipyard")).join(""):'<p class="text-center text-gray-500 text-sm p-4">No new ships available at this location.</p>',a=e.ownedShipIds.length>0?e.ownedShipIds.map(s=>Ie(l,s,"hangar")).join(""):'<p class="text-center text-gray-500 text-sm p-4">Your hangar is empty.</p>';return`
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-x-8 relative">
            <div id="starport-shipyard-panel">
                ...
                <div class="starport-panel shipyard-panel space-y-4">${i}</div>
            </div>
        ...
        <div class="${u}" data-action="show-ship-detail" data-ship-id="${e}" data-context="${t}">
        ...
        </div>`}function De(l){let{player:e,currentLocationId:t,market:i,introSequenceActive:a}=l;return a?e.ownedShipIds.length>0?[]:[A.WANDERER,A.STALWART,A.MULE].map(o=>[o,d.SHIPS[o]]):(i.shipyardStock[t]?.shipsForSale||[]).map(o=>[o,d.SHIPS[o]]).filter(([o,n])=>!e.ownedShipIds.includes(o))}function pe(l,e,t,i){return`<div class="market-scroll-panel">
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">${d.COMMODITIES.filter(o=>o.tier<=l.player.revealedTier).map(o=>He(o,l,t,i)).join("")}</div>
            </div>`}function He(l,e,t,i){let{player:a,market:s,currentLocationId:o,tutorials:n,uiState:r}=e,c=a.inventories[a.activeShipId]?.[l.id],h=t(e,l.id),u=t(e,l.id,!0),p=s.galacticAverages[l.id],m=s.inventory[o]?.[l.id],f=!l.licenseId||a.unlockedLicenseIds.includes(l.licenseId),T=n.activeBatchId==="intro_missions"&&n.activeStepId==="mission_2_2",E=n.activeBatchId==="intro_missions"&&n.activeStepId==="mission_2_3",x=T&&l.id!==L.PLASTEEL||E,_=`data-tooltip="${l.lore}"`,N=c&&c.quantity>0?c.quantity:"0",B=r.marketCardMinimized[l.id],v=z({price:h,sellPrice:u,galacticAvg:p,playerItem:c}),C=c&&c.quantity>0?`<div class="avg-cost-display" id="avg-cost-${l.id}">Avg. Cost: ${g(c.avgCost,!1)}</div>`:"",I;f?I=`
             <div class="transaction-controls" data-mode="${i[l.id]?.mode||"buy"}" data-good-id="${l.id}" ${x?"disabled":""}>
            ...
            </div>`;let w=c?.quantity>0?` (${c.quantity})`:"";return`
    <div class="item-card-container ${f?"":"locked"} ${B?"minimized":""}" id="item-card-container-${l.id}">
        <div class="rounded-lg border ${l.styleClass} transition-colors shadow-md">
            <button class="card-toggle-btn" data-action="${b.TOGGLE_MARKET_CARD_VIEW}" data-good-id="${l.id}">${B?"+":"\u2212"}</button>
            ...
            <div class="max-view-content">
                ...
                <p id="price-display-${l.id}" class="font-roboto-mono font-bold price-text" data-action="${b.SHOW_PRICE_GRAPH}" data-good-id="${l.id}" data-base-price="${h}">${g(h)}</p>
                
                <div id="effective-price-display-${l.id}" class="effective-price-display"></div>
                
                <div class="indicator-container" id="indicators-${l.id}">${v}</div>
    ...
    </div>`}function Ae(l){let{player:e,day:t,currentLocationId:i}=l,a=d.SHIPS[e.activeShipId],s=e.shipStates[e.activeShipId],o=e.inventories[e.activeShipId],n=$(o),c=d.MARKETS.find(T=>T.id===i)?.navTheme||{gradient:"linear-gradient(135deg, #4a5568, #2d3748)",textColor:"#f0f0f0",borderColor:"#7a9ac0"},h=a.class.toLowerCase(),u=Math.floor(s.health/a.maxHealth*100),p=Math.floor(s.fuel/a.maxFuel*100),m=Array.from({length:Math.max(10,Math.min(25,Math.floor(a.cargoCapacity/8)))},(T,E)=>{let x=Math.round(n/a.cargoCapacity*Math.max(10,Math.min(25,Math.floor(a.cargoCapacity/8))));return`<div class="segment ${E<x?"filled":""}"></div>`}).join(""),f=`
    ...
    `;return`
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4 bg-black/30 p-4 rounded-lg mb-6 items-start">
                <div class="md:col-span-2 h-full p-4 rounded-lg flex items-center justify-between transition-all duration-500 panel-border border" style="border-color: ${c.borderColor}; color: ${c.textColor}; background: ${c.gradient};">
                    ...
                    <div class="text-right flex flex-col items-end">
                        <p class="text-xs font-roboto-mono text-right" style="color: ${c.textColor}cc;">${ye(t)}</p>
        ...
        </div>`}function Me(l){let{player:e,currentLocationId:t,TRAVEL_DATA:i,tutorials:a}=l,{navLock:s}=a,o=s&&s.screenId===y.NAVIGATION,n=o?s.enabledElementQuery:null;return`
        <div class="navigation-scroll-panel p-1">
            <div class="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-6">
            ${d.MARKETS.filter(r=>e.unlockedLocationIds.includes(r.id)).map(r=>{let c=r.id===t,h=c?null:i[t][r.id],u=!1;if(o&&n){let m=document.createElement("div");m.innerHTML=`<div data-location-id="${r.id}"></div>`,u=!m.querySelector(n)}let p=u?"disabled-location":"";return`<div class="location-card p-6 rounded-lg text-center flex flex-col ${c?"highlight-current":""} ${r.color} ${r.bg} ${p}" 
        ...
        </div>`}function _e(l){let{player:e,currentLocationId:t}=l,i=d.SHIPS[e.activeShipId],a=e.shipStates[e.activeShipId],s=d.MARKETS.find(u=>u.id===t),o=s?.navTheme||{gradient:"linear-gradient(135deg, #4a5568, #2d3748)",textColor:"#f0f0f0",borderColor:"#7a9ac0"},n=s.fuelPrice/2;e.activePerks[M.VENETIAN_SYNDICATE]&&t===S.VENUS&&(n*=1-d.PERKS[M.VENETIAN_SYNDICATE].fuelDiscount);let r=i.maxHealth*(k.REPAIR_AMOUNT_PER_TICK/100)*k.REPAIR_COST_PER_HP;e.activePerks[M.VENETIAN_SYNDICATE]&&t===S.VENUS&&(r*=1-d.PERKS[M.VENETIAN_SYNDICATE].repairDiscount);let c=a.fuel/i.maxFuel*100,h=a.health/i.maxHealth*100;return`
        ...
        </div>`}function xe(l){let e=l.player.inventories[l.player.activeShipId];if(!e)return'<p class="text-center text-gray-500 text-lg">No active ship.</p>';let t=Object.entries(e).filter(([,a])=>a.quantity>0);return t.length===0?'<p class="text-center text-gray-500 text-lg">Your cargo hold is empty.</p>':`<div class="cargo-scroll-panel"><div class="cargo-grid">${t.map(([a,s])=>{let o=d.COMMODITIES.find(n=>n.id===a);return Be(o,s)}).join("")}</div></div>`}function Be(l,e){let i={"item-style-1":{hex:"#60a5fa",gradient:"linear-gradient(45deg, #3b82f6, #1e3a8a)"},"item-style-2":{hex:"#a3a3a3",gradient:"linear-gradient(45deg, #737373, #262626)"},"item-style-3":{hex:"#22c55e",gradient:"linear-gradient(45deg, #16a34a, #14532d)"},"item-style-4":{hex:"#e5e5e5",gradient:"linear-gradient(45deg, #d4d4d4, #737373)"},"item-style-5":{hex:"#c084fc",gradient:"linear-gradient(45deg, #a855f7, #6b21a8)"},"item-style-6":{hex:"#93c5fd",gradient:"linear-gradient(45deg, #60a5fa, #2563eb)"},"item-style-7":{hex:"#84cc16",gradient:"linear-gradient(45deg, #a3e635, #4d7c0f)"},"item-style-8":{hex:"#67e8f9",gradient:"linear-gradient(45deg, #22d3ee, #0891b2)"},"item-style-9":{hex:"#fcd34d",gradient:"linear-gradient(45deg, #facc15, #b45309)"},"item-style-10":{hex:"#fb7185",gradient:"linear-gradient(45deg, #f43f5e, #9f1239)"},"item-style-11":{hex:"#a78bfa",gradient:"linear-gradient(165deg, #a78bfa, #312e81, #1e3a8a)"},"item-style-12":{hex:"#f87171",gradient:"linear-gradient(45deg, #ef4444, #7f1d1d)"},"item-style-13":{hex:"#d8b4fe",gradient:"linear-gradient(45deg, #a855f7, #3b0764)"},"item-style-14":{hex:"#f472b6",gradient:"linear-gradient(45deg, #ec4899, #831843)"}}[l.styleClass]||{hex:"#a8a29e",gradient:"linear-gradient(45deg, #52525b, #18181b)"};return`
        <div class="min-cargo-item" 
             style="background: ${i.gradient}; border: 2px solid ${i.hex};"
             data-action="show_cargo_detail" 
             data-good-id="${l.id}">
            
            <div class="pt-symbol" style="font-size: 2rem; color: ${i.hex}; text-shadow: 0 0 5px rgba(0,0,0,0.7);">${l.symbol.toUpperCase()}</div>
            <div class="pt-quantity text-gray-400" style="text-shadow: 1px 1px 3px #000;">(${e.quantity})</div>
        </div>
    `}function Ce(l,e){let i={"item-style-1":{hex:"#60a5fa",gradient:"linear-gradient(45deg, #3b82f6, #1e3a8a)"},"item-style-2":{hex:"#a3a3a3",gradient:"linear-gradient(45deg, #737373, #262626)"},"item-style-3":{hex:"#22c55e",gradient:"linear-gradient(45deg, #16a34a, #14532d)"},"item-style-4":{hex:"#e5e5e5",gradient:"linear-gradient(45deg, #d4d4d4, #737373)"},"item-style-5":{hex:"#c084fc",gradient:"linear-gradient(45deg, #a855f7, #6b21a8)"},"item-style-6":{hex:"#93c5fd",gradient:"linear-gradient(45deg, #60a5fa, #2563eb)"},"item-style-7":{hex:"#84cc16",gradient:"linear-gradient(45deg, #a3e635, #4d7c0f)"},"item-style-8":{hex:"#67e8f9",gradient:"linear-gradient(45deg, #22d3ee, #0891b2)"},"item-style-9":{hex:"#fcd34d",gradient:"linear-gradient(45deg, #facc15, #b45309)"},"item-style-10":{hex:"#fb7185",gradient:"linear-gradient(45deg, #f43f5e, #9f1239)"},"item-style-11":{hex:"#a78bfa",gradient:"linear-gradient(165deg, #a78bfa, #312e81, #1e3a8a)"},"item-style-12":{hex:"#f87171",gradient:"linear-gradient(45deg, #ef4444, #7f1d1d)"},"item-style-13":{hex:"#d8b4fe",gradient:"linear-gradient(45deg, #a855f7, #3b0764)"},"item-style-14":{hex:"#f472b6",gradient:"linear-gradient(45deg, #ec4899, #831843)"}}[l.styleClass]||{hex:"#a8a29e",gradient:"linear-gradient(45deg, #52525b, #18181b)"},s={RAW:"Raw Material",IND:"Industrial Product",AGRI:"Agricultural Good",TECH:"Technology",CIV:"Civilian Commodity",BIO:"Bioware",RARE:"Exotic Material"}[l.cat]||"Unknown",n=(l.basePriceRange[0]+l.basePriceRange[1])/2*e.quantity;return`
        <div class="max-cargo-card" style="background: ${i.gradient}; border-color: ${i.hex};">
            ...
            <p class="text-sm text-center tier-type-line mb-4" style="color: ${i.hex};">Tier ${l.tier} ${s}</p>
            ...
            <div class="avg-cost">
                ...
                <div>Avg. Value: <span class="font-bold credits-text-pulsing">${g(n,!0)}</span></div>
            </div>
        </div>
    `}function Re(l,e){let{missions:t,currentLocationId:i}=l,{activeMissionId:a,activeMissionObjectivesMet:s}=t,o=(c,h)=>{let u="";h==="active"&&(u="mission-active"),h==="completed"&&(u="mission-complete"),h==="active"&&s&&c.completion.locationId===i&&(u+=" mission-turn-in");let p=`host-${c.host.toLowerCase().replace(/[^a-z0-9]/g,"")}`,m=c.rewards.map(f=>f.type==="credits"?`\u232C ${f.amount.toLocaleString()}`:f.type.toUpperCase()).join(", ");return`
    ...
    `}function ke(l){let{player:e,day:t,currentLocationId:i}=l,s=d.MARKETS.find(r=>r.id===i)?.navTheme||{gradient:"linear-gradient(135deg, #4a5568, #2d3748)",textColor:"#f0f0f0",borderColor:"#7a9ac0"},o;if(e.debt>0){let r="";if(e.loanStartDate){let c=k.LOAN_GARNISHMENT_DAYS-(t-e.loanStartDate);c>0&&(r=`<p class="text-xs text-red-400/70 mt-2">Garnishment in ${c} days</p>`)}o=`
            <div>
            ...
            </div>`}else{let r=Math.floor(e.credits*3.5),c=Math.floor(r*.1),h=Math.floor(r*.04),p=[{key:"10000",amount:1e4,fee:600,interest:500},{key:"dynamic",...{amount:r,fee:c,interest:h}}].map(m=>`<button class="btn btn-loan w-full p-2 mt-2" data-action="${b.TAKE_LOAN}" data-loan-details='${JSON.stringify(m)}' ${e.credits<m.fee?"disabled":""}>
            ...
            </div>`}let n=[...e.financeLog].reverse().map(r=>{let c=r.amount>0?"text-green-400":"text-red-400",h=r.amount>0?"+":"";return`
            <div class="grid grid-cols-4 gap-2 p-2 border-b border-slate-700 text-sm">
                ...
                <span class="${c} text-right">${h}${g(r.amount,!1)}</span>
            </div>
        `}).join("");return`
    ...
    `}function Ne(){return`
        <div class="intel-scroll-panel">
            ...
            <div class="context-bar" style="background: ${T.gradient}; color: ${T.textColor};">
            ...
            </div>`,x=Object.keys(this.navStructure).map(v=>{let C=v===a,I=o[v]||Object.keys(this.navStructure[v].screens)[0],w=h&&h.navId!==v,O=n||w,P=C?`background: ${T.gradient}; color: ${T.textColor};`:"";return`<div class="tab ${v}-tab ${C?"active":""} ${O?"disabled":""}" style="${P}" data-action="${b.SET_SCREEN}" data-nav-id="${v}" data-screen-id="${I}">${this.navStructure[v].label}</div>`}).join(""),_="";if(p&&m&&f){let v=$(f),C=m.health/p.maxHealth*100,I=m.fuel/p.maxFuel*100,w=v/p.cargoCapacity*100;_=`
                ...
                </div>`}let N=`<div class="nav-wrapper">${x}${_}</div>`,B=Object.keys(this.navStructure).map(v=>{let C=this.navStructure[v].screens,I=v===a,w=Object.keys(C).map(O=>{let P=h&&h.screenId!==O,q=O===s,H=n||P,j=`style="color: ${T.textColor};"`;return q&&(j=`style="background: ${T.gradient}; color: ${T.textColor}; opacity: 1; font-weight: 700;"`),`<a href="#" class="${H?"disabled":""}" ${j} data-action="${b.SET_SCREEN}" data-nav-id="${v}" data-screen-id="${O}" draggable="false">${C[O]}</a>`}).join("");return`<div class="nav-sub ${!I||c?"hidden":""}" id="${v}-sub">${w}</div>`}).join("");this.cache.navBar.innerHTML=E+N,this.cache.subNavBar.innerHTML=B}renderActiveScreen(e){let t=this.cache[`${e.activeScreen}Screen`];switch(this.lastActiveScreenEl&&this.lastActiveScreenEl!==t&&(this.lastActiveScreenEl.style.display="none"),t&&(t.style.display="block",this.lastActiveScreenEl=t),e.activeScreen){case y.STATUS:this.cache.statusScreen.innerHTML=Ae(e);break;case y.NAVIGATION:this.cache.navigationScreen.innerHTML=Me(e);break;case y.SERVICES:this.cache.servicesScreen.innerHTML=_e(e);break;case y.MARKET:this._saveMarketTransactionState(),this.cache.marketScreen.innerHTML=pe(e,this.isMobile,this.getItemPrice,this.marketTransactionState),this._restoreMarketTransactionState();break;case y.CARGO:this.cache.cargoScreen.innerHTML=xe(e);break;case y.HANGAR:this.cache.hangarScreen.innerHTML=Ee(e,this.isMobile);break;case y.MISSIONS:this.cache.missionsScreen.innerHTML=Re(e,this.missionService);break;case y.FINANCE:this.cache.financeScreen.innerHTML=ke(e);break;case y.INTEL:this.cache.intelScreen.innerHTML=Ne();break}}updateStickyBar(e){this.cache.stickyBar.innerHTML="",this.cache.topBarContainer.classList.remove("has-sticky-bar")}updateServicesScreen(e){if(e.activeScreen!==y.SERVICES)return;let{player:t}=e,i=d.SHIPS[t.activeShipId],a=t.shipStates[t.activeShipId],s=this.cache.servicesScreen.querySelector("#fuel-bar"),o=this.cache.servicesScreen.querySelector("#refuel-btn");if(s&&o){let c=a.fuel/i.maxFuel*100;s.style.width=`${c}%`,o.disabled=a.fuel>=i.maxFuel}let n=this.cache.servicesScreen.querySelector("#repair-bar"),r=this.cache.servicesScreen.querySelector("#repair-btn");if(n&&r){let c=a.health/i.maxHealth*100;n.style.width=`${c}%`,r.disabled=a.health>=i.maxHealth}}updateMarketScreen(e){e.activeScreen===y.MARKET&&(this._saveMarketTransactionState(),this.cache.marketScreen.innerHTML=pe(e,this.isMobile,this.getItemPrice,this.marketTransactionState),this._restoreMarketTransactionState())}_saveMarketTransactionState(){if(!this.lastKnownState||this.lastKnownState.activeScreen!==y.MARKET)return;this.cache.marketScreen.querySelectorAll(".transaction-controls").forEach(t=>{let i=t.dataset.goodId,a=t.querySelector("input"),s=t.dataset.mode;a&&(this.marketTransactionState[i]={quantity:a.value,mode:s})})}_restoreMarketTransactionState(){for(let e in this.marketTransactionState){let t=this.marketTransactionState[e],i=this.cache.marketScreen.querySelector(`.transaction-controls[data-good-id="${e}"]`);if(i){let a=i.querySelector("input");a&&(a.value=t.quantity,i.setAttribute("data-mode",t.mode),this.updateMarketCardDisplay(e,parseInt(t.quantity,10)||0,t.mode))}}}getItemPrice(e,t,i=!1){let a=e.market.prices[e.currentLocationId][t],s=d.MARKETS.find(n=>n.id===e.currentLocationId);i&&s.specialDemand&&s.specialDemand[t]&&(a*=s.specialDemand[t].bonus);let o=e.intel.active;return o&&o.targetMarketId===e.currentLocationId&&o.commodityId===t&&(a*=o.type==="demand"?d.CONFIG.INTEL_DEMAND_MOD:d.CONFIG.INTEL_DEPRESSION_MOD),Math.max(1,Math.round(a))}_calculateSaleDetails(e,t){let i=this.lastKnownState;if(!i)return{totalPrice:0,effectivePricePerUnit:0,netProfit:0};let a=d.COMMODITIES.find(E=>E.id===e),s=i.market.inventory[i.currentLocationId][e].quantity,o=this.getItemPrice(i,e,!0),r=i.player.inventories[i.player.activeShipId]?.[e]?.avgCost||0;if(s<=0)return{totalPrice:0,effectivePricePerUnit:0,netProfit:0};let c=s*.1;if(t<=c){let E=o*t,x=r*t,_=E-x;if(_>0){let N=(i.player.activePerks[M.TRADEMASTER]?d.PERKS[M.TRADEMASTER].profitBonus:0)+(i.player.birthdayProfitBonus||0);_+=_*N}return{totalPrice:E,effectivePricePerUnit:o,netProfit:_}}let h=t/s,u=0;a.tier<=2?u=Math.min(.1,(h-.1)*.2):a.tier<=5?u=Math.min(.25,(h-.1)*.5):u=Math.min(.4,(h-.1)*.8);let p=o*(1-u),m=Math.floor(p*t),f=r*t,T=m-f;if(T>0){let E=(i.player.activePerks[M.TRADEMASTER]?d.PERKS[M.TRADEMASTER].profitBonus:0)+(i.player.birthdayProfitBonus||0);T+=T*E}return{totalPrice:m,effectivePricePerUnit:p,netProfit:T}}updateMarketCardPrice(e,t){let i=this.cache.marketScreen.querySelector(`#price-display-${e}`);if(i){i.dataset.basePrice=t;let a=i.closest(".item-card-container").querySelector(".transaction-controls");a&&a.dataset.mode==="buy"&&(i.textContent=g(t))}}updateMarketCardDisplay(e,t,i){let a=this.cache.marketScreen.querySelector(`#price-display-${e}`),s=this.cache.marketScreen.querySelector(`#effective-price-display-${e}`),o=this.cache.marketScreen.querySelector(`#indicators-${e}`),n=this.cache.marketScreen.querySelector(`#avg-cost-${e}`);if(!a||!s||!o||!this.lastKnownState)return;let r=this.lastKnownState,c=parseInt(a.dataset.basePrice,10),h=r.player.inventories[r.player.activeShipId]?.[e];if(n&&n.classList.toggle("visible",i==="sell"),i==="buy")a.textContent=g(c),a.className="font-roboto-mono font-bold price-text",s.textContent="",o.innerHTML=z({price:c,sellPrice:this.getItemPrice(r,e,!0),galacticAvg:r.market.galacticAverages[e],playerItem:h});else{let{effectivePricePerUnit:u,netProfit:p}=this._calculateSaleDetails(e,t);if(t>0){let m=`\u232C ${p>=0?"+":""}${g(p,!1)}`;a.textContent=m,s.textContent=`(${g(u,!1)}/unit)`,a.className=`font-roboto-mono font-bold ${p>=0?"profit-text":"loss-text"}`}else a.textContent="\u232C +0",a.className="font-roboto-mono font-bold profit-text",s.textContent="";o.innerHTML=z({price:c,sellPrice:u||this.getItemPrice(r,e,!0),galacticAvg:r.market.galacticAverages[e],playerItem:h})}}showTravelAnimation(e,t,i,a,s){let o=document.getElementById("travel-animation-modal"),n=document.getElementById("travel-status-text"),r=document.getElementById("travel-arrival-lore"),c=document.getElementById("travel-canvas"),h=c.getContext("2d"),u=document.getElementById("travel-progress-container"),p=document.getElementById("travel-progress-bar"),m=document.getElementById("travel-readout-container"),f=document.getElementById("travel-info-text"),T=document.getElementById("travel-hull-damage"),E=document.getElementById("travel-confirm-button"),x=null;n.textContent=`Traveling to ${t.name}...`,r.textContent="",r.style.opacity=0,m.classList.add("hidden"),m.style.opacity=0,E.classList.add("hidden"),E.style.opacity=0,u.classList.remove("hidden"),p.style.width="0%",o.classList.remove("hidden");let _=2500,N=null,B=d.LOCATION_VISUALS[e.id]||"\u2753",v=d.LOCATION_VISUALS[t.id]||"\u2753",C="\u{1F680}",I=[],w=150;c.width=c.clientWidth,c.height=c.clientHeight;for(let P=0;P<w;P++)I.push({x:Math.random()*c.width,y:Math.random()*c.height,radius:Math.random()*1.5,speed:.2+Math.random()*.8,alpha:.5+Math.random()*.5});let O=P=>{N||(N=P);let q=P-N,H=Math.min(q/_,1);H=1-Math.pow(1-H,3),c.width=c.clientWidth,c.height=c.clientHeight,h.clearRect(0,0,c.width,c.height),h.fillStyle="#FFF";for(let he=0;he<w;he++){let U=I[he];H<1&&(U.x-=U.speed,U.x<0&&(U.x=c.width)),h.beginPath(),h.arc(U.x,U.y,U.radius,0,Math.PI*2),h.globalAlpha=U.alpha,h.fill()}h.globalAlpha=1;let j=60,W=j,fe=c.width-j,de=c.height/2;h.font="42px sans-serif",h.textAlign="center",h.textBaseline="middle",h.fillText(B,W,de),h.fillText(v,fe,de);let Le=W+(fe-W)*H;h.save(),h.translate(Le,de),h.font="17px sans-serif",h.fillText(C,0,0),h.restore(),p.style.width=`${H*100}%`,H<1?x=requestAnimationFrame(O):(n.textContent=`Arrived at ${t.name}`,r.innerHTML=t.arrivalLore||"You have arrived.",f.innerHTML=`
                ...
                </div>`}else{let h=a.shipStates[t],u=a.inventories[t],p=$(u),m=t===a.activeShipId,f=a.ownedShipIds.length>1&&!m,T=Math.floor(o.price*k.SHIP_SELL_MODIFIER);n=`
                ...
                </div>`}let r=this.cache.shipDetailModal,c=r.querySelector("#ship-detail-content");c.innerHTML=n,r.classList.remove("hidden"),r.classList.add("modal-visible")}showLaunchModal(e){let t=this.lastKnownState;if(!t)return;let i=d.MARKETS.find(f=>f.id===e);if(!i)return;let a=i.navTheme,s=t.TRAVEL_DATA[t.currentLocationId]?.[e],o=t.player.shipStates[t.player.activeShipId];if(!s)return;let n={water_ice:"RAW",plasteel:"IND",hydroponics:"AGRI",cybernetics:"TECH",propellant:"IND",processors:"TECH",gmo_seeds:"AGRI",cryo_pods:"CIV",atmos_processors:"IND",cloned_organs:"BIO",xeno_geologicals:"RAW",sentient_ai:"TECH",antimatter:"RARE",folded_drives:"RARE"},r=[],c=[];for(let f in i.availabilityModifier){let T=i.availabilityModifier[f],E=n[f];T<1&&!r.includes(E)?r.push(E):T>1&&!c.includes(E)&&c.push(E)}let h="";r.length>0&&(h+=`<p><b style="color: ${a.textColor};">Imports:</b> ${r.join(", ")}</p>`),c.length>0&&(h+=`<p><b style="color: ${a.textColor};">Exports:</b> ${c.join(", ")}</p>`),h===""&&(h="<p>Market data is unreliable.</p>");let u=`
