(()=>{var v=Object.freeze({MAP:"map",NAVIGATION:"navigation",SERVICES:"services",MARKET:"market",CARGO:"cargo",HANGAR:"hangar",MISSIONS:"missions",FINANCE:"finance",INTEL:"intel"}),M=Object.freeze({SHIP:"ship",STARPORT:"starport",DATA:"data"}),A=Object.freeze({WANDERER:"starter",STALWART:"hauler_c1",MULE:"hauler_c2",PATHFINDER:"explorer_b1",NOMAD:"explorer_b2",VINDICATOR:"frigate_a1",AEGIS:"frigate_a2",ODYSSEY:"luxury_s1",MAJESTIC:"luxury_s2",TITAN_HAULER:"rare_s1",VOID_CHASER:"rare_s2",GUARDIAN:"rare_s3",STARGAZER:"rare_s4",BEHEMOTH:"rare_o1"}),y=Object.freeze({WATER_ICE:"water_ice",PLASTEEL:"plasteel",HYDROPONICS:"hydroponics",CYBERNETICS:"cybernetics",PROPELLANT:"propellant",PROCESSORS:"processors",GMO_SEEDS:"gmo_seeds",CRYO_PODS:"cryo_pods",ATMO_PROCESSORS:"atmos_processors",CLONED_ORGANS:"cloned_organs",XENO_GEOLOGICALS:"xeno_geologicals",SENTIENT_AI:"sentient_ai",ANTIMATTER:"antimatter",FOLDED_DRIVES:"folded_drives"}),g=Object.freeze({EARTH:"loc_earth",LUNA:"loc_luna",MARS:"loc_mars",VENUS:"loc_venus",BELT:"loc_belt",SATURN:"loc_saturn",JUPITER:"loc_jupiter",URANUS:"loc_uranus",NEPTUNE:"loc_neptune",PLUTO:"loc_pluto",EXCHANGE:"loc_exchange",KEPLER:"loc_kepler"}),E=Object.freeze({TRADEMASTER:"trademaster",NAVIGATOR:"navigator",VENETIAN_SYNDICATE:"venetian_syndicate",MERCHANT_GUILD_SHIP:"merchant_guild_ship"}),S=Object.freeze({SET_SCREEN:"set-screen",TRAVEL:"travel",BUY_SHIP:"buy-ship",SELL_SHIP:"sell-ship",SELECT_SHIP:"select-ship",PAY_DEBT:"pay-debt",TAKE_LOAN:"take-loan",PURCHASE_INTEL:"purchase-intel",ACQUIRE_LICENSE:"acquire-license",BUY_ITEM:"buy-item",SELL_ITEM:"sell-item",SET_MAX_BUY:"set-max-buy",SET_MAX_SELL:"set-max-sell",INCREMENT:"increment",DECREMENT:"decrement",SHOW_PRICE_GRAPH:"show-price-graph",SHOW_FINANCE_GRAPH:"show-finance-graph",TOGGLE_MARKET_CARD_VIEW:"toggle-market-card-view",TOGGLE_HANGAR_MODE:"toggle-hangar-mode",SET_HANGAR_PAGE:"set-hangar-page"}),N=Object.freeze({SCREEN_LOAD:"SCREEN_LOAD",ACTION:"ACTION",INFO:"INFO"}),_=Object.freeze({STARTING_CREDITS:5e3,STARTING_DEBT_INTEREST:125,REPAIR_COST_PER_HP:75,REPAIR_AMOUNT_PER_TICK:5,FUEL_SCALAR:3,INTEREST_INTERVAL:30,PASSIVE_REPAIR_RATE:.02,HULL_DECAY_PER_TRAVEL_DAY:1/7,SHIP_SELL_MODIFIER:.75,RARE_SHIP_CHANCE:.3,PRICE_HISTORY_LENGTH:65,FINANCE_HISTORY_LENGTH:10,DAILY_PRICE_VOLATILITY:.15,MEAN_REVERSION_STRENGTH:.07,MARKET_PRESSURE_DECAY:.7,LOAN_GARNISHMENT_DAYS:1095,LOAN_GARNISHMENT_PERCENT:.14,RANDOM_EVENT_CHANCE:.07}),Se=[{threshold:5e4,revealsTier:2},{threshold:45e4,revealsTier:3},{threshold:4e6,revealsTier:4},{threshold:35e6,revealsTier:5},{threshold:3e8,revealsTier:6},{threshold:25e8,revealsTier:7}],Ae="orbitalTraderSave_v2";var Me={START_YEAR:2140,START_DAY_OF_WEEK:1,DAYS_IN_MONTH:[31,28,31,30,31,30,31,31,30,31,30,31],MONTH_NAMES:["January","February","March","April","May","June","July","August","September","October","November","December"],DAY_NAMES:["Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"]},Ve={NEUTRAL:{name:"Neutral System",duration:28,description:"Standard space-faring conditions. Markets are operating under normal parameters.",modifiers:{}}},d={CONFIG:{INTEL_COST_PERCENTAGE:.2,INTEL_MIN_CREDITS:5e3,INTEL_CHANCE:.3,INTEL_DEMAND_MOD:1.8,INTEL_DEPRESSION_MOD:.5},SYSTEM_STATES:Ve,DATE_CONFIG:Me,INTRO_SEQUENCE_V1:{modals:[{id:"lore_1",title:"Year 2140",description:'Humanity has expanded throughout the Solar System.<br><br> <span class="hl">Commerce</span> has thrived among the numerous colonies and stations longer than living memory.',buttonText:"Begin",contentClass:"text-center"},{id:"lore_2",title:"The Price of Freedom",description:"A dead-end job in the Belt pays the bills, but it does not offer the <b class='hl-green font-bold'>prosperity</b> that you dream of.<br><br>The <span class='hl'>Merchant's Guild</span> will fund your ambition, but their price is steep.<br><br>This is no simple loan; it's a bet on yourself and your future.",buttonText:"Apply for Loan",contentClass:"text-center",buttonClass:"btn-pulse-green"},{id:"charter",title:`<span class="hl">MERCHANT'S GUILD LOAN AGREEMENT</span>`,description:`
    ...
    `}function Qe(o,e,t){let i=d.SHIPS[e],a=t?o.player.shipStates[e]:null,{player:s}=o,n="";if(t){let c=s.activeShipId===e;n=`<div class="status-badge" style="border-color: ${c?"var(--theme-color-primary)":"var(--ot-border-light)"}; color: ${c?"var(--theme-color-primary)":"var(--ot-text-secondary)"};">${c?"ACTIVE":"STORED"}</div>`}let r=`
    ...
    `}function Le(o,e,t,i,a,s){let n=t.class.toLowerCase();return s?`
            <div class="info-panel-content info-panel-hangar flex-col justify-between h-full">
                ...
                <div class="hangar-specs my-4">
                    ...
                    ${fe("Cargo",O(a.inventories[e]),t.cargoCapacity,"var(--class-s-color)")}
                </div>
        ...
        `:`
             <div class="info-panel-content info-panel-shipyard flex-col justify-between h-full">
                <div>
                    <h3 class="text-2xl font-orbitron inset-text-shadow" style="color: var(--class-${n}-color);">${t.name}</h3>
                    <p class="text-md text-gray-400 inset-text-shadow">Class ${t.class} ${t.role||"Freighter"}</p>
                    <p class="ship-price-display font-roboto-mono text-2xl">${T(t.price)}</p>
                </div>
                 <div class="grid grid-cols-3 gap-2 my-4">
                    ${ve("Max Hull",t.maxHealth)}
                    ${ve("Max Fuel",t.maxFuel)}
                    ${ve("Cargo Hold",t.cargoCapacity)}
                </div>
                <div class="flavor-text-box mt-auto" style="border-color: var(--frame-border-color);">
                    <p class="text-sm text-gray-300">${t.lore}</p>
                </div>
            </div>
        `}function we(o,e,t,i,a){if(i){let s=t.activeShipId===o,n=t.ownedShipIds.length>1&&!s,r=Math.floor(e.price*_.SHIP_SELL_MODIFIER);return`
            <div class="grid grid-cols-2 gap-2">
                ...
                <button class="action-button" data-action="${S.SELL_SHIP}" data-ship-id="${o}" ${n?"":"disabled"} style="background-color: var(--ot-hangar-red-base);">
                    ...
                    <span class="action-button-price font-roboto-mono">${T(r,!0)}</span>
                </button>
            </div>
        ...
        `}}function fe(o,e,t,i){let a=t>0?e/t*100:0;return`
    ...
    `}function ve(o,e){return`
        <div class="spec-card">
            <p class="text-xs text-gray-400">${o}</p>
            <p class="text-lg font-bold font-orbitron">${e}</p>
        </div>
    `}function ke(o,e,t,i){return`<div class="scroll-panel">
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">${d.COMMODITIES.filter(n=>n.tier<=o.player.revealedTier).map(n=>Xe(n,o,t,i)).join("")}</div>
            </div>`}function Xe(o,e,t,i){let{player:a,market:s,currentLocationId:n,tutorials:r,uiState:l}=e,c=a.inventories[a.activeShipId]?.[o.id],u=t(e,o.id),h=t(e,o.id,!0),m=s.galacticAverages[o.id],p=s.inventory[n]?.[o.id],f=!o.licenseId||a.unlockedLicenseIds.includes(o.licenseId),b=r.activeBatchId==="intro_missions"&&r.activeStepId==="mission_2_2",I=r.activeBatchId==="intro_missions"&&r.activeStepId==="mission_2_3",R=b&&o.id!==y.PLASTEEL||I,x=`data-tooltip="${o.lore}"`,D=c&&c.quantity>0?c.quantity:"0",q=l.marketCardMinimized[o.id],L=Y({price:u,sellPrice:h,galacticAvg:m,playerItem:c}),k=c&&c.quantity>0?`<div class="avg-cost-display" id="avg-cost-${o.id}">Avg. Cost: ${T(c.avgCost,!1)}</div>`:"",C;f?C=`
             <div class="transaction-controls" data-mode="${i[o.id]?.mode||"buy"}" data-good-id="${o.id}" ${R?"disabled":""}>
    ...
    <div class="item-card-container ${f?"":"locked"} ${q?"minimized":""}" id="item-card-container-${o.id}">
        <div class="rounded-lg border ${o.styleClass} transition-colors shadow-md">
            <button class="card-toggle-btn" data-action="${S.TOGGLE_MARKET_CARD_VIEW}" data-good-id="${o.id}">${q?"+":"\u2212"}</button>
            ...
            <div class="max-view-content">
                ...
                <p id="price-display-${o.id}" class="font-roboto-mono font-bold price-text" data-action="${S.SHOW_PRICE_GRAPH}" data-good-id="${o.id}" data-base-price="${u}">${T(u)}</p>
    ...
    </div>`}function Oe(){return'<div id="map-container" class="w-full h-full"></div>'}function Pe(o){let e=d3.select("#map-container");if(!e.node()||!e.select("svg").empty())return;let t=e.append("svg").attr("id","map-svg").attr("width","100%").attr("height","100%"),a=t.append("defs").append("radialGradient").attr("id","sun-gradient");a.append("stop").attr("offset","0%").attr("stop-color","#fef08a"),a.append("stop").attr("offset","100%").attr("stop-color","#fde047"),t.append("circle").attr("class","sun").attr("cx","50%").attr("cy",-195).attr("r",225).attr("fill","url(#sun-gradient)"),t.append("line").attr("class","central-axis").attr("x1","50%").attr("y1",0).attr("x2","50%").attr("y2","100%");let s={[g.VENUS]:1.035,[g.EARTH]:1.035,[g.LUNA]:.805,[g.MARS]:.9775,[g.BELT]:.805,[g.EXCHANGE]:.805,[g.JUPITER]:1.564,[g.SATURN]:1.46625,[g.URANUS]:1.27075,[g.NEPTUNE]:1.27075,[g.KEPLER]:.8625,[g.PLUTO]:.92},n=d.MARKETS.filter(h=>o.lastKnownState.player.unlockedLocationIds.includes(h.id)).map(h=>{let p=(h.parent?8:12)*(s[h.id]||1),f=h.distance;if(h.parent){let b=d.MARKETS.find(I=>I.id===h.parent);b&&(f=b.distance+.1)}return{...h,effectiveDistance:f,finalRadius:p}}).sort((h,m)=>h.effectiveDistance-m.effectiveDistance),r=d3.scalePoint().domain(n.map(h=>h.id)).range([120,e.node().clientHeight-80]).padding(.1),l=e.node().clientWidth/2,c=t.selectAll(".poi-group").data(n).enter().append("g").attr("class","poi-group").attr("data-action","show-map-modal").attr("data-location-id",h=>h.id).on("click",(h,m)=>{o.showMapDetailModal(m.id)});c.filter(h=>h.id!==g.BELT).append("circle").attr("cx","50%").attr("cy",h=>r(h.id)).attr("r",h=>h.finalRadius).attr("fill",h=>h.navTheme.borderColor);let u=c.filter(h=>h.id===g.BELT);if(!u.empty()){let h=u.datum().finalRadius;u.append("path").attr("d",`M 0,${-h} L ${h},0 L 0,${h} L ${-h},0 Z`).attr("transform",m=>`translate(${l}, ${r(m.id)})`).attr("fill",m=>m.navTheme.borderColor)}c.append("line").attr("class","leader-line").attr("x1","50%").attr("y1",h=>r(h.id)).attr("x2",(h,m)=>l+(m%2===0?-46:46)).attr("y2",h=>r(h.id)),c.append("text").attr("class","poi-label").attr("x",(h,m)=>l+(m%2===0?-52:52)).attr("y",h=>r(h.id)).attr("text-anchor",(h,m)=>m%2===0?"end":"start").attr("dominant-baseline","middle").text(h=>h.name)}function De(o){let{player:e,currentLocationId:t,TRAVEL_DATA:i,tutorials:a}=o,{navLock:s}=a,n=s&&s.screenId===v.NAVIGATION,r=n?s.enabledElementQuery:null;return`
        <div class="scroll-panel p-1">
            <div class="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-6">
            ${d.MARKETS.filter(l=>e.unlockedLocationIds.includes(l.id)).map(l=>{let c=l.id===t,u=c?null:i[t][l.id],h=!1;if(n&&r){let p=document.createElement("div");p.innerHTML=`<div data-location-id="${l.id}"></div>`,h=!p.querySelector(r)}let m=h?"disabled-location":"";return`<div class="location-card p-6 rounded-lg text-center flex flex-col ${c?"highlight-current":""} ${l.color} ${l.bg} ${m}" 
                                 data-action="show-launch-modal" data-location-id="${l.id}" ${h?"disabled":""}>
        ...
        </div>`}function $e(o){let{player:e,currentLocationId:t}=o,i=d.SHIPS[e.activeShipId],a=e.shipStates[e.activeShipId],s=d.MARKETS.find(h=>h.id===t),n=s?.navTheme||{gradient:"linear-gradient(135deg, #4a5568, #2d3748)",textColor:"#f0f0f0",borderColor:"#7a9ac0"},r=s.fuelPrice/2;e.activePerks[E.VENETIAN_SYNDICATE]&&t===g.VENUS&&(r*=1-d.PERKS[E.VENETIAN_SYNDICATE].fuelDiscount);let l=i.maxHealth*(_.REPAIR_AMOUNT_PER_TICK/100)*_.REPAIR_COST_PER_HP;e.activePerks[E.VENETIAN_SYNDICATE]&&t===g.VENUS&&(l*=1-d.PERKS[E.VENETIAN_SYNDICATE].repairDiscount);let c=a.fuel/i.maxFuel*100,u=a.health/i.maxHealth*100;return`
        <div class="services-scroll-panel">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl mx-auto mt-8">
                <div class="p-4 rounded-lg text-center shadow-lg panel-border border" style="border-color: ${n.borderColor}; color: ${n.textColor}; background: ${n.gradient};">
                    ...
                    <p class="mb-3">Price: <span class="font-bold">\u232C ${T(r,!1)}</span> / 5 units</p>
                ...
                <div class="p-4 rounded-lg text-center shadow-lg panel-border border" style="border-color: ${n.borderColor}; color: ${n.textColor}; background: ${n.gradient};">
                    ...
                    <p class="mb-3">Price: <span class="font-bold">\u232C ${T(l,!1)}</span> / 5% repair</p>
        ...
        </div>`}function He(o){let e=o.player.inventories[o.player.activeShipId];if(!e)return'<p class="text-center text-gray-500 text-lg">No active ship.</p>';let t=Object.entries(e).filter(([,a])=>a.quantity>0);return t.length===0?'<p class="text-center text-gray-500 text-lg">Your cargo hold is empty.</p>':`<div class="cargo-scroll-panel"><div class="cargo-grid">${t.map(([a,s])=>{let n=d.COMMODITIES.find(r=>r.id===a);return Je(n,s)}).join("")}</div></div>`}function Je(o,e){let t=U(o.styleClass);return`
    ...
    `}function Be(o,e){let t=U(o.styleClass),a={RAW:"Raw Material",IND:"Industrial Product",AGRI:"Agricultural Good",TECH:"Technology",CIV:"Civilian Commodity",BIO:"Bioware",RARE:"Exotic Material"}[o.cat]||"Unknown",n=(o.basePriceRange[0]+o.basePriceRange[1])/2*e.quantity;return`
    ...
    `}function Fe(o){let{player:e,day:t,currentLocationId:i}=o,s=d.MARKETS.find(l=>l.id===i)?.navTheme||{gradient:"linear-gradient(135deg, #4a5568, #2d3748)",textColor:"#f0f0f0",borderColor:"#7a9ac0"},n;if(e.debt>0){let l="";if(e.loanStartDate){let c=_.LOAN_GARNISHMENT_DAYS-(t-e.loanStartDate);c>0&&(l=`<p class="text-xs text-red-400/70 mt-2">Garnishment in ${c} days</p>`)}n=`
            <div>
                ...
                <div class="p-4 rounded-lg flex flex-col items-center justify-center space-y-2 shadow-lg panel-border border text-center" style="border-color: ${s.borderColor}; color: ${s.textColor}; background: ${s.gradient};">
                    ...
                    ${l}
                        ...
                        <span class="font-orbitron text-cyan-300">\u232C ${T(p.amount,!1)}</span>
                    </button>`).join("");n=`
            <div>
            ...
            <div class="grid grid-cols-4 gap-2 p-2 border-b border-slate-700 text-sm">
                ...
                <span class="${c} text-right">${u}${T(l.amount,!1)}</span>
            </div>
        `}).join("");return`
    ...
    `}function qe(){return`
        <div class="intel-scroll-panel">
            ...
            <div class="context-bar" style="background: ${b.gradient}; color: ${b.textColor};">
                ...
                <div class="ship-card p-4 flex flex-col space-y-3">
                    <div class="flex justify-between items-start">
                        ...
                        <div class="text-right">
                            <p class="text-lg font-bold text-cyan-300">${T(n.price)}</p>
                        </div>
                    </div>
                ...
                </div>`}else{let u=a.shipStates[t],h=a.inventories[t],m=O(h),p=t===a.activeShipId,f=a.ownedShipIds.length>1&&!p,b=Math.floor(n.price*_.SHIP_SELL_MODIFIER);r=`
                <div class="ship-card p-4 flex flex-col space-y-3 ${p?"border-yellow-400":""}">
                    ...
                    <div class="grid grid-cols-2 gap-2 mt-2">
                        ...
                        <button class="btn" data-action="${S.SELL_SHIP}" data-ship-id="${t}" ${f?"":"disabled"}>Sell<br>\u232C ${T(b,!1)}</button>
                    </div>
            ...
            <div class="my-4 p-4 rounded-lg" style="background-color: rgba(0,0,0,0.3);">
                ...
                <div class="text-center font-roboto-mono space-y-1 imprinted-text">
                    ...
                    <p><b>Services:</b> Fuel @ ${T(t.fuelPrice,!0)}/unit</p>
                </div>
            </div>
            <div class="text-center">
                <div>
