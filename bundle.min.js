(()=>{var b=Object.freeze({MAP:"map",NAVIGATION:"navigation",SERVICES:"services",MARKET:"market",CARGO:"cargo",HANGAR:"hangar",MISSIONS:"missions",FINANCE:"finance",INTEL:"intel"}),_=Object.freeze({SHIP:"ship",STARPORT:"starport",DATA:"data"}),A=Object.freeze({WANDERER:"starter",STALWART:"hauler_c1",MULE:"hauler_c2",PATHFINDER:"explorer_b1",NOMAD:"explorer_b2",VINDICATOR:"frigate_a1",AEGIS:"frigate_a2",ODYSSEY:"luxury_s1",MAJESTIC:"luxury_s2",TITAN_HAULER:"rare_s1",VOID_CHASER:"rare_s2",GUARDIAN:"rare_s3",STARGAZER:"rare_s4",BEHEMOTH:"rare_o1"}),y=Object.freeze({WATER_ICE:"water_ice",PLASTEEL:"plasteel",HYDROPONICS:"hydroponics",CYBERNETICS:"cybernetics",PROPELLANT:"propellant",PROCESSORS:"processors",GMO_SEEDS:"gmo_seeds",CRYO_PODS:"cryo_pods",ATMO_PROCESSORS:"atmos_processors",CLONED_ORGANS:"cloned_organs",XENO_GEOLOGICALS:"xeno_geologicals",SENTIENT_AI:"sentient_ai",ANTIMATTER:"antimatter",FOLDED_DRIVES:"folded_drives"}),g=Object.freeze({EARTH:"loc_earth",LUNA:"loc_luna",MARS:"loc_mars",VENUS:"loc_venus",BELT:"loc_belt",SATURN:"loc_saturn",JUPITER:"loc_jupiter",URANUS:"loc_uranus",NEPTUNE:"loc_neptune",PLUTO:"loc_pluto",EXCHANGE:"loc_exchange",KEPLER:"loc_kepler"}),E=Object.freeze({TRADEMASTER:"trademaster",NAVIGATOR:"navigator",VENETIAN_SYNDICATE:"venetian_syndicate",MERCHANT_GUILD_SHIP:"merchant_guild_ship"}),S=Object.freeze({DEBUG_SIMPLE_START:"debug-simple-start",SET_SCREEN:"set-screen",TRAVEL:"travel",BUY_SHIP:"buy-ship",SELL_SHIP:"sell-ship",SELECT_SHIP:"select-ship",PAY_DEBT:"pay-debt",TAKE_LOAN:"take-loan",PURCHASE_INTEL:"purchase-intel",ACQUIRE_LICENSE:"acquire-license",BUY_ITEM:"buy-item",SELL_ITEM:"sell-item",SET_MAX_BUY:"set-max-buy",SET_MAX_SELL:"set-max-sell",INCREMENT:"increment",DECREMENT:"decrement",SHOW_PRICE_GRAPH:"show-price-graph",SHOW_FINANCE_GRAPH:"show-finance-graph",TOGGLE_MARKET_CARD_VIEW:"toggle-market-card-view",TOGGLE_HANGAR_MODE:"toggle-hangar-mode",SET_HANGAR_PAGE:"set-hangar-page"}),w=Object.freeze({SCREEN_LOAD:"SCREEN_LOAD",ACTION:"ACTION",INFO:"INFO"}),M=Object.freeze({STARTING_CREDITS:5e3,STARTING_DEBT_INTEREST:125,REPAIR_COST_PER_HP:75,REPAIR_AMOUNT_PER_TICK:5,FUEL_SCALAR:3,INTEREST_INTERVAL:30,PASSIVE_REPAIR_RATE:.02,HULL_DECAY_PER_TRAVEL_DAY:1/7,SHIP_SELL_MODIFIER:.75,RARE_SHIP_CHANCE:.3,PRICE_HISTORY_LENGTH:65,FINANCE_HISTORY_LENGTH:25,DAILY_PRICE_VOLATILITY:.15,MEAN_REVERSION_STRENGTH:.07,MARKET_PRESSURE_DECAY:.7,LOAN_GARNISHMENT_DAYS:1095,LOAN_GARNISHMENT_PERCENT:.14,RANDOM_EVENT_CHANCE:.07}),pe=[{threshold:5e4,revealsTier:2},{threshold:45e4,revealsTier:3},{threshold:4e6,revealsTier:4},{threshold:35e6,revealsTier:5},{threshold:3e8,revealsTier:6},{threshold:25e8,revealsTier:7}],Te="orbitalTraderSave_v2";var Ie={START_YEAR:2140,START_DAY_OF_WEEK:1,DAYS_IN_MONTH:[31,28,31,30,31,30,31,31,30,31,30,31],MONTH_NAMES:["January","February","March","April","May","June","July","August","September","October","November","December"],DAY_NAMES:["Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"]},Fe={NEUTRAL:{name:"Neutral System",duration:28,description:"Standard space-faring conditions. Markets are operating under normal parameters.",modifiers:{}}},d={CONFIG:{INTEL_COST_PERCENTAGE:.2,INTEL_MIN_CREDITS:5e3,INTEL_CHANCE:.3,INTEL_DEMAND_MOD:1.8,INTEL_DEPRESSION_MOD:.5},SYSTEM_STATES:Fe,DATE_CONFIG:Ie,INTRO_SEQUENCE_V1:{modals:[{id:"lore_1",title:"Year 2140",description:'Humanity has expanded throughout the Solar System.<br><br> <span class="hl">Commerce</span> has thrived among the numerous colonies and stations longer than living memory.',buttonText:"Begin",contentClass:"text-center"},{id:"lore_2",title:"The Price of Freedom",description:"A dead-end job in the Belt pays the bills, but it does not offer the <b class='hl-green font-bold'>prosperity</b> that you dream of.<br><br>The <span class='hl'>Merchant's Guild</span> will fund your ambition, but their price is steep.<br><br>This is no simple loan; it's a bet on yourself and your future.",buttonText:"Apply for Loan",contentClass:"text-center",buttonClass:"btn-pulse-green"},{id:"charter",title:`<span class="hl">MERCHANT'S GUILD LOAN AGREEMENT</span>`,description:`
    ...
    `}function Me(o,e,t,i,a,s){let n=t.class.toLowerCase();return s?`
        ...
        `}function xe(o,e,t,i,a){if(i){let s=t.activeShipId===o,n=t.ownedShipIds.length>1&&!s,r=Math.floor(e.price*M.SHIP_SELL_MODIFIER);return`
    ...
    `}function Re(o,e,t,i){return`<div class="scroll-panel">
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">${d.COMMODITIES.filter(n=>n.tier<=o.player.revealedTier).map(n=>We(n,o,t,i)).join("")}</div>
            </div>`}function We(o,e,t,i){let{player:a,market:s,currentLocationId:n,tutorials:r,uiState:l}=e,c=a.inventories[a.activeShipId]?.[o.id],u=t(e,o.id),h=t(e,o.id,!0),m=s.galacticAverages[o.id],p=s.inventory[n]?.[o.id],v=!o.licenseId||a.unlockedLicenseIds.includes(o.licenseId),T=r.activeBatchId==="intro_missions"&&r.activeStepId==="mission_2_2",I=r.activeBatchId==="intro_missions"&&r.activeStepId==="mission_2_3",x=T&&o.id!==y.PLASTEEL||I,C=`data-tooltip="${o.lore}"`,k=c&&c.quantity>0?c.quantity:"0",O=l.marketCardMinimized[o.id],L=U({price:u,sellPrice:h,galacticAvg:m,playerItem:c}),D=c&&c.quantity>0?`<div class="avg-cost-display" id="avg-cost-${o.id}">Avg. Cost: ${f(c.avgCost,!1)}</div>`:"",R;v?R=`
             <div class="transaction-controls" data-mode="${i[o.id]?.mode||"buy"}" data-good-id="${o.id}" ${x?"disabled":""}>
            ...
            </div>`;let P=c?.quantity>0?` (${c.quantity})`:"";return`
    <div class="item-card-container ${v?"":"locked"} ${O?"minimized":""}" id="item-card-container-${o.id}">
        <div class="rounded-lg border ${o.styleClass} transition-colors shadow-md">
            <button class="card-toggle-btn" data-action="${S.TOGGLE_MARKET_CARD_VIEW}" data-good-id="${o.id}">${O?"+":"\u2212"}</button>
            
            <div class="max-view-content">
                <p class="font-bold commodity-name"><span class="commodity-name-tooltip" ${C}>${o.name}</span></p>
                <p class="avail-text">Avail: <span id="m-stock-${o.id}">${p.quantity}</span>, Own: <span id="p-inv-${o.id}">${k}</span></p>
                ...
                <div class="indicator-container" id="indicators-${o.id}">${L}</div>
        ...
        </div>`}function ke(o){let{player:e,currentLocationId:t}=o,i=d.SHIPS[e.activeShipId],a=e.shipStates[e.activeShipId],s=d.MARKETS.find(h=>h.id===t),n=s?.navTheme||{gradient:"linear-gradient(135deg, #4a5568, #2d3748)",textColor:"#f0f0f0",borderColor:"#7a9ac0"},r=s.fuelPrice/2;e.activePerks[E.VENETIAN_SYNDICATE]&&t===g.VENUS&&(r*=1-d.PERKS[E.VENETIAN_SYNDICATE].fuelDiscount);let l=i.maxHealth*(M.REPAIR_AMOUNT_PER_TICK/100)*M.REPAIR_COST_PER_HP;e.activePerks[E.VENETIAN_SYNDICATE]&&t===g.VENUS&&(l*=1-d.PERKS[E.VENETIAN_SYNDICATE].repairDiscount);let c=a.fuel/i.maxFuel*100,u=a.health/i.maxHealth*100;return`
    ...
    `}function Pe(o){let{player:e,day:t,currentLocationId:i}=o,s=d.MARKETS.find(l=>l.id===i)?.navTheme||{gradient:"linear-gradient(135deg, #4a5568, #2d3748)",textColor:"#f0f0f0",borderColor:"#7a9ac0"},n;if(e.debt>0){let l="";if(e.loanStartDate){let c=M.LOAN_GARNISHMENT_DAYS-(t-e.loanStartDate);c>0&&(l=`<p class="text-xs text-red-400/70 mt-2">Garnishment in ${c} days</p>`)}n=`
            <div>
    ...
    `}function He(){return`
        <div class="intel-scroll-panel">
            ...
            </div>`,x=Object.keys(this.navStructure).map(L=>{let D=L===a,R=n[L]||Object.keys(this.navStructure[L].screens)[0],P=u&&u.navId!==L,G=r||P,me=D?`background: ${T.gradient}; color: ${T.textColor};`:"";return`<div class="tab ${D?"active":""} ${G?"disabled":""}" style="${me}" data-action="${S.SET_SCREEN}" data-nav-id="${L}" data-screen-id="${R}">${this.navStructure[L].label}</div>`}).join(""),C="";if(m&&p&&v){let L=N(v),D=p.health/m.maxHealth*100,R=p.fuel/m.maxFuel*100,P=L/m.cargoCapacity*100;C=`
            ...
            `;return I.isHalf?`<div class="pagination-dot half" style="${x}" data-action="${S.SET_HANGAR_PAGE}" data-jump-direction="${I.jump}"></div>`:`<div class="pagination-dot ${I.isActive?"active":""}" style="${x}" data-action="${S.SET_HANGAR_PAGE}" data-index="${I.index}"></div>`}).join("");n.innerHTML=T}updateStickyBar(e){this.cache.stickyBar.innerHTML="",this.cache.topBarContainer.classList.remove("has-sticky-bar")}updateServicesScreen(e){if(e.activeScreen!==b.SERVICES)return;let{player:t}=e,i=d.SHIPS[t.activeShipId],a=t.shipStates[t.activeShipId],s=this.cache.servicesScreen.querySelector("#fuel-bar"),n=this.cache.servicesScreen.querySelector("#refuel-btn");if(s&&n){let c=a.fuel/i.maxFuel*100;s.style.width=`${c}%`,n.disabled=a.fuel>=i.maxFuel}let r=this.cache.servicesScreen.querySelector("#repair-bar"),l=this.cache.servicesScreen.querySelector("#repair-btn");if(r&&l){let c=a.health/i.maxHealth*100;r.style.width=`${c}%`,l.disabled=a.health>=i.maxHealth}}updateMarketScreen(e){if(e.activeScreen!==b.MARKET)return;let t=this.cache.marketScreen.querySelector(".scroll-panel");this.lastKnownState&&this.lastKnownState.activeScreen===b.MARKET&&this.lastKnownState.currentLocationId===e.currentLocationId&&t?this.marketScrollPosition=t.scrollTop:this.marketScrollPosition=0,this._saveMarketTransactionState(),this.cache.marketScreen.innerHTML=Re(e,this.isMobile,this.getItemPrice,this.marketTransactionState),this._restoreMarketTransactionState();let i=this.cache.marketScreen.querySelector(".scroll-panel");i&&(i.scrollTop=this.marketScrollPosition)}_saveMarketTransactionState(){if(!this.lastKnownState||this.lastKnownState.activeScreen!==b.MARKET)return;this.cache.marketScreen.querySelectorAll(".transaction-controls").forEach(t=>{let i=t.dataset.goodId,a=t.querySelector("input"),s=t.dataset.mode;a&&(this.marketTransactionState[i]={quantity:a.value,mode:s})})}_restoreMarketTransactionState(){for(let e in this.marketTransactionState){let t=this.marketTransactionState[e],i=this.cache.marketScreen.querySelector(`.transaction-controls[data-good-id="${e}"]`);if(i){let a=i.querySelector("input");a&&(a.value=t.quantity,i.setAttribute("data-mode",t.mode),this.updateMarketCardDisplay(e,parseInt(t.quantity,10)||0,t.mode))}}}getItemPrice(e,t,i=!1){let a=e.market.prices[e.currentLocationId][t],s=d.MARKETS.find(r=>r.id===e.currentLocationId);i&&s.specialDemand&&s.specialDemand[t]&&(a*=s.specialDemand[t].bonus);let n=e.intel.active;return n&&n.targetMarketId===e.currentLocationId&&n.commodityId===t&&(a*=n.type==="demand"?d.CONFIG.INTEL_DEMAND_MOD:d.CONFIG.INTEL_DEPRESSION_MOD),Math.max(1,Math.round(a))}_calculateSaleDetails(e,t){let i=this.lastKnownState;if(!i)return{totalPrice:0,effectivePricePerUnit:0,netProfit:0};let a=d.COMMODITIES.find(I=>I.id===e),s=i.market.inventory[i.currentLocationId][e].quantity,n=this.getItemPrice(i,e,!0),l=i.player.inventories[i.player.activeShipId]?.[e]?.avgCost||0;if(s<=0)return{totalPrice:0,effectivePricePerUnit:0,netProfit:0};let c=s*.1;if(t<=c){let I=n*t,x=l*t,C=I-x;if(C>0){let k=(i.player.activePerks[E.TRADEMASTER]?d.PERKS[E.TRADEMASTER].profitBonus:0)+(i.player.birthdayProfitBonus||0);C+=C*k}return{totalPrice:I,effectivePricePerUnit:n,netProfit:C}}let u=t/s,h=0;a.tier<=2?h=Math.min(.1,(u-.1)*.2):a.tier<=5?h=Math.min(.25,(u-.1)*.5):h=Math.min(.4,(u-.1)*.8);let m=n*(1-h),p=Math.floor(m*t),v=l*t,T=p-v;if(T>0){let I=(i.player.activePerks[E.TRADEMASTER]?d.PERKS[E.TRADEMASTER].profitBonus:0)+(i.player.birthdayProfitBonus||0);T+=T*I}return{totalPrice:p,effectivePricePerUnit:m,netProfit:T}}updateMarketCardPrice(e,t){let i=this.cache.marketScreen.querySelector(`#price-display-${e}`);if(i){i.dataset.basePrice=t;let a=i.closest(".item-card-container").querySelector(".transaction-controls");a&&a.dataset.mode==="buy"&&(i.textContent=f(t))}}updateMarketCardDisplay(e,t,i){let a=this.cache.marketScreen.querySelector(`#price-display-${e}`),s=this.cache.marketScreen.querySelector(`#effective-price-display-${e}`),n=this.cache.marketScreen.querySelector(`#indicators-${e}`),r=this.cache.marketScreen.querySelector(`#avg-cost-${e}`);if(!a||!s||!n||!this.lastKnownState)return;let l=this.lastKnownState,c=parseInt(a.dataset.basePrice,10),u=l.player.inventories[l.player.activeShipId]?.[e];if(r&&r.classList.toggle("visible",i==="sell"),i==="buy")a.textContent=f(c),a.className="font-roboto-mono font-bold price-text",s.textContent="",n.innerHTML=U({price:c,sellPrice:this.getItemPrice(l,e,!0),galacticAvg:l.market.galacticAverages[e],playerItem:u});else{let{effectivePricePerUnit:h,netProfit:m}=this._calculateSaleDetails(e,t);if(t>0){let p=`\u232C ${m>=0?"+":""}${f(m,!1)}`;a.textContent=p,s.textContent=`(${f(h,!1)}/unit)`,a.className=`font-roboto-mono font-bold ${m>=0?"profit-text":"loss-text"}`}else a.textContent="\u232C +0",a.className="font-roboto-mono font-bold profit-text",s.textContent="";n.innerHTML=U({price:c,sellPrice:h||this.getItemPrice(l,e,!0),galacticAvg:l.market.galacticAverages[e],playerItem:u})}}showTravelAnimation(e,t,i,a,s){this.travelAnimationService.play(e,t,i,a,s)}queueModal(e,t,i,a=null,s={}){this.modalQueue.push({modalId:e,title:t,description:i,callback:a,options:s}),document.querySelector(".modal-backdrop:not(.hidden)")||this.processModalQueue()}processModalQueue(){if(this.modalQueue.length===0)return;let{modalId:e,title:t,description:i,callback:a,options:s}=this.modalQueue.shift(),n=document.getElementById(e);if(!n)return this.logger.error("UIManager",`Modal element with ID '${e}' not found in the DOM. Aborting modal display.`),this.processModalQueue();s.specialClass&&n.classList.add(s.specialClass),s.nonDismissible&&n.classList.add("dismiss-disabled");let r=e==="mission-modal"?"mission-modal-title":e.replace("-modal","-title"),l=e==="mission-modal"?"mission-modal-description":e.replace("-modal","-description"),c=n.querySelector(`#${r}`),u=n.querySelector(`#${l}`)||n.querySelector(`#${e.replace("-modal","-scenario")}`);c&&(c.innerHTML=t),u&&(u.innerHTML=i,u.className="my-4 text-gray-300",e!=="mission-modal"&&u.classList.add("mb-6","text-lg"),(e==="event-modal"||e==="random-event-modal")&&u.classList.add("text-center"),s.contentClass&&((s.contentClass.includes("text-left")||s.contentClass.includes("text-right")||s.contentClass.includes("text-justify"))&&u.classList.remove("text-center"),u.classList.add(...s.contentClass.split(" ").filter(Boolean))));let h=()=>{this.hideModal(e),a&&a(),this.processModalQueue()};if(s.customSetup)s.customSetup(n,h);else{let m=n.querySelector("#"+e.replace("-modal","-button-container")),p;m?(m.innerHTML="",p=document.createElement("button"),m.appendChild(p)):p=n.querySelector("button"),p&&(p.className="btn px-6 py-2",s.buttonClass&&p.classList.add(s.buttonClass),p.innerHTML=s.buttonText||"Understood",p.onclick=h)}n.classList.remove("hidden"),n.classList.add("modal-visible")}showRandomEventModal(e,t){this.queueModal("random-event-modal",e.title,e.scenario,null,{nonDismissible:!0,customSetup:(i,a)=>{let s=i.querySelector("#random-event-choices-container");s.innerHTML="",e.choices.forEach((n,r)=>{let l=document.createElement("button");l.className="btn w-full text-center p-4 hover:bg-slate-700",l.innerHTML=n.title,l.onclick=()=>{t(e.id,r),a()},s.appendChild(l)})}})}showAgeEventModal(e,t){let i=document.getElementById("age-event-modal");i.classList.add("dismiss-disabled"),document.getElementById("age-event-title").innerHTML=e.title,document.getElementById("age-event-description").innerHTML=e.description;let a=document.getElementById("age-event-button-container");a.innerHTML="",e.choices.forEach(s=>{let n=document.createElement("button");n.className="perk-button",n.innerHTML=`<h4>${s.title}</h4><p>${s.description}</p>`,n.onclick=()=>{this.hideModal("age-event-modal"),t(s)},a.appendChild(n)}),i.classList.remove("hidden"),i.classList.add("modal-visible")}hideModal(e){let t=document.getElementById(e);t&&!t.classList.contains("hidden")&&(t.classList.add("modal-hiding"),t.addEventListener("animationend",()=>{t.classList.add("hidden"),t.classList.remove("modal-hiding","modal-visible","dismiss-disabled","intro-fade-in"),this.modalQueue.length>0&&!document.querySelector(".modal-backdrop:not(.hidden)")&&this.processModalQueue()},{once:!0}))}showProcessingAnimation(e,t){let i=this.cache.processingModal;if(!i)return;let a=i.querySelector("#processing-title"),s=i.querySelector("#processing-progress-bar"),n=i.querySelector("#processing-status");a.textContent=`Processing application for ${e}...`,s.style.width="0%",n.textContent="",i.classList.remove("hidden"),setTimeout(()=>{s.style.width="100%"},100),setTimeout(()=>{n.textContent="Processing complete!",setTimeout(()=>{this.hideModal("processing-modal"),t&&t()},1e3)},4e3)}createFloatingText(e,t,i,a="#fde047"){let s=document.createElement("div");s.textContent=e,s.className="floating-text",s.style.left=`${t-20}px`,s.style.top=`${i-40}px`,s.style.color=a,document.body.appendChild(s),setTimeout(()=>s.remove(),2450)}showGraph(e,t){this.activeGraphAnchor=e;let i=this.cache.graphTooltip,a=e.dataset.action;if(a===S.SHOW_PRICE_GRAPH){let s=e.dataset.goodId,n=t.player.inventories[t.player.activeShipId][s];i.innerHTML=this._renderPriceGraph(s,t,n)}else a===S.SHOW_FINANCE_GRAPH&&(i.innerHTML=this._renderFinanceGraph(t));i.style.display="block",this.updateGraphTooltipPosition()}hideGraph(){this.activeGraphAnchor&&(this.cache.graphTooltip.style.display="none",this.activeGraphAnchor=null)}updateGraphTooltipPosition(){if(!this.activeGraphAnchor)return;let e=this.cache.graphTooltip;if(e.style.display==="none")return;let t=this.activeGraphAnchor.closest(".item-card-container").getBoundingClientRect(),i=e.offsetHeight,a=t.top-i-10,s=t.left;a<10&&(a=t.bottom+10),e.style.left=`${s}px`,e.style.top=`${a}px`}showGenericTooltip(e,t){this.activeGenericTooltipAnchor=e;let i=this.cache.genericTooltip;i.innerHTML=t,i.style.display="block",this.updateGenericTooltipPosition()}hideGenericTooltip(){this.activeGenericTooltipAnchor&&(this.cache.genericTooltip.style.display="none",this.activeGenericTooltipAnchor=null)}updateGenericTooltipPosition(){if(!this.activeGenericTooltipAnchor)return;let e=this.cache.genericTooltip,t=this.activeGenericTooltipAnchor.getBoundingClientRect(),i=e.offsetWidth,a=e.offsetHeight,s=t.right+10,n=t.top+t.height/2-a/2;n<10&&(n=t.bottom+10),s<10&&(s=10),s+i>window.innerWidth&&(s=window.innerWidth-i-10),e.style.left=`${s}px`,e.style.top=`${n}px`}_renderPriceGraph(e,t,i){let a=t.market.priceHistory[t.currentLocationId]?.[e];if(!a||a.length<2)return'<div class="text-gray-400 text-sm p-4">No Data Available!</div>';let s=d.COMMODITIES.find(R=>R.id===e),n=(s.basePriceRange[0]+s.basePriceRange[1])/2,r=280,l=140,c=35,u=a.map(R=>R.price),h=i?.avgCost>0?i.avgCost:null,m=[...u,n];h&&m.push(h);let p=Math.min(...m),v=Math.max(...m),T=v-p>0?v-p:1,I=R=>R/(a.length-1)*(r-c*2)+c,x=R=>l-c-(R-p)/T*(l-c*2.5),C=`<svg width="${r}" height="${l}" xmlns="http://www.w3.org/2000/svg"><rect width="100%" height="100%" fill="#0c101d" />`;C+='<g class="grid-lines" stroke="#1f2937" stroke-width="1">',C+=`<line x1="${c}" y1="${x(v)}" x2="${c}" y2="${l-c}" /><line x1="${c}" y1="${l-c}" x2="${r-c}" y2="${l-c}" />`,C+="</g>";let k=x(n);if(C+=`<line x1="${c}" y1="${k}" x2="${r-c}" y2="${k}" stroke="#facc15" stroke-width="1" stroke-dasharray="3 3" />`,C+=`<text x="${r-c+4}" y="${k+3}" fill="#facc15" font-size="10" font-family="Roboto Mono" text-anchor="start">Avg: ${f(n,!1)}</text>`,h){let R=x(h);C+=`<line x1="${c}" y1="${R}" x2="${r-c}" y2="${R}" stroke="#34d399" stroke-width="1" stroke-dasharray="3 3" />`,C+=`<text x="${r-c+4}" y="${R+3}" fill="#34d399" font-size="10" font-family="Roboto Mono" text-anchor="start">Paid: ${f(h,!1)}</text>`}let O=a.map((R,P)=>`${I(P)},${x(R.price)}`).join(" ");C+=`<polyline fill="none" stroke="#60a5fa" stroke-width="2" points="${O}" />`;let L=a[0].day,D=a[a.length-1].day;return C+=`<text x="${c}" y="${l-c+15}" fill="#9ca3af" font-size="10" font-family="Roboto Mono" text-anchor="start">Day ${L}</text>`,C+=`<text x="${r-c}" y="${l-c+15}" fill="#9ca3af" font-size="10" font-family="Roboto Mono" text-anchor="end">Day ${D}</text>`,C+=`<text x="${c-8}" y="${x(p)+3}" fill="#9ca3af" font-size="10" font-family="Roboto Mono" text-anchor="end">${f(p,!1)}</text>`,C+=`<text x="${c-8}" y="${x(v)+3}" fill="#9ca3af" font-size="10" font-family="Roboto Mono" text-anchor="end">${f(v,!1)}</text>`,C+="</svg>",C}showTutorialToast({step:e,onSkip:t,onNext:i,gameState:a}){let s=this.cache.tutorialToastContainer,n=e.text;if(n.includes("{shipName}")){let u=d.SHIPS[a.player.activeShipId]?.name||"your ship";n=n.replace(/{shipName}/g,u)}n.includes("{playerName}")&&(n=n.replace(/{playerName}/g,a.player.name)),this.cache.tutorialToastText.innerHTML=n,s.className="hidden fixed p-4 rounded-lg shadow-2xl transition-all duration-300 pointer-events-auto";let r;if(this.isMobile?r=`tt-${e.position.mobile||"mobile"}`:r=`tt-${e.position.desktop||"bottom-right"}`,s.classList.add(r),s.style.width=e.size?.width||"auto",s.classList.remove("hidden"),e.completion.type==="INFO"){let u=e.buttonText||"Next &rarr;";this.cache.tutorialToastNextBtn.innerHTML=u,this.cache.tutorialToastNextBtn.style.display="inline-block",this.cache.tutorialToastNextBtn.onclick=i}else this.cache.tutorialToastNextBtn.style.display="none";let c=!1;this.cache.tutorialToastSkipBtn.style.display=c?"block":"none",this.cache.tutorialToastSkipBtn.onclick=t,this.cache.tutorialToastText.scrollTop=0}hideTutorialToast(){this.cache.tutorialToastContainer.classList.add("hidden"),this.applyTutorialHighlight(null)}applyTutorialHighlight(e){this.activeHighlightConfig=e,this._renderHighlightsFromConfig(this.activeHighlightConfig)}_renderHighlightsFromConfig(e){let t=this.cache.tutorialHighlightOverlay;if(t){if(t.innerHTML="",!e){t.classList.add("hidden");return}t.classList.remove("hidden"),e.forEach(i=>{let a=document.createElement("div");a.className="tutorial-cue",a.style.left=`${i.x}px`,a.style.top=`${i.y}px`,a.style.width=`${i.width}px`,a.style.height=`${i.height}px`,a.style.transform=`rotate(${i.rotation}deg)`,a.style.opacity=i.style.opacity,i.style.animation!=="None"&&a.classList.add(`anim-${i.style.animation.toLowerCase()}`);let s="";i.type==="Shape"?s=`
                ...
                </div>`}else{let u=a.shipStates[t],h=a.inventories[t],m=N(h),p=t===a.activeShipId,v=a.ownedShipIds.length>1&&!p,T=Math.floor(n.price*M.SHIP_SELL_MODIFIER);r=`
                <div class="ship-card p-4 flex flex-col space-y-3 ${p?"border-yellow-400":""}">
                    ...
                    <div class="grid grid-cols-2 gap-2 mt-2">
                        ...
                        <button class="btn" data-action="${S.SELL_SHIP}" data-ship-id="${t}" ${v?"":"disabled"}>Sell<br>\u232C ${f(T,!1)}</button>
                    </div>
