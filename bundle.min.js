(()=>{var A=Object.freeze({MAP:"map",NAVIGATION:"navigation",SERVICES:"services",MARKET:"market",CARGO:"cargo",HANGAR:"hangar",MISSIONS:"missions",FINANCE:"finance",INTEL:"intel"}),N=Object.freeze({SHIP:"ship",STARPORT:"starport",DATA:"data"}),L=Object.freeze({WANDERER:"starter",STALWART:"hauler_c1",MULE:"hauler_c2",PATHFINDER:"explorer_b1",NOMAD:"explorer_b2",VINDICATOR:"frigate_a1",AEGIS:"frigate_a2",ODYSSEY:"luxury_s1",MAJESTIC:"luxury_s2",TITAN_HAULER:"rare_s1",VOID_CHASER:"rare_s2",GUARDIAN:"rare_s3",STARGAZER:"rare_s4",BEHEMOTH:"rare_o1"}),E=Object.freeze({WATER_ICE:"water_ice",PLASTEEL:"plasteel",HYDROPONICS:"hydroponics",CYBERNETICS:"cybernetics",PROPELLANT:"propellant",PROCESSORS:"processors",GMO_SEEDS:"gmo_seeds",CRYO_PODS:"cryo_pods",ATMO_PROCESSORS:"atmos_processors",CLONED_ORGANS:"cloned_organs",XENO_GEOLOGICALS:"xeno_geologicals",SENTIENT_AI:"sentient_ai",ANTIMATTER:"antimatter",FOLDED_DRIVES:"folded_drives"}),v=Object.freeze({EARTH:"loc_earth",LUNA:"loc_luna",MARS:"loc_mars",VENUS:"loc_venus",BELT:"loc_belt",SATURN:"loc_saturn",JUPITER:"loc_jupiter",URANUS:"loc_uranus",NEPTUNE:"loc_neptune",PLUTO:"loc_pluto",EXCHANGE:"loc_exchange",KEPLER:"loc_kepler"}),C=Object.freeze({TRADEMASTER:"trademaster",NAVIGATOR:"navigator",VENETIAN_SYNDICATE:"venetian_syndicate",MERCHANT_GUILD_SHIP:"merchant_guild_ship"}),T=Object.freeze({DEBUG_SIMPLE_START:"debug-simple-start",SET_SCREEN:"set-screen",TRAVEL:"travel",BUY_SHIP:"buy-ship",SELL_SHIP:"sell-ship",SELECT_SHIP:"select-ship",PAY_DEBT:"pay-debt",TAKE_LOAN:"take-loan",PURCHASE_INTEL:"purchase-intel",ACQUIRE_LICENSE:"acquire-license",BUY_ITEM:"buy-item",SELL_ITEM:"sell-item",SET_MAX_BUY:"set-max-buy",SET_MAX_SELL:"set-max-sell",INCREMENT:"increment",DECREMENT:"decrement",SHOW_PRICE_GRAPH:"show-price-graph",SHOW_FINANCE_GRAPH:"show-finance-graph",TOGGLE_MARKET_CARD_VIEW:"toggle-market-card-view",TOGGLE_HANGAR_MODE:"toggle-hangar-mode",SET_HANGAR_PAGE:"set-hangar-page"}),D=Object.freeze({SCREEN_LOAD:"SCREEN_LOAD",ACTION:"ACTION",INFO:"INFO"}),M=Object.freeze({STARTING_CREDITS:5e3,STARTING_DEBT_INTEREST:125,REPAIR_COST_PER_HP:75,REPAIR_AMOUNT_PER_TICK:5,FUEL_SCALAR:3,INTEREST_INTERVAL:30,PASSIVE_REPAIR_RATE:.02,HULL_DECAY_PER_TRAVEL_DAY:1/7,SHIP_SELL_MODIFIER:.75,RARE_SHIP_CHANCE:.3,PRICE_HISTORY_LENGTH:65,FINANCE_HISTORY_LENGTH:25,DAILY_PRICE_VOLATILITY:.25,MEAN_REVERSION_STRENGTH:.04,MARKET_PRESSURE_DECAY:.7,LOCAL_PRICE_MOD_STRENGTH:.5,LOAN_GARNISHMENT_DAYS:1095,LOAN_GARNISHMENT_PERCENT:.14,RANDOM_EVENT_CHANCE:.07}),ve=[{threshold:5e4,revealsTier:2},{threshold:45e4,revealsTier:3},{threshold:4e6,revealsTier:4},{threshold:35e6,revealsTier:5},{threshold:3e8,revealsTier:6},{threshold:25e8,revealsTier:7}],Ce="orbitalTraderSave_v2";var Me={mission_tutorial_01:{id:"mission_tutorial_01",name:"Milk Run to Luna",type:"DELIVERY",host:"STATION",isRepeatable:!1,isAbandonable:!1,description:"Hey buddy, you're a new captain, right? My hauler's reactor is fried and I'm on the hook for a delivery to Luna.<br><br>Could you deliver this load of <b>Plasteel</b> to the <b>Moon</b> for me? I don't have any credits to spare, but I've padded the manifest.<br><br>Deliver what I owe, keep the rest. You won't have trouble selling it there, trust me.",objectives:[{type:"have_item",goodId:"plasteel",quantity:5}],completion:{locationId:"loc_luna",title:"Favor Complete",text:"The freelancer sends his thanks.",buttonText:"Deliver Plasteel"},rewards:[],providedCargo:[{goodId:"plasteel",quantity:6}]},mission_tutorial_02:{id:"mission_tutorial_02",name:"Martian Resupply",type:"DELIVERY",host:"STATION",isRepeatable:!1,isAbandonable:!1,description:"A construction crew on Mars has requested a small shipment of plasteel to complete a habitat.",prerequisites:[{type:"mission_completed",missionId:"mission_tutorial_01"}],objectives:[{type:"have_item",goodId:"plasteel",quantity:2}],completion:{locationId:"loc_mars",title:"Delivery Complete",text:"The construction foreman thanks you for the Plasteel.",buttonText:"Deliver Plasteel"},rewards:[{type:"credits",amount:7500}]},mission_license_t3:{id:"mission_license_t3",name:"Guild Certification",type:"LICENSE_GRANT",host:"GUILD",isRepeatable:!1,isAbandonable:!1,description:"The Merchant's Guild requires you to certify your trade proficiency. Accepting this contract formally recognizes your status and grants you access to Tier 3 commodities.",prerequisites:[{type:"revealed_tier",tier:3}],objectives:[],completion:{},rewards:[{type:"license",licenseId:"t3_license"}]},mission_license_t5:{id:"mission_license_t5",name:"Governor's Contract",type:"LICENSE_GRANT",host:"STATION",isRepeatable:!1,isAbandonable:!1,description:"The planetary governor requires a sign of your commitment to local industry. This contract solidifies your standing and unlocks access to Tier 5 commodities.",prerequisites:[{type:"revealed_tier",tier:5}],objectives:[],completion:{},rewards:[{type:"license",licenseId:"t5_license"}]},mission_license_t7:{id:"mission_license_t7",name:"Legendary Run",type:"LICENSE_GRANT",host:"UNKNOWN",isRepeatable:!1,isAbandonable:!1,description:"Your name is spoken in the farthest corners of the system. Only a legend of your stature may be granted the right to trade the most advanced technologies known.",prerequisites:[{type:"revealed_tier",tier:7}],objectives:[],completion:{},rewards:[{type:"license",licenseId:"t7_license"}]}};var Le=[{id:"distress_call",title:"Distress Call",scenario:"You pick up a distress signal from a small, damaged ship. They are out of fuel and requesting an emergency transfer to restart their reactor.",precondition:(c,e)=>e.fuel>=20,choices:[{title:"Offer Aid (20 Fuel)",outcomes:[{chance:.75,description:"The fuel transfer is successful. The grateful captain rewards you with 10,000 credits for your timely assistance.",effects:[{type:"fuel",value:-20},{type:"credits",value:1e4}]},{chance:.25,description:"As the fuel transfer begins, their reactor overloads! The resulting explosion damages your hull by 15%.",effects:[{type:"fuel",value:-20},{type:"hull_damage_percent",value:15}]}]},{title:"Ignore the Call",outcomes:[{chance:1,description:"You press on, and the desperate signal fades behind you.",effects:[]}]}]},{id:"floating_cargo",title:"Floating Cargo Pod",scenario:"Long-range sensors detect an unmarked, sealed cargo pod adrift in the shipping lane. It appears to be intact.",precondition:()=>!0,choices:[{title:"Bring it Aboard",outcomes:[{chance:.6,description:"The pod contains valuable goods. You gain 25 units of Neural Processors.",effects:[{type:"add_cargo",value:{id:E.PROCESSORS,quantity:25}}]},{chance:.4,description:"It was a trap! The pod is booby-trapped and detonates as your tractor beam locks on, causing 20% hull damage.",effects:[{type:"hull_damage_percent",value:20}]}]},{title:"Report it",outcomes:[{chance:1,description:"You notify the nearest station of the hazard and receive a small finder's fee of 1,000 credits.",effects:[{type:"credits",value:1e3}]}]}]},{id:"adrift_passenger",title:"Adrift Passenger",scenario:"You find a spacer in a functioning escape pod. Their beacon is down, and they ask for passage to the nearest civilized port.",precondition:(c,e)=>e.fuel>=30,choices:[{title:"Take Aboard for Payment",outcomes:[{chance:1,description:"The passenger is grateful for the rescue and pays you 10,000 credits upon arrival at your destination.",effects:[{type:"credits",value:1e4}]}]},{title:"Give a Fuel Cell (30 Fuel)",outcomes:[{chance:1,descriptions:{reward_cybernetics:'In gratitude, the passenger gives you a crate of <span class="hl-green">40 Cybernetics</span>.',reward_debt_paid:'Seeing your tight cargo, the passenger pays off 20% of your debt, reducing it by <span class="hl-green">{amount}</span>.',reward_credits:'With no room and no debt, the passenger transfers you <span class="hl-green">{amount}</span>.'},effects:[{type:"ADRIFT_PASSENGER"}]}]}]},{id:"meteoroid_swarm",title:"Micrometeoroid Swarm",scenario:"Alarms blare as you fly into an uncharted micrometeoroid swarm. Your navigation computer suggests two options to minimize damage.",precondition:(c,e)=>e.fuel>=15,choices:[{title:"Evade Aggressively (+15 Fuel)",outcomes:[{chance:1,description:"You burn extra fuel to successfully dodge the worst of the swarm, emerging unscathed.",effects:[{type:"fuel",value:-15}]}]},{title:"Brace for Impact",outcomes:[{chance:1,description:"You trust your hull to withstand the impacts, taking a beating but saving fuel.",effects:[{type:"hull_damage_percent",value:[10,25]}]}]}]},{id:"engine_malfunction",title:"Engine Malfunction",scenario:"A sickening shudder runs through the ship. A key plasma injector has failed, destabilizing your engine output.",precondition:(c,e,t)=>(t()[E.PLASTEEL]?.quantity||0)>=5,choices:[{title:"Quick, Risky Fix (5 Plasteel)",outcomes:[{chance:.5,description:"The patch holds! The engine stabilizes and you continue your journey without further incident.",effects:[{type:"lose_cargo",value:{id:E.PLASTEEL,quantity:5}}]},{chance:.5,description:"The patch fails catastrophically, causing a small explosion that deals 20% hull damage.",effects:[{type:"lose_cargo",value:{id:E.PLASTEEL,quantity:5}},{type:"hull_damage_percent",value:20}]}]},{title:"Limp to Destination",outcomes:[{chance:1,description:"You shut down the faulty injector. The ship is slower, but stable. Your remaining travel time increases by 25%.",effects:[{type:"travel_time_add_percent",value:.25}]}]}]},{id:"nav_glitch",title:"Navigation Sensor Glitch",scenario:"The nav-console flashes red. Your primary positioning sensors are offline, and you're flying blind in the deep dark.",precondition:()=>!0,choices:[{title:"Attempt Hard Reboot",outcomes:[{chance:.5,description:"Success! The sensors come back online. In your haste, you find a shortcut, shortening your trip. You will arrive the next day.",effects:[{type:"set_travel_time",value:1}]},{chance:.5,description:"The reboot corrupts your course data, sending you on a long, meandering path. This adds 15 days to your journey.",effects:[{type:"travel_time_add",value:15}]}]},{title:"Navigate Manually",outcomes:[{chance:1,description:"You rely on old-fashioned star charts. It's slow but safe, adding 7 days to your trip.",effects:[{type:"travel_time_add",value:7}]}]}]},{id:"life_support_fluctuation",title:"Life Support Fluctuation",scenario:"An alarm indicates unstable oxygen levels. It's not critical yet, but the crew is on edge and efficiency is dropping.",precondition:(c,e)=>e.health>e.maxHealth*.25,choices:[{title:"Salvage materials from the ship to repair the atmospheric regulators. (This will cost 25% hull damage)",outcomes:[{chance:1,description:"You cannibalize some non-essential hull plating to get the regulators working again. The system stabilizes, but the ship's integrity is compromised.",effects:[{type:"hull_damage_percent",value:25}]}]},{title:"Defer Maintenance Costs",outcomes:[{chance:1,description:"You log the issue for later. The cost of repairs and crew hazard pay, 5,000 credits, is added to your debt.",effects:[{type:"add_debt",value:5e3}]}]}]},{id:"cargo_rupture",title:"Cargo Hold Rupture",scenario:"A micrometeorite has punched a small hole in the cargo bay. One of your cargo stacks is exposed to hard vacuum.",precondition:(c,e,t)=>{let i=t();return i?Object.values(i).some(a=>a.quantity>0):!1},choices:[{title:"Jettison Damaged Cargo",outcomes:[{chance:1,description:"You vent the damaged section, losing 10% of a random cargo stack from your hold into the void.",effects:[{type:"lose_random_cargo_percent",value:.1}]}]},{title:"Attempt EVA Repair",outcomes:[{chance:.75,description:"The emergency patch holds! The cargo is safe, but the repair adds 2 days to your trip.",effects:[{type:"travel_time_add",value:2}]},{chance:.25,description:"The patch fails to hold. Explosive decompression destroys 50% of the cargo stack, and the repair still adds 2 days to your trip.",effects:[{type:"lose_random_cargo_percent",value:.5},{type:"travel_time_add",value:2}]}]}]},{id:"space_race",title:"Space Race Wager",scenario:'A smug-looking luxury ship pulls alongside and its captain, broadcasted on your main screen, challenges you to a "friendly" race to the destination.',precondition:c=>c.player.credits>100,choices:[{title:"Accept Wager (Bet: 80% of current credits)",outcomes:[{chance:1,description:"You accept the high-stakes challenge...",effects:[{type:"SPACE_RACE",wagerPercentage:.8,winChance:{S:.85,A:.7,B:.55,C:.4,O:.95}}]}]},{title:"Politely Decline",outcomes:[{chance:1,description:"You decline the race. The luxury ship performs a flashy maneuver and speeds off, leaving you to travel in peace.",effects:[]}]}]},{id:"supply_drop",title:"Emergency Supply Drop",scenario:"You intercept a system-wide emergency broadcast. A new outpost is offering a massive premium for an immediate delivery of a specific commodity that you happen to be carrying.",precondition:(c,e,t)=>{let i=t();return i&&Object.values(i).some(a=>a.quantity>0)},choices:[{title:"Divert Course to Deliver",outcomes:[{chance:1,description:"You sell your entire stack of the requested commodity for 3 times its galactic average value. Your course is diverted to a new, random destination, adding 7 days to your trip.",effects:[{type:"sell_random_cargo_premium",value:3},{type:"travel_time_add",value:7},{type:"set_new_random_destination"}]}]},{title:"Decline and Continue",outcomes:[{chance:1,description:"You stick to your original plan and let someone else handle the emergency supply run.",effects:[]}]}]}];var xe=[{id:"captain_choice",trigger:{day:366},title:"Captain Who?",description:"You've successfully navigated many trades and run a tight ship. Your crew depends on you... but what kind of captain will you be?",choices:[{title:"Trademaster",description:"5% bonus on all trade profits.",perkId:C.TRADEMASTER,playerTitle:"Trademaster"},{title:"Navigator",description:"10% reduced fuel usage, hull decay, and travel time.",perkId:C.NAVIGATOR,playerTitle:"Navigator"}]},{id:"friends_with_benefits",trigger:{credits:5e4},title:"Friends with Benefits",description:"An ally in need is an ally indeed.",choices:[{title:"Join the Merchant's Guild",description:"Receive a free C-Class freighter.",perkId:C.MERCHANT_GUILD_SHIP},{title:"Join the Venetian Syndicate",description:"75% discount on fuel and repairs at Venus.",perkId:C.VENETIAN_SYNDICATE}]}];var Ne={intro_hangar:{title:"Your First Ship",trigger:{type:D.ACTION,action:"INTRO_START_HANGAR"},navLock:!0,steps:[{stepId:"hangar_1",text:"Welcome to the <b>Shipyard</b> on <b>Mars!</b><br><br>Every station has a port from which you can trade ships and manage your <b>Hangar</b>.",size:{width:"400px",height:"auto"},anchorElement:"body",positionX:50,positionY:16,completion:{type:D.INFO},nextStepId:"hangar_2",isSkippable:!0},{stepId:"hangar_2",text:"Now that you've borrowed <b class='hl-yellow font-bold'>extra credits</b>, you can buy your first ship!<br><br>Select one of the options in the <b>Shipyard</b>. Choose carefully...",size:{width:"400px",height:"auto"},anchorElement:"body",positionX:50,positionY:17,completion:{type:D.ACTION,action:T.BUY_SHIP},nextStepId:"hangar_3",isSkippable:!0,unlockPurchase:!0},{stepId:"hangar_3",text:'This is your <b>Hangar</b>. From here you can manage all the ships you own. Select your new ship and <b class="hl-yellow font-bold">Board</b> it to make it your active vessel.',size:{width:"400px",height:"110px"},anchorElement:"body",positionX:50,positionY:12,completion:{type:D.ACTION,action:T.SELECT_SHIP},nextStepId:null,isSkippable:!1}]},intro_finance:{title:"Managing Your Debt",trigger:{type:D.ACTION,action:"INTRO_START_FINANCE"},navLock:!0,steps:[{stepId:"finance_1",text:"That was a big purchase, but don't worry - you've still got some <b class='hl-yellow font-bold'>credits</b> left over!<br><br>Your transaction history and debts can be viewed on the <b>Finance</b> tab within <b>Data</b>.",size:{width:"400px",height:"120px"},anchorElement:"body",positionX:50,positionY:16,completion:{type:D.INFO},nextStepId:"finance_2",isSkippable:!1},{stepId:"finance_2",text:"Dont forget, your debt to the <b class='hl-yellow font-bold'>Merchant's Guild</b> is due in <b class='hl-red font-bold'>3 years</b>.<br><br>You will need to earn <b class='hl-yellow font-bold'>credits</b> to <b>pay off your debt</b>!",size:{width:"400px",height:"auto"},anchorElement:"body",positionX:50,positionY:16,completion:{type:D.INFO},nextStepId:null,isSkippable:!1}]},intro_missions:{id:"intro_missions",title:"First Steps",trigger:{type:"ACTION",action:"INTRO_START_MISSIONS"},navLock:!0,steps:[{stepId:"mission_1_1",text:"This is the <b>Mission Terminal</b>.<br><br>Check the <b>Missions</b> tab often for opportunities to earn <b class='hl-yellow font-bold'>credits</b> and improve your reputation.",size:{width:"400px",height:"auto"},anchorElement:"body",positionX:50,positionY:84,completion:{type:"INFO"},nextStepId:"mission_1_2",isSkippable:!1},{stepId:"mission_1_2",text:"A freelancer at the <b>Mars</b> station has put in a <b>Delivery</b> request. Select the mission '<b>Milk Run to Luna</b>' to view more details.",size:{width:"400px",height:"auto"},anchorElement:"body",positionX:50,positionY:84,completion:{type:"ACTION",action:"show-mission-modal"},nextStepId:"mission_1_3",isSkippable:!1},{stepId:"mission_1_3",text:"The freelancer can't pay, but he's giving you the <b>remaining cargo</b>. Accept the contract.",size:{width:"400px",height:"auto"},anchorElement:"body",positionX:50,positionY:84,completion:{type:"ACTION",action:"accept-mission"},nextStepId:"mission_1_4",isSkippable:!1},{stepId:"mission_1_4",text:"Mission accepted!<br><br>The contract is now <b>active</b> and the cargo as been loaded onto your ship, the <b>{shipName}</b>.<br><br>The freelancer has also loaded extra <b>Plasteel</b> which you can sell for <b class='hl-yellow font-bold'>credits</b>.",size:{width:"400px",height:"auto"},anchorElement:"body",positionX:50,positionY:77,completion:{type:"INFO"},nextStepId:"mission_1_5",isSkippable:!1},{stepId:"mission_1_5",text:"This mission must be completed on the <b>Moon</b>, but you are presently docked at <b>Mars</b>! Therefore, it's time for the maiden voyage of your new ship, the <b>{shipName}</b>!<br><br>On the <b>nav bar</b> at the top, select the <b>Ship</b> tab, then the <b>Navigation</b> tab.",size:{width:"400px",height:"auto"},anchorElement:"body",positionX:50,positionY:27,completion:{type:"SCREEN_LOAD",screenId:"navigation"},nextStepId:"mission_1_6",isSkippable:!1,navLock:{navId:N.SHIP,screenId:"navigation"}},{stepId:"mission_1_6",text:"From here you can travel to other stations in the system. This will cost you <b>time</b>, <b class='hl-blue'>fuel</b>, and wear on the <b class='hl-green'>hull</b> of your ship.<br><br>Select the <b>Moon</b> to lift off from <b>Mars</b>.",size:{width:"400px",height:"170px"},anchorElement:"body",positionX:50,positionY:83,completion:{type:"ACTION",action:"travel"},nextStepId:"mission_1_7",isSkippable:!1,navLock:{navId:N.SHIP,screenId:"navigation",enabledElementQuery:"[data-location-id='loc_luna']"}},{stepId:"mission_1_7",text:"You've arrived and docked at the <b>Moon</b> station!<br><br>It's time to deliver the <b>Plasteel</b>. Select the active mission and <b>deliver the Plasteel</b>.",size:{width:"400px",height:"auto"},anchorElement:"body",positionX:50,positionY:82,completion:{type:"ACTION",action:"complete-mission"},nextStepId:"mission_1_8",isSkippable:!1,navLock:{navId:N.DATA,screenId:"missions"}},{stepId:"mission_1_8",text:"Mission complete!<br><br>However, favors don't pay off <b class='hl-yellow font-bold'>Guild</b> loans. You're going to need more <b class='hl-yellow font-bold'>credits</b>.",size:{width:"400px",height:"auto"},anchorElement:"body",positionX:50,positionY:25,completion:{type:"INFO"},nextStepId:"mission_2_1",isSkippable:!1},{stepId:"mission_2_1",text:"The <i>best way to make money</i> is to play the markets yourself by <b class='hl-green font-bold'>buying low and selling high</b>.<br><br>Select the <b>Starport</b> tab, then the <b>Market</b> tab.",size:{width:"400px",height:"auto"},anchorElement:"body",positionX:50,positionY:25,completion:{type:"SCREEN_LOAD",screenId:"market"},nextStepId:"mission_2_2",isSkippable:!1,navLock:{navId:N.STARPORT,screenId:"market"}},{stepId:"mission_2_2",text:"This is the <b>Moon Market</b>.<br>On each commodity you will find a wealth of information to aid your trading.<br><br>The <b class='hl-green font-bold'>MKT</b> indicator will inform you of <b class='hl-green font-bold'>prices higher or lower than average.</b> Selecting the price will reveal past performance.<br><br>Select the <b class='hl-yellow font-bold'>Buy/Sell toggle</b> to transition to sale mode, and then sell your single unit of <b>Plasteel</b>.",size:{width:"400px",height:"150px"},anchorElement:"body",positionX:50,positionY:67,completion:{type:"ACTION",action:"sell-item",goodId:"plasteel"},nextStepId:"mission_2_3",isSkippable:!1},{stepId:"mission_2_3",text:"<b class='hl-green font-bold'>Pure profit</b>!<br><br>However, you still need more <b class='hl-yellow font-bold'>credits</b>! Return to the <b>Mission Terminal</b> by selecting the <b>Data</b> tab.",size:{width:"400px",height:"150px"},anchorElement:"body",positionX:50,positionY:67,completion:{type:"SCREEN_LOAD",screenId:"missions"},nextStepId:"mission_2_4",isSkippable:!1,navLock:{navId:N.DATA,screenId:"missions"}},{stepId:"mission_2_4",text:"This mission offers a <b class='hl-yellow font-bold'>credit</b> reward.<br><br>Accept the mission, <b>Martian Resupply</b>.",size:{width:"400px",height:"auto"},anchorElement:"body",positionX:50,positionY:77,completion:{type:"ACTION",action:"accept-mission",missionId:"mission_tutorial_02"},nextStepId:"mission_3_1",isSkippable:!1},{stepId:"mission_3_1",text:"To complete this mission you will need to <b>travel to Mars</b> after you have purchased <b>two Plasteel</b> from any <b>Market</b>.<br><br>After you have acquired the <b>Plasteel</b>, visit the <b>Mission</b> tab on <b>Mars</b> to submit the cargo and complete the mission. ",size:{width:"400px",height:"160px"},anchorElement:"body",positionX:50,positionY:83,completion:{type:"ACTION",action:"complete-mission",missionId:"mission_tutorial_02"},nextStepId:"mission_final",isSkippable:!1,navLock:null},{stepId:"mission_final",text:"Well done Captain {playerName}, you have successfully completed trades across the <b>Moon</b> and <b>Mars</b>.<br><br>Continue to trade commodities for <b class='hl-green font-bold'>favorable margins</b> and complete missions to unlock additional opportunities.<br><br><b>The Solar System awaits</b>!",size:{width:"400px",height:"auto"},anchorElement:"body",positionX:50,positionY:29,completion:{type:"INFO"},nextStepId:null,isSkippable:!1,buttonText:"Complete Tutorial",navLock:null}]}};var Re={START_YEAR:2140,START_DAY_OF_WEEK:1,DAYS_IN_MONTH:[31,28,31,30,31,30,31,31,30,31,30,31],MONTH_NAMES:["January","February","March","April","May","June","July","August","September","October","November","December"],DAY_NAMES:["Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"]},ze={NEUTRAL:{name:"Neutral System",duration:28,description:"Standard space-faring conditions. Markets are operating under normal parameters.",modifiers:{}}},h={CONFIG:{INTEL_COST_PERCENTAGE:.2,INTEL_MIN_CREDITS:5e3,INTEL_CHANCE:.3,INTEL_DEMAND_MOD:1.8,INTEL_DEPRESSION_MOD:.5},SYSTEM_STATES:ze,DATE_CONFIG:Re,INTRO_SEQUENCE_V1:{modals:[{id:"lore_1",title:"Year 2140",description:'Humanity has expanded throughout the Solar System.<br><br> <span class="hl">Commerce</span> has thrived among the numerous colonies and stations longer than living memory.',buttonText:"Begin",contentClass:"text-center"},{id:"lore_2",title:"The Price of Freedom",description:"A dead-end job in the Belt pays the bills, but it does not offer the <b class='hl-green font-bold'>prosperity</b> that you dream of.<br><br>The <span class='hl'>Merchant's Guild</span> will fund your ambition, but their price is steep.<br><br>This is no simple loan; it's a bet on yourself and your future.",buttonText:"Apply for Loan",contentClass:"text-center",buttonClass:"btn-pulse-green"},{id:"charter",title:`<span class="hl">MERCHANT'S GUILD LOAN AGREEMENT</span>`,description:`
    ...
    `}function tt(c,e,t){let i=h.SHIPS[e],a=t?c.player.shipStates[e]:null,{player:s}=c,o="";if(t){let l=s.activeShipId===e;o=`<div class="status-badge" style="border-color: ${l?"var(--theme-color-primary)":"var(--ot-border-light)"}; color: ${l?"var(--theme-color-primary)":"var(--ot-text-secondary)"};">${l?"ACTIVE":"STORED"}</div>`}let r=`
    ...
    `}function Pe(c,e,t,i,a,s){let o=t.class.toLowerCase();return s?`
            <div class="info-panel-content info-panel-hangar flex-col justify-between h-full">
                ...
                <div class="hangar-specs my-4">
                    ${be("Hull",i?.health,t.maxHealth,"var(--ot-green-accent)")}
                    ${be("Fuel",i?.fuel,t.maxFuel,"var(--ot-cyan-base)")}
                    ${be("Cargo",P(a.inventories[e]),t.cargoCapacity,"var(--class-s-color)")}
                </div>
             ...
             <div class="info-panel-content info-panel-shipyard flex-col justify-between h-full">
                <div>
                 ...
                 <div class="grid grid-cols-3 gap-2 my-4">
                    ${Te("Max Hull",t.maxHealth)}
                    ${Te("Max Fuel",t.maxFuel)}
                    ${Te("Cargo Hold",t.cargoCapacity)}
                </div>
                <div class="flavor-text-box mt-auto" style="border-color: var(--frame-border-color);">
                    <p class="text-sm text-gray-300">${t.lore}</p>
                </div>
            </div>
        `}function De(c,e,t,i,a){if(i){let s=t.activeShipId===c,o=t.ownedShipIds.length>1&&!s,r=Math.floor(e.price*M.SHIP_SELL_MODIFIER);return`
        ...
        `}else{let s=t.credits>=e.price,o=a.activeBatchId?h.TUTORIAL_DATA[a.activeBatchId]?.steps.find(l=>l.stepId===a.activeStepId):null,r=a.activeBatchId==="intro_hangar"&&!o?.unlockPurchase,n=!s||r;return`
        ...
        `}}function be(c,e,t,i){let a=t>0?e/t*100:0;return`
        <div class="spec-readout hangar-specs">
            <span class="text-xs text-right pr-2 text-gray-400">${c}</span>
    ...
    `}function Te(c,e){return`
        <div class="spec-card">
            <p class="text-xs text-gray-400">${c}</p>
            <p class="text-lg font-bold font-orbitron">${e}</p>
        </div>
    `}function He(c,e,t,i){return`<div class="market-scroll-panel">
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">${h.COMMODITIES.filter(o=>o.tier<=c.player.revealedTier).map(o=>it(o,c,t,i)).join("")}</div>
            </div>`}function it(c,e,t,i){let{player:a,market:s,currentLocationId:o,tutorials:r,uiState:n}=e,l=a.inventories[a.activeShipId]?.[c.id],d=t(e,c.id),u=t(e,c.id,!0),m=s.galacticAverages[c.id],p=s.inventory[o]?.[c.id],f=!c.licenseId||a.unlockedLicenseIds.includes(c.licenseId),S=r.activeBatchId==="intro_missions"&&r.activeStepId==="mission_2_2",g=r.activeBatchId==="intro_missions"&&r.activeStepId==="mission_2_3",I=S&&c.id!==E.PLASTEEL||g,_=`data-tooltip="${c.lore}"`,x=l&&l.quantity>0?l.quantity:"0",O=n.marketCardMinimized[c.id],R,k="";if(f){let w=W({price:d,sellPrice:u,galacticAvg:m,playerItem:l}),B=l&&l.quantity>0?`<div class="avg-cost-display" id="avg-cost-${c.id}">Avg. Cost: ${y(l.avgCost,!1)}</div>`:"",V=`
            ...
            </div>`,X=l?.quantity>0?` (${l.quantity})`:"";k=`<button class="card-toggle-btn" data-action="${T.TOGGLE_MARKET_CARD_VIEW}" data-good-id="${c.id}">${O?"+":"\u2212"}</button>`,R=`
            <div class="max-view-content">
                <p class="font-bold commodity-name"><span class="commodity-name-tooltip" ${_}>${c.name}</span></p>
                <p class="avail-text">Avail: <span id="m-stock-${c.id}">${p.quantity}</span>, Own: <span id="p-inv-${c.id}">${x}</span></p>
                <p id="price-display-${c.id}" class="font-roboto-mono font-bold price-text" data-action="${T.SHOW_PRICE_GRAPH}" data-good-id="${c.id}" data-base-price="${d}">${y(d)}</p>
            ...
            <div class="min-view-content">
                <p class="font-bold commodity-name-min">${c.name}${X}</p>
                <p class="tier-text-min">Tier ${c.tier} | ${c.cat}</p>
            </div>
        `}else{let w=`TIER ${c.tier} LICENSE`;R=`
        ...
        `}return`
    <div class="item-card-container ${O?"minimized":""}" id="item-card-container-${c.id}">
        ${k}
        <div class="rounded-lg border ${c.styleClass} transition-colors shadow-md">
            ${R}
        </div>
    </div>`}function Be(){return'<div id="map-container" class="w-full h-full overflow-y-auto"></div>'}function Ee(c){let e=d3.select("#map-container");if(!e.node()||!e.select("svg").empty()){console.warn("Map container not found or map already initialized.");return}let t=e.node().clientWidth;if(t<=0){console.warn("Map container width not available yet. Retrying initialization shortly."),setTimeout(()=>Ee(c),100);return}let i=e.append("svg").attr("id","map-svg").attr("width","100%"),s=i.append("defs").append("radialGradient").attr("id","sun-gradient");s.append("stop").attr("offset","0%").attr("stop-color","#fef08a"),s.append("stop").attr("offset","100%").attr("stop-color","#fde047"),i.append("circle").attr("class","sun").attr("cx","50%").attr("cy",-195).attr("r",225).attr("fill","url(#sun-gradient)");let o={[v.VENUS]:1.035,[v.EARTH]:1.035,[v.LUNA]:.805,[v.MARS]:.9775,[v.BELT]:.805,[v.EXCHANGE]:.805,[v.JUPITER]:1.564,[v.SATURN]:1.46625,[v.URANUS]:1.27075,[v.NEPTUNE]:1.27075,[v.KEPLER]:.8625,[v.PLUTO]:.92},r=h.MARKETS.filter(g=>c.lastKnownState.player.unlockedLocationIds.includes(g.id)).map(g=>{let _=(g.parent?12:16)*(o[g.id]||1),x=g.distance;if(g.parent){let O=h.MARKETS.find(R=>R.id===g.parent);O&&(x=O.distance+.1)}return{...g,effectiveDistance:x,finalRadius:_}}).sort((g,I)=>g.effectiveDistance-I.effectiveDistance),n=130,l=110,u=l+(r.length-1)*n+30;i.attr("height",u);let m=new Map;r.forEach((g,I)=>{m.set(g.id,l+I*n)}),i.append("line").attr("class","central-axis").attr("x1","50%").attr("y1",0).attr("x2","50%").attr("y2",u);let p=t/2,f=i.selectAll(".poi-group").data(r).enter().append("g").attr("class","poi-group").attr("data-location-id",g=>g.id).on("click",(g,I)=>{let _=g.target;_.closest(".poi-group")&&(_.tagName==="circle"||_.tagName==="path"||_.tagName==="text")&&c.showMapDetailModal(I.id)});f.append("line").attr("class","leader-line").attr("x1","50%").attr("y1",g=>m.get(g.id)).attr("x2",(g,I)=>p+(I%2===0?-50:50)).attr("y2",g=>m.get(g.id)),f.filter(g=>g.id!==v.BELT).append("circle").attr("cx","50%").attr("cy",g=>m.get(g.id)).attr("r",g=>g.finalRadius).attr("fill",g=>g.navTheme.borderColor);let S=f.filter(g=>g.id===v.BELT);if(!S.empty()){let g=S.datum().finalRadius;S.append("path").attr("d",`M 0,${-g} L ${g},0 L 0,${g} L ${-g},0 Z`).attr("transform",I=>`translate(${p}, ${m.get(I.id)})`).attr("fill",I=>I.navTheme.borderColor)}f.append("text").attr("class","poi-label").attr("x",(g,I)=>p+(I%2===0?-56:56)).attr("y",g=>m.get(g.id)).attr("text-anchor",(g,I)=>I%2===0?"end":"start").attr("dominant-baseline","middle").text(g=>g.name)}function Fe(c){let{player:e,currentLocationId:t,TRAVEL_DATA:i,tutorials:a}=c,{navLock:s}=a,o=h.MARKETS.find(d=>d.id===t),r=s&&s.screenId===A.NAVIGATION,n=r?s.enabledElementQuery:null,l=null;if(n){let d=n.match(/\[data-location-id='(.*?)'\]/);d&&d[1]&&(l=d[1])}return`
        <div class="scroll-panel navigation-scroll-panel">
            <div class="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-6">
            ${h.MARKETS.filter(d=>e.unlockedLocationIds.includes(d.id)).map(d=>{let u=d.id===t,m=u?null:i[t][d.id],p=r&&l&&d.id!==l,f=p?"disabled-location":"",S=u?`style="--theme-glow-color: ${o?.navTheme.borderColor};"`:"";return`<div class="location-card p-6 rounded-lg text-center flex flex-col ${u?"highlight-current":""} ${d.color} ${d.bg} ${f}" 
        ...
        </div>`}function Ge(c){let{player:e,currentLocationId:t}=c;if(!e.activeShipId||!c.player.shipStates[e.activeShipId])return'<p class="text-center text-gray-500 text-lg mt-8">No active ship available for servicing.</p>';let i=h.SHIPS[e.activeShipId],a=c.player.shipStates[e.activeShipId],s=h.MARKETS.find(S=>S.id===t).fuelPrice/2;e.activePerks[C.VENETIAN_SYNDICATE]&&t===v.VENUS&&(s*=1-h.PERKS[C.VENETIAN_SYNDICATE].fuelDiscount),s=Math.round(s);let o=i.maxHealth*(M.REPAIR_AMOUNT_PER_TICK/100)*M.REPAIR_COST_PER_HP;e.activePerks[C.VENETIAN_SYNDICATE]&&t===v.VENUS&&(o*=1-h.PERKS[C.VENETIAN_SYNDICATE].repairDiscount),o=Math.round(o);let r=a.fuel/i.maxFuel*100,n=a.health/i.maxHealth*100,l=a.fuel>=i.maxFuel,d=a.health>=i.maxHealth,u=e.credits>=s,m=e.credits>=o,p=l||!u,f=d||!m;return`
        ...
        </div>`}function je(c){let e=c.player.inventories[c.player.activeShipId];if(!e)return'<p class="text-center text-gray-500 text-lg">No active ship.</p>';let t=Object.entries(e).filter(([,a])=>a.quantity>0);return t.length===0?'<p class="text-center text-gray-500 text-lg">Your cargo hold is empty.</p>':`<div class="cargo-scroll-panel"><div class="cargo-grid">${t.map(([a,s])=>{let o=h.COMMODITIES.find(r=>r.id===a);return at(o,s)}).join("")}</div></div>`}function at(c,e){let t=Y(c.styleClass);return`
    ...
    `}function Ue(c,e){let t=Y(c.styleClass),a={RAW:"Raw Material",IND:"Industrial Product",AGRI:"Agricultural Good",TECH:"Technology",CIV:"Civilian Commodity",BIO:"Bioware",RARE:"Exotic Material"}[c.cat]||"Unknown",o=(c.basePriceRange[0]+c.basePriceRange[1])/2*e.quantity;return`
    ...
    `}function qe(c,e){let{missions:t,currentLocationId:i}=c,{activeMissionId:a,activeMissionObjectivesMet:s}=t,o=(l,d)=>{let u="";d==="active"&&(u="mission-active"),d==="completed"&&(u="mission-complete"),d==="active"&&s&&l.completion.locationId===i&&(u+=" mission-turn-in");let m=`host-${l.host.toLowerCase().replace(/[^a-z0-9]/g,"")}`,p=l.rewards.map(f=>f.type==="credits"?`\u232C ${f.amount.toLocaleString()}`:f.type.toUpperCase()).join(", ");return`
            ...
            </div>`},r="",n=a?h.MISSIONS[a]:null;return n&&(r+=o(n,"active")),e&&e.getAvailableMissions().forEach(d=>{r+=o(d,"available")}),r===""&&(r='<p class="text-center text-gray-500 text-lg">No missions available at this terminal.</p>'),`
        <div class="flex flex-col h-full">
    ...
    `}function Ve(c){let{player:e,day:t,currentLocationId:i}=c,s=h.MARKETS.find(n=>n.id===i)?.navTheme||{gradient:"linear-gradient(135deg, #4a5568, #2d3748)",textColor:"#f0f0f0",borderColor:"#7a9ac0"},o;if(e.debt>0){let n="";if(e.loanStartDate){let l=M.LOAN_GARNISHMENT_DAYS-(t-e.loanStartDate);l>0&&(n=`<p class="text-xs text-red-400/70 mt-2">Garnishment in ${l} days</p>`)}o=`
            <div>
            ...
            </div>`}else{let n=Math.floor(e.credits*3.5),l=Math.floor(n*.1),d=Math.floor(n*.04),m=[{key:"10000",amount:1e4,fee:600,interest:500},{key:"dynamic",...{amount:n,fee:l,interest:d}}].map(p=>`<button class="btn btn-loan w-full p-2 mt-2" data-action="${T.TAKE_LOAN}" data-loan-details='${JSON.stringify(p)}' ${e.credits<p.fee?"disabled":""}>
            ...
            </div>`}let r=[...e.financeLog].reverse().map(n=>{let l=n.amount>0?"text-green-400":"text-red-400",d=n.amount>0?"+":"";return`
            <div class="log-entry">
                <span class="text-gray-400 text-center">${n.day}</span>
                <span>${n.description}</span>
                <span class="${l} text-right font-roboto-mono">${d}${y(n.amount,!1)}</span>
            </div>
        `}).join("");return`
    ...
    `},oe=class{constructor(e){this.logger=e,this.isMobile=window.innerWidth<=768,this.modalQueue=[],this.activeGraphAnchor=null,this.activeGenericTooltipAnchor=null,this.lastActiveScreenEl=null,this.lastKnownState=null,this.missionService=null,this.simulationService=null,this.newsTickerService=null,this.debugService=null,this.marketTransactionState={},this.activeHighlightConfig=null,this.marketScrollPosition=0,this.popperInstance=null,this.eventManager=null,this.effectsManager=new ae,this.travelAnimationService=new se(this.isMobile),this.navStructure={[N.SHIP]:{label:"Ship",screens:{[A.MAP]:"Map",[A.NAVIGATION]:"Navigation",[A.CARGO]:"Cargo"}},[N.STARPORT]:{label:"Starport",screens:{[A.MARKET]:"Market",[A.SERVICES]:"Services",[A.HANGAR]:"Shipyard"}},[N.DATA]:{label:"Data",screens:{[A.MISSIONS]:"Missions",[A.FINANCE]:"Finance",[A.INTEL]:"Intel"}}},this._cacheDOM(),window.addEventListener("resize",this._setAppHeight)}_setAppHeight(){document.documentElement.style.setProperty("--app-height",`${window.innerHeight}px`)}triggerEffect(e,t){this.effectsManager.trigger(e,t)}setMissionService(e){this.missionService=e}setSimulationService(e){this.simulationService=e}setNewsTickerService(e){this.newsTickerService=e}setDebugService(e){this.debugService=e}setEventManager(e){this.eventManager=e}resetMarketTransactionState(){this.marketTransactionState={}}_cacheDOM(){this.cache={gameContainer:document.getElementById("game-container"),navBar:document.getElementById("nav-bar"),newsTickerBar:document.getElementById("news-ticker-bar"),topBarContainer:document.getElementById("top-bar-container"),subNavBar:document.getElementById("sub-nav-bar"),stickyBar:document.getElementById("sticky-bar"),mapScreen:document.getElementById(`${A.MAP}-screen`),navigationScreen:document.getElementById(`${A.NAVIGATION}-screen`),servicesScreen:document.getElementById(`${A.SERVICES}-screen`),marketScreen:document.getElementById(`${A.MARKET}-screen`),cargoScreen:document.getElementById(`${A.CARGO}-screen`),hangarScreen:document.getElementById(`${A.HANGAR}-screen`),missionsScreen:document.getElementById(`${A.MISSIONS}-screen`),financeScreen:document.getElementById(`${A.FINANCE}-screen`),intelScreen:document.getElementById(`${A.INTEL}-screen`),graphTooltip:document.getElementById("graph-tooltip"),genericTooltip:document.getElementById("generic-tooltip"),processingModal:document.getElementById("processing-modal"),shipDetailModal:document.getElementById("ship-detail-modal"),launchModal:document.getElementById("launch-modal"),launchModalContent:document.getElementById("launch-modal-content"),cargoDetailModal:document.getElementById("cargo-detail-modal"),cargoDetailContent:document.getElementById("cargo-detail-content"),mapDetailModal:document.getElementById("map-detail-modal"),loreModal:document.getElementById("lore-modal"),loreModalContent:document.getElementById("lore-modal-content"),tutorialAnchorOverlay:document.getElementById("tutorial-anchor-overlay"),tutorialToastContainer:document.getElementById("tutorial-toast-container"),tutorialToastText:document.getElementById("tutorial-toast-text"),tutorialToastSkipBtn:document.getElementById("tutorial-toast-skip-btn"),tutorialToastNextBtn:document.getElementById("tutorial-toast-next-btn"),skipTutorialModal:document.getElementById("skip-tutorial-modal"),skipTutorialConfirmBtn:document.getElementById("skip-tutorial-confirm-btn"),skipTutorialCancelBtn:document.getElementById("skip-tutorial-cancel-btn"),tutorialHighlightOverlay:document.getElementById("tutorial-highlight-overlay"),missionStickyBar:document.getElementById("mission-sticky-bar"),stickyObjectiveText:document.getElementById("sticky-objective-text"),stickyObjectiveProgress:document.getElementById("sticky-objective-progress")}}render(e){if(!e||!e.player)return;let t=this.lastKnownState;if(this.lastKnownState=e,e.introSequenceActive&&!e.tutorials.activeBatchId)return;let i=h.MARKETS.find(a=>a.id===e.currentLocationId);i?(this.cache.topBarContainer.setAttribute("data-location-theme",i.id),this.cache.gameContainer.className=`game-container ${i.bg}`,i.navTheme&&i.navTheme.borderColor?(document.documentElement.style.setProperty("--theme-border-color",i.navTheme.borderColor),this.cache.newsTickerBar&&(this.cache.newsTickerBar.style.backgroundImage=i.navTheme.gradient,this.cache.newsTickerBar.style.borderTopColor=i.navTheme.borderColor,this.cache.newsTickerBar.style.borderBottomColor=i.navTheme.borderColor,this.cache.newsTickerBar.style.backgroundColor="transparent")):(document.documentElement.style.removeProperty("--theme-border-color"),this.cache.newsTickerBar&&(this.cache.newsTickerBar.style.backgroundImage="",this.cache.newsTickerBar.style.borderTopColor="",this.cache.newsTickerBar.style.borderBottomColor="",this.cache.newsTickerBar.style.backgroundColor=""))):this.cache.newsTickerBar&&(this.cache.newsTickerBar.style.backgroundImage="",this.cache.newsTickerBar.style.borderTopColor="",this.cache.newsTickerBar.style.borderBottomColor="",this.cache.newsTickerBar.style.backgroundColor=""),this._renderNewsTicker(),this.renderNavigation(e),this.renderActiveScreen(e,t),this.updateStickyBar(e),this.renderStickyBar(e)}_renderNewsTicker(){if(!this.newsTickerService||!this.cache.newsTickerBar||!this.newsTickerService.isDirty)return;let e=this.newsTickerService.getTickerContentHtml();if(!e){this.cache.newsTickerBar.innerHTML="",this.newsTickerService.isDirty=!1;return}this.cache.newsTickerBar.innerHTML=e;let t=this.cache.newsTickerBar.querySelector(".news-ticker-content");if(t){let i=t.innerHTML,a=t.scrollWidth;t.innerHTML=i+i;let r=Math.max(20,a/50);t.style.animationDuration=`${r}s`}this.newsTickerService.isDirty=!1}renderNavigation(e){let{player:t,currentLocationId:i,activeNav:a,activeScreen:s,lastActiveScreen:o,introSequenceActive:r,tutorials:n,subNavCollapsed:l}=e,{navLock:d}=n,u=h.MARKETS.find(R=>R.id===i),m=t.activeShipId?h.SHIPS[t.activeShipId]:null,p=t.activeShipId?t.shipStates[t.activeShipId]:null,f=t.activeShipId?t.inventories[t.activeShipId]:null,S=u?.navTheme||{gradient:"linear-gradient(135deg, #4a5568, #2d3748)",textColor:"#f0f0f0"},g=`
            ...
            </div>`,I=Object.keys(this.navStructure).map(R=>{let k=R===a,w=o[R]||Object.keys(this.navStructure[R].screens)[0],B=d&&d.navId!==R,j=r||B,V=k?`background: ${S.gradient}; color: ${S.textColor};`:"";return`<div class="tab ${k?"active":""} ${j?"disabled":""}" 
 style="${V}" data-action="${T.SET_SCREEN}" data-nav-id="${R}" data-screen-id="${w}">${this.navStructure[R].label}</div>`}).join(""),_="";if(m&&p&&f){let R=P(f),k=p.health/m.maxHealth*100,w=p.fuel/m.maxFuel*100,B=R/m.cargoCapacity*100;_=`
            ...
            `;return g.isHalf?`<div class="pagination-dot half" style="${I}" data-action="${T.SET_HANGAR_PAGE}" data-jump-direction="${g.jump}"></div>`:`<div class="pagination-dot ${g.isActive?"active":""}" style="${I}" data-action="${T.SET_HANGAR_PAGE}" data-index="${g.index}"></div>`}).join("");o.innerHTML=S}updateStickyBar(e){this.cache.stickyBar.innerHTML="",this.cache.topBarContainer.classList.remove("has-sticky-bar")}updateServicesScreen(e){if(e.activeScreen!==A.SERVICES)return;let{player:t}=e,i=h.SHIPS[t.activeShipId],a=t.shipStates[t.activeShipId],s=this.cache.servicesScreen.querySelector("#fuel-bar"),o=this.cache.servicesScreen.querySelector("#refuel-btn");if(s&&o){let l=a.fuel/i.maxFuel*100;s.style.width=`${l}%`,o.disabled=a.fuel>=i.maxFuel}let r=this.cache.servicesScreen.querySelector("#repair-bar"),n=this.cache.servicesScreen.querySelector("#repair-btn");if(r&&n){let l=a.health/i.maxHealth*100;r.style.width=`${l}%`,n.disabled=a.health>=i.maxHealth}}updateMarketScreen(e){if(e.activeScreen!==A.MARKET)return;let t=this.cache.marketScreen.querySelector(".market-scroll-panel");this.lastKnownState&&this.lastKnownState.activeScreen===A.MARKET&&this.lastKnownState.currentLocationId===e.currentLocationId&&t?this.marketScrollPosition=t.scrollTop:this.marketScrollPosition=0,this._saveMarketTransactionState(),this.cache.marketScreen.innerHTML=He(e,this.isMobile,this.getItemPrice,this.marketTransactionState),this._restoreMarketTransactionState();let i=this.cache.marketScreen.querySelector(".market-scroll-panel");i&&(i.scrollTop=this.marketScrollPosition)}_saveMarketTransactionState(){if(!this.lastKnownState||this.lastKnownState.activeScreen!==A.MARKET)return;this.cache.marketScreen.querySelectorAll(".transaction-controls").forEach(t=>{let i=t.dataset.goodId,a=t.querySelector("input"),s=t.dataset.mode;a&&(this.marketTransactionState[i]={quantity:a.value,mode:s})})}_restoreMarketTransactionState(){for(let e in this.marketTransactionState){let t=this.marketTransactionState[e],i=this.cache.marketScreen.querySelector(`.transaction-controls[data-good-id="${e}"]`);if(i){let a=i.querySelector("input");a&&(a.value=t.quantity,i.setAttribute("data-mode",t.mode),this.updateMarketCardDisplay(e,parseInt(t.quantity,10)||0,t.mode))}}}getItemPrice(e,t,i=!1){let a=e.market.prices[e.currentLocationId][t],s=h.MARKETS.find(r=>r.id===e.currentLocationId);i&&s.specialDemand&&s.specialDemand[t]&&(a*=s.specialDemand[t].bonus);let o=e.intel.active;return o&&o.targetMarketId===e.currentLocationId&&o.commodityId===t&&(a*=o.type==="demand"?h.CONFIG.INTEL_DEMAND_MOD:h.CONFIG.INTEL_DEPRESSION_MOD),Math.max(1,Math.round(a))}_calculateSaleDetails(e,t){let i=this.lastKnownState;if(!i)return{totalPrice:0,effectivePricePerUnit:0,netProfit:0};let a=h.COMMODITIES.find(g=>g.id===e),s=i.market.inventory[i.currentLocationId][e].quantity,o=this.getItemPrice(i,e,!0),n=i.player.inventories[i.player.activeShipId]?.[e]?.avgCost||0;if(s<=0)return{totalPrice:0,effectivePricePerUnit:0,netProfit:0};let l=s*.1;if(t<=l){let g=o*t,I=n*t,_=g-I;if(_>0){let x=(i.player.activePerks[C.TRADEMASTER]?h.PERKS[C.TRADEMASTER].profitBonus:0)+(i.player.birthdayProfitBonus||0);_+=_*x}return{totalPrice:g,effectivePricePerUnit:o,netProfit:_}}let d=t/s,u=0;a.tier<=2?u=Math.min(.1,(d-.1)*.2):a.tier<=5?u=Math.min(.25,(d-.1)*.5):u=Math.min(.4,(d-.1)*.8);let m=o*(1-u),p=Math.floor(m*t),f=n*t,S=p-f;if(S>0){let g=(i.player.activePerks[C.TRADEMASTER]?h.PERKS[C.TRADEMASTER].profitBonus:0)+(i.player.birthdayProfitBonus||0);S+=S*g}return{totalPrice:p,effectivePricePerUnit:m,netProfit:S}}updateMarketCardPrice(e,t){let i=this.cache.marketScreen.querySelector(`#price-display-${e}`);if(i){i.dataset.basePrice=t;let a=i.closest(".item-card-container").querySelector(".transaction-controls");a&&a.dataset.mode==="buy"&&(i.textContent=y(t))}}updateMarketCardDisplay(e,t,i){let a=this.cache.marketScreen.querySelector(`#price-display-${e}`),s=this.cache.marketScreen.querySelector(`#effective-price-display-${e}`),o=this.cache.marketScreen.querySelector(`#indicators-${e}`),r=this.cache.marketScreen.querySelector(`#avg-cost-${e}`);if(!a||!s||!o||!this.lastKnownState)return;let n=this.lastKnownState,l=parseInt(a.dataset.basePrice,10),d=n.player.inventories[n.player.activeShipId]?.[e];if(r&&r.classList.toggle("visible",i==="sell"),i==="buy")a.textContent=y(l),a.className="font-roboto-mono font-bold price-text",s.textContent="",o.innerHTML=W({price:l,sellPrice:this.getItemPrice(n,e,!0),galacticAvg:n.market.galacticAverages[e],playerItem:d});else{let{effectivePricePerUnit:u,netProfit:m}=this._calculateSaleDetails(e,t);if(t>0){let p=`\u232C ${m>=0?"+":""}${y(m,!1)}`;a.textContent=p,s.textContent=`(${y(u,!1)}/unit)`,a.className=`font-roboto-mono font-bold ${m>=0?"profit-text":"loss-text"}`}else a.textContent="\u232C +0",a.className="font-roboto-mono font-bold profit-text",s.textContent="";o.innerHTML=W({price:l,sellPrice:u||this.getItemPrice(n,e,!0),galacticAvg:n.market.galacticAverages[e],playerItem:d})}}showTravelAnimation(e,t,i,a,s){this.travelAnimationService.play(e,t,i,a,s)}queueModal(e,t,i,a=null,s={}){this.modalQueue.push({modalId:e,title:t,description:i,callback:a,options:s}),document.querySelector(".modal-backdrop:not(.hidden)")||this.processModalQueue()}processModalQueue(){if(this.modalQueue.length===0)return;let{modalId:e,title:t,description:i,callback:a,options:s}=this.modalQueue.shift(),o=document.getElementById(e);if(!o)return this.logger.error("UIManager",`Modal element with ID '${e}' not found in the DOM. Aborting modal display.`),this.processModalQueue();s.specialClass&&o.classList.add(s.specialClass),s.nonDismissible&&o.classList.add("dismiss-disabled");let r=e==="mission-modal"?"mission-modal-title":e.replace("-modal","-title"),n=e==="mission-modal"?"mission-modal-description":e.replace("-modal","-description"),l=o.querySelector(`#${r}`),d=o.querySelector(`#${n}`)||o.querySelector(`#${e.replace("-modal","-scenario")}`);l&&(l.innerHTML=t),d&&(d.innerHTML=i,d.className="my-4 text-gray-300",e!=="mission-modal"&&d.classList.add("mb-6","text-lg"),(e==="event-modal"||e==="random-event-modal")&&d.classList.add("text-center"),s.contentClass&&((s.contentClass.includes("text-left")||s.contentClass.includes("text-right")||s.contentClass.includes("text-justify"))&&d.classList.remove("text-center"),d.classList.add(...s.contentClass.split(" ").filter(Boolean))));let u=()=>{this.hideModal(e),a&&a(),this.processModalQueue()};if(s.customSetup)s.customSetup(o,u);else{let m=o.querySelector("#"+e.replace("-modal","-button-container")),p;m?(m.innerHTML="",p=document.createElement("button"),m.appendChild(p)):p=o.querySelector("button"),p&&(p.className="btn px-6 py-2",s.buttonClass&&p.classList.add(s.buttonClass),p.innerHTML=s.buttonText||"Understood",p.onclick=u)}o.classList.remove("hidden"),o.classList.add("modal-visible")}showRandomEventModal(e,t){this.queueModal("random-event-modal",e.title,e.scenario,null,{nonDismissible:!0,customSetup:(i,a)=>{let s=i.querySelector("#random-event-choices-container");s.innerHTML="",e.choices.forEach((o,r)=>{let n=document.createElement("button");n.className="btn w-full text-center p-4 hover:bg-slate-700",n.innerHTML=o.title,n.onclick=()=>{t(e.id,r),a()},s.appendChild(n)})}})}showAgeEventModal(e,t){let i=document.getElementById("age-event-modal");i.classList.add("dismiss-disabled"),document.getElementById("age-event-title").innerHTML=e.title,document.getElementById("age-event-description").innerHTML=e.description;let a=document.getElementById("age-event-button-container");a.innerHTML="",e.choices.forEach(s=>{let o=document.createElement("button");o.className="perk-button",o.innerHTML=`<h4>${s.title}</h4><p>${s.description}</p>`,o.onclick=()=>{this.hideModal("age-event-modal"),t(s)},a.appendChild(o)}),i.classList.remove("hidden"),i.classList.add("modal-visible")}showLoreModal(e){let t=this.cache.loreModal,i=this.cache.loreModalContent;if(!t||!i){this.logger.error("UIManager","Lore modal elements not cached or found in DOM.");return}let a=st[e];a?i.innerHTML=a:(this.logger.error("UIManager",`No lore content found for ID: ${e}`),i.innerHTML="<p>Error: Lore content not found.</p>"),i.scrollTop=0,t.classList.remove("hidden"),t.classList.add("modal-visible");let s=o=>{(o.target.closest("#lore-modal-content")||o.target.id==="lore-modal")&&(this.hideModal("lore-modal"),t.removeEventListener("click",s))};t.addEventListener("click",s)}hideModal(e){let t=document.getElementById(e);t&&!t.classList.contains("hidden")&&(t.classList.add("modal-hiding"),t.addEventListener("animationend",()=>{t.classList.add("hidden"),t.classList.remove("modal-hiding","modal-visible","dismiss-disabled","intro-fade-in"),this.modalQueue.length>0&&!document.querySelector(".modal-backdrop:not(.hidden)")&&this.processModalQueue()},{once:!0}))}showProcessingAnimation(e,t){let i=this.cache.processingModal;if(!i)return;let a=i.querySelector("#processing-title"),s=i.querySelector("#processing-progress-bar"),o=i.querySelector("#processing-status");a.textContent=`Processing application for ${e}...`,s.style.width="0%",o.textContent="",i.classList.remove("hidden"),setTimeout(()=>{s.style.width="100%"},100),setTimeout(()=>{o.textContent="Processing complete!",setTimeout(()=>{this.hideModal("processing-modal"),t&&t()},1e3)},4e3)}createFloatingText(e,t,i,a="#fde047"){let s=document.createElement("div");s.textContent=e,s.className="floating-text",s.style.left=`${t-20}px`,s.style.top=`${i-40}px`,s.style.color=a,document.body.appendChild(s),setTimeout(()=>s.remove(),2450)}showGraph(e,t){this.activeGraphAnchor=e;let i=this.cache.graphTooltip,a=e.dataset.action;if(a===T.SHOW_PRICE_GRAPH){let s=e.dataset.goodId,o=t.player.inventories[t.player.activeShipId][s];i.innerHTML=this._renderPriceGraph(s,t,o)}else a===T.SHOW_FINANCE_GRAPH&&(i.innerHTML=this._renderFinanceGraph(t));i.style.display="block",this.updateGraphTooltipPosition()}hideGraph(){this.activeGraphAnchor&&(this.cache.graphTooltip.style.display="none",this.activeGraphAnchor=null)}updateGraphTooltipPosition(){if(!this.activeGraphAnchor)return;let e=this.cache.graphTooltip;if(e.style.display==="none")return;let t=this.activeGraphAnchor.closest(".item-card-container").getBoundingClientRect(),i=e.offsetHeight,a=t.top-i-10,s=t.left;a<10&&(a=t.bottom+10),e.style.left=`${s}px`,e.style.top=`${a}px`}showGenericTooltip(e,t){this.activeGenericTooltipAnchor=e;let i=this.cache.genericTooltip;i.innerHTML=t,i.style.display="block",this.updateGenericTooltipPosition()}hideGenericTooltip(){this.activeGenericTooltipAnchor&&(this.cache.genericTooltip.style.display="none",this.activeGenericTooltipAnchor=null)}updateGenericTooltipPosition(){if(!this.activeGenericTooltipAnchor)return;let e=this.cache.genericTooltip,t=this.activeGenericTooltipAnchor.getBoundingClientRect(),i=e.offsetWidth,a=e.offsetHeight,s=t.right+10,o=t.top+t.height/2-a/2;o<10&&(o=t.bottom+10),s<10&&(s=10),s+i>window.innerWidth&&(s=window.innerWidth-i-10),e.style.left=`${s}px`,e.style.top=`${o}px`}_renderPriceGraph(e,t,i){let a=t.market.priceHistory[t.currentLocationId]?.[e];if(!a||a.length<2)return'<div class="text-gray-400 text-sm p-4">No Data Available!</div>';let s=h.COMMODITIES.find(w=>w.id===e),o=(s.basePriceRange[0]+s.basePriceRange[1])/2,r=280,n=140,l=35,d=a.map(w=>w.price),u=i?.avgCost>0?i.avgCost:null,m=[...d,o];u&&m.push(u);let p=Math.min(...m),f=Math.max(...m),S=f-p>0?f-p:1,g=w=>w/(a.length-1)*(r-l*2)+l,I=w=>n-l-(w-p)/S*(n-l*2.5),_=`<svg width="${r}" height="${n}" xmlns="http://www.w3.org/2000/svg"><rect width="100%" height="100%" fill="#0c101d" />`;_+='<g class="grid-lines" stroke="#1f2937" stroke-width="1">',_+=`<line x1="${l}" y1="${I(f)}" x2="${l}" y2="${n-l}" /><line x1="${l}" y1="${n-l}" x2="${r-l}" y2="${n-l}" />`,_+="</g>";let x=I(o);if(_+=`<line x1="${l}" y1="${x}" x2="${r-l}" y2="${x}" stroke="#facc15" stroke-width="1" stroke-dasharray="3 3" />`,_+=`<text x="${r-l+4}" y="${x+3}" fill="#facc15" font-size="10" font-family="Roboto Mono" text-anchor="start">Avg: ${y(o,!1)}</text>`,u){let w=I(u);_+=`<line x1="${l}" y1="${w}" x2="${r-l}" y2="${w}" stroke="#34d399" stroke-width="1" stroke-dasharray="3 3" />`,_+=`<text x="${r-l+4}" y="${w+3}" fill="#34d399" font-size="10" font-family="Roboto Mono" text-anchor="start">Paid: ${y(u,!1)}</text>`}let O=a.map((w,B)=>`${g(B)},${I(w.price)}`).join(" ");_+=`<polyline fill="none" stroke="#60a5fa" stroke-width="2" points="${O}" />`;let R=a[0].day,k=a[a.length-1].day;return _+=`<text x="${l}" y="${n-l+15}" fill="#9ca3af" font-size="10" font-family="Roboto Mono" text-anchor="start">Day ${R}</text>`,_+=`<text x="${r-l}" y="${n-l+15}" fill="#9ca3af" font-size="10" font-family="Roboto Mono" text-anchor="end">Day ${k}</text>`,_+=`<text x="${l-8}" y="${I(p)+3}" fill="#9ca3af" font-size="10" font-family="Roboto Mono" text-anchor="end">${y(p,!1)}</text>`,_+=`<text x="${l-8}" y="${I(f)+3}" fill="#9ca3af" font-size="10" font-family="Roboto Mono" text-anchor="end">${y(f,!1)}</text>`,_+="</svg>",_}showTutorialToast({step:e,onSkip:t,onNext:i,gameState:a}){let s=this.cache.tutorialToastContainer,o=s.querySelector("#tt-arrow"),r=e.anchorElement==="body",n;r?n=this.cache.tutorialAnchorOverlay:(n=document.querySelector(e.anchorElement),n||(this.logger.error("TutorialService",`Anchor element "${e.anchorElement}" not found for step "${e.stepId}". Defaulting to overlay.`),n=this.cache.tutorialAnchorOverlay)),this.popperInstance&&(this.popperInstance.destroy(),this.popperInstance=null);let l=e.text;if(l.includes("{shipName}")){let f=a.player.activeShipId,S=f?h.SHIPS[f].name:"your ship";l=l.replace(/{shipName}/g,S)}if(l.includes("{playerName}")){let f=a.player.name||"Captain";l=l.replace(/{playerName}/g,f)}this.cache.tutorialToastText.innerHTML=l;let d=e.size?.width||"auto",u=e.size?.height||"auto";if(s.style.width=d,s.style.height=u,r){let f=e.positionX??50,S=e.positionY??50;s.style.left=`${f}%`,s.style.top=`${S}%`,s.style.transform="translate(-50%, -50%)",o.style.display="none",s.removeAttribute("data-popper-placement")}else{s.style.left="",s.style.top="",s.style.transform="",o.style.display="block";let f={placement:"auto",modifiers:[{name:"offset",options:{offset:[0,10]}},{name:"preventOverflow",options:{padding:{top:60,bottom:60,left:10,right:10}}},{name:"flip",options:{fallbackPlacements:["top","bottom","left","right"]}},{name:"arrow",options:{element:"#tt-arrow",padding:5}}]},S=e.popperOptions?.modifiers?.find(_=>_.name==="offset"),g=f.modifiers.filter(_=>_.name!=="offset");S?g.push(S):g.push(f.modifiers.find(_=>_.name==="offset")),e.popperOptions?.modifiers;let I={placement:e.placement||e.popperOptions?.placement||f.placement,modifiers:g};this.popperInstance=Popper.createPopper(n,s,I)}s.classList.remove("hidden");let m=e.completion.type==="INFO";this.cache.tutorialToastNextBtn.classList.toggle("hidden",!m),m&&(this.cache.tutorialToastNextBtn.onclick=i);let p=!1;this.cache.tutorialToastSkipBtn.style.display=p?"block":"none",this.cache.tutorialToastSkipBtn.onclick=t,this.cache.tutorialToastText.scrollTop=0,this.debugService&&this.debugService.setActiveTutorialStep(e)}hideTutorialToast(){this.cache.tutorialToastContainer.classList.add("hidden"),this.popperInstance&&(this.popperInstance.destroy(),this.popperInstance=null),this.applyTutorialHighlight(null),this.debugService&&this.debugService.clearActiveTutorialStep()}updateTutorialPopper(e){let t=this.cache.tutorialToastContainer,i=t.querySelector("#tt-arrow"),{isOverlayAnchor:a,width:s,height:o,percentX:r,percentY:n,placement:l,distance:d,skidding:u}=e;if(t.style.width=s>0?`${s}px`:"auto",t.style.height=o>0?`${o}px`:"auto",a)this.popperInstance&&(this.popperInstance.destroy(),this.popperInstance=null,t.removeAttribute("data-popper-placement"),t.style.transform=""),t.style.left=`${r}%`,t.style.top=`${n}%`,t.style.transform="translate(-50%, -50%)",i.style.display="none";else{t.style.left="",t.style.top="",t.style.transform="",i.style.display="block";let m={placement:l,modifiers:[{name:"offset",options:{offset:[u,d]}},{name:"preventOverflow",options:{padding:{top:60,bottom:60,left:10,right:10}}},{name:"flip",options:{fallbackPlacements:["top","bottom","left","right"]}},{name:"arrow",options:{element:"#tt-arrow",padding:5}}]};this.popperInstance?this.popperInstance.setOptions(m).catch(p=>{this.logger.error("UIManager","Error updating Popper options:",p)}):this.logger.warn("UIManager","Popper instance needed but not found during update. Re-trigger toast if anchor type changed.")}}applyTutorialHighlight(e){this.activeHighlightConfig=e,this._renderHighlightsFromConfig(this.activeHighlightConfig)}_renderHighlightsFromConfig(e){let t=this.cache.tutorialHighlightOverlay;if(t){if(t.innerHTML="",!e){t.classList.add("hidden");return}t.classList.remove("hidden"),e.forEach(i=>{let a=document.createElement("div");a.className="tutorial-cue",a.style.left=`${i.x}px`,a.style.top=`${i.y}px`,a.style.width=`${i.width}px`,a.style.height=`${i.height}px`,a.style.transform=`rotate(${i.rotation}deg)`,a.style.opacity=i.style.opacity,i.style.animation!=="None"&&a.classList.add(`anim-${i.style.animation.toLowerCase()}`);let s="";i.type==="Shape"?s=`
                ...
                </div>`}else{let d=a.shipStates[t],u=a.inventories[t],m=P(u),p=t===a.activeShipId,f=a.ownedShipIds.length>1&&!p,S=Math.floor(o.price*M.SHIP_SELL_MODIFIER);r=`
                <div class="ship-card p-4 flex flex-col space-y-3 ${p?"border-yellow-400":""}">
                    ...
                    <div class="grid grid-cols-2 gap-2 mt-2">
                        ...
                        <button class="btn" data-action="${T.SELL_SHIP}" data-ship-id="${t}" ${f?"":"disabled"}>Sell<br>\u232C ${y(S,!1)}</button>
                    </div>
                </div>`}let n=this.cache.shipDetailModal,l=n.querySelector("#ship-detail-content");l.innerHTML=r,n.classList.remove("hidden"),n.classList.add("modal-visible")}showLaunchModal(e){let t=this.lastKnownState;if(!t)return;let i=h.MARKETS.find(d=>d.id===e);if(!i)return;let a=i.navTheme,s=t.TRAVEL_DATA[t.currentLocationId]?.[e],o=t.player.shipStates[t.player.activeShipId];if(!s)return;let r=`
