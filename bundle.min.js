(()=>{var I=Object.freeze({MAP:"map",NAVIGATION:"navigation",SERVICES:"services",MARKET:"market",CARGO:"cargo",HANGAR:"hangar",MISSIONS:"missions",FINANCE:"finance",INTEL:"intel"}),C=Object.freeze({SHIP:"ship",STARPORT:"starport",DATA:"data"}),M=Object.freeze({WANDERER:"starter",STALWART:"hauler_c1",MULE:"hauler_c2",PATHFINDER:"explorer_b1",NOMAD:"explorer_b2",VINDICATOR:"frigate_a1",AEGIS:"frigate_a2",ODYSSEY:"luxury_s1",MAJESTIC:"luxury_s2",TITAN_HAULER:"rare_s1",VOID_CHASER:"rare_s2",GUARDIAN:"rare_s3",STARGAZER:"rare_s4",BEHEMOTH:"rare_o1"}),T=Object.freeze({WATER_ICE:"water_ice",PLASTEEL:"plasteel",HYDROPONICS:"hydroponics",CYBERNETICS:"cybernetics",PROPELLANT:"propellant",PROCESSORS:"processors",GMO_SEEDS:"gmo_seeds",CRYO_PODS:"cryo_pods",ATMO_PROCESSORS:"atmos_processors",CLONED_ORGANS:"cloned_organs",XENO_GEOLOGICALS:"xeno_geologicals",SENTIENT_AI:"sentient_ai",ANTIMATTER:"antimatter",FOLDED_DRIVES:"folded_drives"}),S=Object.freeze({EARTH:"loc_earth",LUNA:"loc_luna",MARS:"loc_mars",VENUS:"loc_venus",BELT:"loc_belt",SATURN:"loc_saturn",JUPITER:"loc_jupiter",URANUS:"loc_uranus",NEPTUNE:"loc_neptune",PLUTO:"loc_pluto",EXCHANGE:"loc_exchange",KEPLER:"loc_kepler"}),_=Object.freeze({TRADEMASTER:"trademaster",NAVIGATOR:"navigator",VENETIAN_SYNDICATE:"venetian_syndicate",MERCHANT_GUILD_SHIP:"merchant_guild_ship"}),b=Object.freeze({DEBUG_SIMPLE_START:"debug-simple-start",SET_SCREEN:"set-screen",TRAVEL:"travel",BUY_SHIP:"buy-ship",SELL_SHIP:"sell-ship",SELECT_SHIP:"select-ship",PAY_DEBT:"pay-debt",TAKE_LOAN:"take-loan",PURCHASE_INTEL:"purchase-intel",ACQUIRE_LICENSE:"acquire-license",BUY_ITEM:"buy-item",SELL_ITEM:"sell-item",SET_MAX_BUY:"set-max-buy",SET_MAX_SELL:"set-max-sell",INCREMENT:"increment",DECREMENT:"decrement",SHOW_PRICE_GRAPH:"show-price-graph",SHOW_FINANCE_GRAPH:"show-finance-graph",TOGGLE_MARKET_CARD_VIEW:"toggle-market-card-view",TOGGLE_HANGAR_MODE:"toggle-hangar-mode",SET_HANGAR_PAGE:"set-hangar-page"}),O=Object.freeze({SCREEN_LOAD:"SCREEN_LOAD",ACTION:"ACTION",INFO:"INFO"}),x=Object.freeze({STARTING_CREDITS:5e3,STARTING_DEBT_INTEREST:125,REPAIR_COST_PER_HP:75,REPAIR_AMOUNT_PER_TICK:5,FUEL_SCALAR:3,INTEREST_INTERVAL:30,PASSIVE_REPAIR_RATE:.02,HULL_DECAY_PER_TRAVEL_DAY:1/7,SHIP_SELL_MODIFIER:.75,RARE_SHIP_CHANCE:.3,PRICE_HISTORY_LENGTH:65,FINANCE_HISTORY_LENGTH:25,DAILY_PRICE_VOLATILITY:.25,MEAN_REVERSION_STRENGTH:.04,MARKET_PRESSURE_DECAY:.7,LOCAL_PRICE_MOD_STRENGTH:.5,LOAN_GARNISHMENT_DAYS:1095,LOAN_GARNISHMENT_PERCENT:.14,RANDOM_EVENT_CHANCE:.07}),me=[{threshold:5e4,revealsTier:2},{threshold:45e4,revealsTier:3},{threshold:4e6,revealsTier:4},{threshold:35e6,revealsTier:5},{threshold:3e8,revealsTier:6},{threshold:25e8,revealsTier:7}],Ie="orbitalTraderSave_v2";var Ee={START_YEAR:2140,START_DAY_OF_WEEK:1,DAYS_IN_MONTH:[31,28,31,30,31,30,31,31,30,31,30,31],MONTH_NAMES:["January","February","March","April","May","June","July","August","September","October","November","December"],DAY_NAMES:["Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"]},Fe={NEUTRAL:{name:"Neutral System",duration:28,description:"Standard space-faring conditions. Markets are operating under normal parameters.",modifiers:{}}},d={CONFIG:{INTEL_COST_PERCENTAGE:.2,INTEL_MIN_CREDITS:5e3,INTEL_CHANCE:.3,INTEL_DEMAND_MOD:1.8,INTEL_DEPRESSION_MOD:.5},SYSTEM_STATES:Fe,DATE_CONFIG:Ee,INTRO_SEQUENCE_V1:{modals:[{id:"lore_1",title:"Year 2140",description:'Humanity has expanded throughout the Solar System.<br><br> <span class="hl">Commerce</span> has thrived among the numerous colonies and stations longer than living memory.',buttonText:"Begin",contentClass:"text-center"},{id:"lore_2",title:"The Price of Freedom",description:"A dead-end job in the Belt pays the bills, but it does not offer the <b class='hl-green font-bold'>prosperity</b> that you dream of.<br><br>The <span class='hl'>Merchant's Guild</span> will fund your ambition, but their price is steep.<br><br>This is no simple loan; it's a bet on yourself and your future.",buttonText:"Apply for Loan",contentClass:"text-center",buttonClass:"btn-pulse-green"},{id:"charter",title:`<span class="hl">MERCHANT'S GUILD LOAN AGREEMENT</span>`,description:`
    ...
    `}function je(l,e,t){let i=d.SHIPS[e],a=t?l.player.shipStates[e]:null,{player:s}=l,n="";if(t){let c=s.activeShipId===e;n=`<div class="status-badge" style="border-color: ${c?"var(--theme-color-primary)":"var(--ot-border-light)"}; color: ${c?"var(--theme-color-primary)":"var(--ot-text-secondary)"};">${c?"ACTIVE":"STORED"}</div>`}let r=`
    ...
    `}function xe(l,e,t,i,a,s){let n=t.class.toLowerCase();return s?`
            <div class="info-panel-content info-panel-hangar flex-col justify-between h-full">
                ...
                <div class="hangar-specs my-4">
                    ...
                    ${ge("Cargo",L(a.inventories[e]),t.cargoCapacity,"var(--class-s-color)")}
                </div>
        ...
        `}function Ce(l,e,t,i,a){if(i){let s=t.activeShipId===l,n=t.ownedShipIds.length>1&&!s,r=Math.floor(e.price*x.SHIP_SELL_MODIFIER);return`
        ...
        `}}function ge(l,e,t,i){let a=t>0?e/t*100:0;return`
    ...
    `}function we(l,e,t,i){return`<div class="scroll-panel">
            ...
            </div>`}function We(l,e,t,i){let{player:a,market:s,currentLocationId:n,tutorials:r,uiState:o}=e,c=a.inventories[a.activeShipId]?.[l.id],h=t(e,l.id),u=t(e,l.id,!0),p=s.galacticAverages[l.id],m=s.inventory[n]?.[l.id],f=!l.licenseId||a.unlockedLicenseIds.includes(l.licenseId),v=r.activeBatchId==="intro_missions"&&r.activeStepId==="mission_2_2",g=r.activeBatchId==="intro_missions"&&r.activeStepId==="mission_2_3",E=v&&l.id!==T.PLASTEEL||g,A=`data-tooltip="${l.lore}"`,N=c&&c.quantity>0?c.quantity:"0",k=o.marketCardMinimized[l.id],w=Y({price:h,sellPrice:u,galacticAvg:p,playerItem:c}),D=c&&c.quantity>0?`<div class="avg-cost-display" id="avg-cost-${l.id}">Avg. Cost: ${y(c.avgCost,!1)}</div>`:"",R;f?R=`
            ...
            <div class="transaction-controls absolute inset-0 flex items-center justify-center p-4">
                <button class="btn w-full h-full text-center" data-action="${b.ACQUIRE_LICENSE}" data-license-id="${l.licenseId}">Acquire License</button>
    ...
    <div class="item-card-container ${f?"":"locked"} ${k?"minimized":""}" id="item-card-container-${l.id}">
        <div class="rounded-lg border ${l.styleClass} transition-colors shadow-md">
            <button class="card-toggle-btn" data-action="${b.TOGGLE_MARKET_CARD_VIEW}" data-good-id="${l.id}">${k?"+":"\u2212"}</button>
            ...
            <div class="max-view-content">
                ...
                <p id="price-display-${l.id}" class="font-roboto-mono font-bold price-text" data-action="${b.SHOW_PRICE_GRAPH}" data-good-id="${l.id}" data-base-price="${h}">${y(h)}</p>
        ...
        </div>`}function ke(l){let{player:e,currentLocationId:t}=l;if(!e.activeShipId||!l.player.shipStates[e.activeShipId])return'<p class="text-center text-gray-500 text-lg mt-8">No active ship available for servicing.</p>';let i=d.SHIPS[e.activeShipId],a=l.player.shipStates[e.activeShipId],s=d.MARKETS.find(v=>v.id===t).fuelPrice/2;e.activePerks[_.VENETIAN_SYNDICATE]&&t===S.VENUS&&(s*=1-d.PERKS[_.VENETIAN_SYNDICATE].fuelDiscount),s=Math.round(s);let n=i.maxHealth*(x.REPAIR_AMOUNT_PER_TICK/100)*x.REPAIR_COST_PER_HP;e.activePerks[_.VENETIAN_SYNDICATE]&&t===S.VENUS&&(n*=1-d.PERKS[_.VENETIAN_SYNDICATE].repairDiscount),n=Math.round(n);let r=a.fuel/i.maxFuel*100,o=a.health/i.maxHealth*100,c=a.fuel>=i.maxFuel,h=a.health>=i.maxHealth,u=e.credits>=s,p=e.credits>=n,m=c||!u,f=h||!p;return`
              ...
              >
                ...
                <div class="control-deck flex justify-center items-center gap-4">
                  <div class="price-display-module w-32 h-12 flex justify-between items-center px-4">
                    ...
                    <span class="price-digits text-base ${u?"text-amber-400 shadow-amber-400":"text-red-500 shadow-red-500"}">
                        ${y(s,!1)}
                    </span>
                  </div>
              ...
              >
                <div class="bar-housing">
                  <div class="progress-bar-container w-full h-20 rounded-lg border border-gray-800 overflow-hidden relative">
                    ...
                    <div id="repair-bar" class="progress-bar-fill h-full rounded-md" style="width: ${o}%; background-color: #22c55e; --glow-color: #22c55e; background-image: linear-gradient(45deg, rgba(255,255,255,0.1) 25%, transparent 25%, transparent 50%, rgba(255,255,255,0.1) 50%, rgba(255,255,255,0.1) 75%, transparent 75%, transparent); background-size: 40px 40px;"></div>
                  </div>
                  </div>
                <div class="control-deck flex justify-center items-center gap-4">
                  <div class="price-display-module w-32 h-12 flex justify-between items-center px-4">
                    <span class="price-label text-sm engraved-text">COST</span>
                    <span class="price-digits text-base ${p?"text-amber-400 shadow-amber-400":"text-red-500 shadow-red-500"}">
                        ${y(n,!1)}
                    </span>
                  </div>
                  <button id="repair-btn" class="industrial-button w-32 h-12 flex justify-center items-center text-center p-2 text-base font-orbitron uppercase tracking-wider transition-all duration-100 ease-in-out focus:outline-none" ${f?"disabled":""}>
                      <span class="engraved-text">${h?"MAX":"Repair"}</span>
                  </button>
                  </div>
              </div>
            </div>
        </div>`}function Oe(l){let e=l.player.inventories[l.player.activeShipId];if(!e)return'<p class="text-center text-gray-500 text-lg">No active ship.</p>';let t=Object.entries(e).filter(([,a])=>a.quantity>0);return t.length===0?'<p class="text-center text-gray-500 text-lg">Your cargo hold is empty.</p>':`<div class="cargo-scroll-panel"><div class="cargo-grid">${t.map(([a,s])=>{let n=d.COMMODITIES.find(r=>r.id===a);return Ke(n,s)}).join("")}</div></div>`}function Ke(l,e){let t=q(l.styleClass);return`
    ...
    `}function De(l,e){let t=q(l.styleClass),a={RAW:"Raw Material",IND:"Industrial Product",AGRI:"Agricultural Good",TECH:"Technology",CIV:"Civilian Commodity",BIO:"Bioware",RARE:"Exotic Material"}[l.cat]||"Unknown",n=(l.basePriceRange[0]+l.basePriceRange[1])/2*e.quantity;return`
    ...
    `}function Pe(l,e){let{missions:t,currentLocationId:i}=l,{activeMissionId:a,activeMissionObjectivesMet:s}=t,n=(c,h)=>{let u="";h==="active"&&(u="mission-active"),h==="completed"&&(u="mission-complete"),h==="active"&&s&&c.completion.locationId===i&&(u+=" mission-turn-in");let p=`host-${c.host.toLowerCase().replace(/[^a-z0-9]/g,"")}`,m=c.rewards.map(f=>f.type==="credits"?`\u232C ${f.amount.toLocaleString()}`:f.type.toUpperCase()).join(", ");return`
            ...
            </div>`},r="",o=a?d.MISSIONS[a]:null;return o&&(r+=n(o,"active")),e&&e.getAvailableMissions().forEach(h=>{r+=n(h,"available")}),r===""&&(r='<p class="text-center text-gray-500 text-lg">No missions available at this terminal.</p>'),`
        <div class="flex flex-col h-full">
    ...
    `}function $e(l){let{player:e,day:t,currentLocationId:i}=l,s=d.MARKETS.find(o=>o.id===i)?.navTheme||{gradient:"linear-gradient(135deg, #4a5568, #2d3748)",textColor:"#f0f0f0",borderColor:"#7a9ac0"},n;if(e.debt>0){let o="";if(e.loanStartDate){let c=x.LOAN_GARNISHMENT_DAYS-(t-e.loanStartDate);c>0&&(o=`<p class="text-xs text-red-400/70 mt-2">Garnishment in ${c} days</p>`)}n=`
            <div>
            ...
            </div>`}else{let o=Math.floor(e.credits*3.5),c=Math.floor(o*.1),h=Math.floor(o*.04),p=[{key:"10000",amount:1e4,fee:600,interest:500},{key:"dynamic",...{amount:o,fee:c,interest:h}}].map(m=>`<button class="btn btn-loan w-full p-2 mt-2" data-action="${b.TAKE_LOAN}" data-loan-details='${JSON.stringify(m)}' ${e.credits<m.fee?"disabled":""}>
            ...
            <div class="log-entry">
                ...
                <span class="${c} text-right font-roboto-mono">${h}${y(o.amount,!1)}</span>
            </div>
        `}).join("");return`
    ...
    `},te=class{constructor(e){this.logger=e,this.isMobile=window.innerWidth<=768,this.modalQueue=[],this.activeGraphAnchor=null,this.activeGenericTooltipAnchor=null,this.lastActiveScreenEl=null,this.lastKnownState=null,this.missionService=null,this.simulationService=null,this.debugService=null,this.marketTransactionState={},this.activeHighlightConfig=null,this.marketScrollPosition=0,this.popperInstance=null,this.eventManager=null,this.effectsManager=new Z,this.travelAnimationService=new ee(this.isMobile),this.navStructure={[C.SHIP]:{label:"Ship",screens:{[I.MAP]:"Map",[I.NAVIGATION]:"Navigation",[I.CARGO]:"Cargo"}},[C.STARPORT]:{label:"Starport",screens:{[I.MARKET]:"Market",[I.SERVICES]:"Services",[I.HANGAR]:"Shipyard"}},[C.DATA]:{label:"Data",screens:{[I.MISSIONS]:"Missions",[I.FINANCE]:"Finance",[I.INTEL]:"Intel"}}},this._cacheDOM(),window.addEventListener("resize",this._setAppHeight)}_setAppHeight(){document.documentElement.style.setProperty("--app-height",`${window.innerHeight}px`)}triggerEffect(e,t){this.effectsManager.trigger(e,t)}setMissionService(e){this.missionService=e}setSimulationService(e){this.simulationService=e}setDebugService(e){this.debugService=e}setEventManager(e){this.eventManager=e}resetMarketTransactionState(){this.marketTransactionState={}}_cacheDOM(){this.cache={gameContainer:document.getElementById("game-container"),navBar:document.getElementById("nav-bar"),topBarContainer:document.getElementById("top-bar-container"),subNavBar:document.getElementById("sub-nav-bar"),stickyBar:document.getElementById("sticky-bar"),mapScreen:document.getElementById(`${I.MAP}-screen`),navigationScreen:document.getElementById(`${I.NAVIGATION}-screen`),servicesScreen:document.getElementById(`${I.SERVICES}-screen`),marketScreen:document.getElementById(`${I.MARKET}-screen`),cargoScreen:document.getElementById(`${I.CARGO}-screen`),hangarScreen:document.getElementById(`${I.HANGAR}-screen`),missionsScreen:document.getElementById(`${I.MISSIONS}-screen`),financeScreen:document.getElementById(`${I.FINANCE}-screen`),intelScreen:document.getElementById(`${I.INTEL}-screen`),graphTooltip:document.getElementById("graph-tooltip"),genericTooltip:document.getElementById("generic-tooltip"),processingModal:document.getElementById("processing-modal"),shipDetailModal:document.getElementById("ship-detail-modal"),launchModal:document.getElementById("launch-modal"),launchModalContent:document.getElementById("launch-modal-content"),cargoDetailModal:document.getElementById("cargo-detail-modal"),cargoDetailContent:document.getElementById("cargo-detail-content"),mapDetailModal:document.getElementById("map-detail-modal"),loreModal:document.getElementById("lore-modal"),loreModalContent:document.getElementById("lore-modal-content"),tutorialAnchorOverlay:document.getElementById("tutorial-anchor-overlay"),tutorialToastContainer:document.getElementById("tutorial-toast-container"),tutorialToastText:document.getElementById("tutorial-toast-text"),tutorialToastSkipBtn:document.getElementById("tutorial-toast-skip-btn"),tutorialToastNextBtn:document.getElementById("tutorial-toast-next-btn"),skipTutorialModal:document.getElementById("skip-tutorial-modal"),skipTutorialConfirmBtn:document.getElementById("skip-tutorial-confirm-btn"),skipTutorialCancelBtn:document.getElementById("skip-tutorial-cancel-btn"),tutorialHighlightOverlay:document.getElementById("tutorial-highlight-overlay"),missionStickyBar:document.getElementById("mission-sticky-bar"),stickyObjectiveText:document.getElementById("sticky-objective-text"),stickyObjectiveProgress:document.getElementById("sticky-objective-progress")}}render(e){if(!e||!e.player)return;let t=this.lastKnownState;if(this.lastKnownState=e,e.introSequenceActive&&!e.tutorials.activeBatchId)return;let i=d.MARKETS.find(a=>a.id===e.currentLocationId);i&&(this.cache.topBarContainer.setAttribute("data-location-theme",i.id),this.cache.gameContainer.className=`game-container ${i.bg}`,i.navTheme&&i.navTheme.borderColor?document.documentElement.style.setProperty("--theme-border-color",i.navTheme.borderColor):document.documentElement.style.removeProperty("--theme-border-color")),this.renderNavigation(e),this.renderActiveScreen(e,t),this.updateStickyBar(e),this.renderStickyBar(e)}renderNavigation(e){let{player:t,currentLocationId:i,activeNav:a,activeScreen:s,lastActiveScreen:n,introSequenceActive:r,tutorials:o,subNavCollapsed:c}=e,{navLock:h}=o,u=d.MARKETS.find(w=>w.id===i),p=t.activeShipId?d.SHIPS[t.activeShipId]:null,m=t.activeShipId?t.shipStates[t.activeShipId]:null,f=t.activeShipId?t.inventories[t.activeShipId]:null,v=u?.navTheme||{gradient:"linear-gradient(135deg, #4a5568, #2d3748)",textColor:"#f0f0f0"},g=`
            ...
            </div>`,E=Object.keys(this.navStructure).map(w=>{let D=w===a,R=n[w]||Object.keys(this.navStructure[w].screens)[0],$=h&&h.navId!==w,G=r||$,pe=D?`background: ${v.gradient}; color: ${v.textColor};`:"";return`<div class="tab ${D?"active":""} ${G?"disabled":""}" style="${pe}" data-action="${b.SET_SCREEN}" data-nav-id="${w}" data-screen-id="${R}">${this.navStructure[w].label}</div>`}).join(""),A="";if(p&&m&&f){let w=L(f),D=m.health/p.maxHealth*100,R=m.fuel/p.maxFuel*100,$=w/p.cargoCapacity*100;A=`
            ...
            `;return g.isHalf?`<div class="pagination-dot half" style="${E}" data-action="${b.SET_HANGAR_PAGE}" data-jump-direction="${g.jump}"></div>`:`<div class="pagination-dot ${g.isActive?"active":""}" style="${E}" data-action="${b.SET_HANGAR_PAGE}" data-index="${g.index}"></div>`}).join("");n.innerHTML=v}updateStickyBar(e){this.cache.stickyBar.innerHTML="",this.cache.topBarContainer.classList.remove("has-sticky-bar")}updateServicesScreen(e){if(e.activeScreen!==I.SERVICES)return;let{player:t}=e,i=d.SHIPS[t.activeShipId],a=t.shipStates[t.activeShipId],s=this.cache.servicesScreen.querySelector("#fuel-bar"),n=this.cache.servicesScreen.querySelector("#refuel-btn");if(s&&n){let c=a.fuel/i.maxFuel*100;s.style.width=`${c}%`,n.disabled=a.fuel>=i.maxFuel}let r=this.cache.servicesScreen.querySelector("#repair-bar"),o=this.cache.servicesScreen.querySelector("#repair-btn");if(r&&o){let c=a.health/i.maxHealth*100;r.style.width=`${c}%`,o.disabled=a.health>=i.maxHealth}}updateMarketScreen(e){if(e.activeScreen!==I.MARKET)return;let t=this.cache.marketScreen.querySelector(".scroll-panel");this.lastKnownState&&this.lastKnownState.activeScreen===I.MARKET&&this.lastKnownState.currentLocationId===e.currentLocationId&&t?this.marketScrollPosition=t.scrollTop:this.marketScrollPosition=0,this._saveMarketTransactionState(),this.cache.marketScreen.innerHTML=we(e,this.isMobile,this.getItemPrice,this.marketTransactionState),this._restoreMarketTransactionState();let i=this.cache.marketScreen.querySelector(".scroll-panel");i&&(i.scrollTop=this.marketScrollPosition)}_saveMarketTransactionState(){if(!this.lastKnownState||this.lastKnownState.activeScreen!==I.MARKET)return;this.cache.marketScreen.querySelectorAll(".transaction-controls").forEach(t=>{let i=t.dataset.goodId,a=t.querySelector("input"),s=t.dataset.mode;a&&(this.marketTransactionState[i]={quantity:a.value,mode:s})})}_restoreMarketTransactionState(){for(let e in this.marketTransactionState){let t=this.marketTransactionState[e],i=this.cache.marketScreen.querySelector(`.transaction-controls[data-good-id="${e}"]`);if(i){let a=i.querySelector("input");a&&(a.value=t.quantity,i.setAttribute("data-mode",t.mode),this.updateMarketCardDisplay(e,parseInt(t.quantity,10)||0,t.mode))}}}getItemPrice(e,t,i=!1){let a=e.market.prices[e.currentLocationId][t],s=d.MARKETS.find(r=>r.id===e.currentLocationId);i&&s.specialDemand&&s.specialDemand[t]&&(a*=s.specialDemand[t].bonus);let n=e.intel.active;return n&&n.targetMarketId===e.currentLocationId&&n.commodityId===t&&(a*=n.type==="demand"?d.CONFIG.INTEL_DEMAND_MOD:d.CONFIG.INTEL_DEPRESSION_MOD),Math.max(1,Math.round(a))}_calculateSaleDetails(e,t){let i=this.lastKnownState;if(!i)return{totalPrice:0,effectivePricePerUnit:0,netProfit:0};let a=d.COMMODITIES.find(g=>g.id===e),s=i.market.inventory[i.currentLocationId][e].quantity,n=this.getItemPrice(i,e,!0),o=i.player.inventories[i.player.activeShipId]?.[e]?.avgCost||0;if(s<=0)return{totalPrice:0,effectivePricePerUnit:0,netProfit:0};let c=s*.1;if(t<=c){let g=n*t,E=o*t,A=g-E;if(A>0){let N=(i.player.activePerks[_.TRADEMASTER]?d.PERKS[_.TRADEMASTER].profitBonus:0)+(i.player.birthdayProfitBonus||0);A+=A*N}return{totalPrice:g,effectivePricePerUnit:n,netProfit:A}}let h=t/s,u=0;a.tier<=2?u=Math.min(.1,(h-.1)*.2):a.tier<=5?u=Math.min(.25,(h-.1)*.5):u=Math.min(.4,(h-.1)*.8);let p=n*(1-u),m=Math.floor(p*t),f=o*t,v=m-f;if(v>0){let g=(i.player.activePerks[_.TRADEMASTER]?d.PERKS[_.TRADEMASTER].profitBonus:0)+(i.player.birthdayProfitBonus||0);v+=v*g}return{totalPrice:m,effectivePricePerUnit:p,netProfit:v}}updateMarketCardPrice(e,t){let i=this.cache.marketScreen.querySelector(`#price-display-${e}`);if(i){i.dataset.basePrice=t;let a=i.closest(".item-card-container").querySelector(".transaction-controls");a&&a.dataset.mode==="buy"&&(i.textContent=y(t))}}updateMarketCardDisplay(e,t,i){let a=this.cache.marketScreen.querySelector(`#price-display-${e}`),s=this.cache.marketScreen.querySelector(`#effective-price-display-${e}`),n=this.cache.marketScreen.querySelector(`#indicators-${e}`),r=this.cache.marketScreen.querySelector(`#avg-cost-${e}`);if(!a||!s||!n||!this.lastKnownState)return;let o=this.lastKnownState,c=parseInt(a.dataset.basePrice,10),h=o.player.inventories[o.player.activeShipId]?.[e];if(r&&r.classList.toggle("visible",i==="sell"),i==="buy")a.textContent=y(c),a.className="font-roboto-mono font-bold price-text",s.textContent="",n.innerHTML=Y({price:c,sellPrice:this.getItemPrice(o,e,!0),galacticAvg:o.market.galacticAverages[e],playerItem:h});else{let{effectivePricePerUnit:u,netProfit:p}=this._calculateSaleDetails(e,t);if(t>0){let m=`\u232C ${p>=0?"+":""}${y(p,!1)}`;a.textContent=m,s.textContent=`(${y(u,!1)}/unit)`,a.className=`font-roboto-mono font-bold ${p>=0?"profit-text":"loss-text"}`}else a.textContent="\u232C +0",a.className="font-roboto-mono font-bold profit-text",s.textContent="";n.innerHTML=Y({price:c,sellPrice:u||this.getItemPrice(o,e,!0),galacticAvg:o.market.galacticAverages[e],playerItem:h})}}showTravelAnimation(e,t,i,a,s){this.travelAnimationService.play(e,t,i,a,s)}queueModal(e,t,i,a=null,s={}){this.modalQueue.push({modalId:e,title:t,description:i,callback:a,options:s}),document.querySelector(".modal-backdrop:not(.hidden)")||this.processModalQueue()}processModalQueue(){if(this.modalQueue.length===0)return;let{modalId:e,title:t,description:i,callback:a,options:s}=this.modalQueue.shift(),n=document.getElementById(e);if(!n)return this.logger.error("UIManager",`Modal element with ID '${e}' not found in the DOM. Aborting modal display.`),this.processModalQueue();s.specialClass&&n.classList.add(s.specialClass),s.nonDismissible&&n.classList.add("dismiss-disabled");let r=e==="mission-modal"?"mission-modal-title":e.replace("-modal","-title"),o=e==="mission-modal"?"mission-modal-description":e.replace("-modal","-description"),c=n.querySelector(`#${r}`),h=n.querySelector(`#${o}`)||n.querySelector(`#${e.replace("-modal","-scenario")}`);c&&(c.innerHTML=t),h&&(h.innerHTML=i,h.className="my-4 text-gray-300",e!=="mission-modal"&&h.classList.add("mb-6","text-lg"),(e==="event-modal"||e==="random-event-modal")&&h.classList.add("text-center"),s.contentClass&&((s.contentClass.includes("text-left")||s.contentClass.includes("text-right")||s.contentClass.includes("text-justify"))&&h.classList.remove("text-center"),h.classList.add(...s.contentClass.split(" ").filter(Boolean))));let u=()=>{this.hideModal(e),a&&a(),this.processModalQueue()};if(s.customSetup)s.customSetup(n,u);else{let p=n.querySelector("#"+e.replace("-modal","-button-container")),m;p?(p.innerHTML="",m=document.createElement("button"),p.appendChild(m)):m=n.querySelector("button"),m&&(m.className="btn px-6 py-2",s.buttonClass&&m.classList.add(s.buttonClass),m.innerHTML=s.buttonText||"Understood",m.onclick=u)}n.classList.remove("hidden"),n.classList.add("modal-visible")}showRandomEventModal(e,t){this.queueModal("random-event-modal",e.title,e.scenario,null,{nonDismissible:!0,customSetup:(i,a)=>{let s=i.querySelector("#random-event-choices-container");s.innerHTML="",e.choices.forEach((n,r)=>{let o=document.createElement("button");o.className="btn w-full text-center p-4 hover:bg-slate-700",o.innerHTML=n.title,o.onclick=()=>{t(e.id,r),a()},s.appendChild(o)})}})}showAgeEventModal(e,t){let i=document.getElementById("age-event-modal");i.classList.add("dismiss-disabled"),document.getElementById("age-event-title").innerHTML=e.title,document.getElementById("age-event-description").innerHTML=e.description;let a=document.getElementById("age-event-button-container");a.innerHTML="",e.choices.forEach(s=>{let n=document.createElement("button");n.className="perk-button",n.innerHTML=`<h4>${s.title}</h4><p>${s.description}</p>`,n.onclick=()=>{this.hideModal("age-event-modal"),t(s)},a.appendChild(n)}),i.classList.remove("hidden"),i.classList.add("modal-visible")}showLoreModal(e){let t=this.cache.loreModal,i=this.cache.loreModalContent;if(!t||!i){this.logger.error("UIManager","Lore modal elements not cached or found in DOM.");return}let a=ze[e];a?i.innerHTML=a:(this.logger.error("UIManager",`No lore content found for ID: ${e}`),i.innerHTML="<p>Error: Lore content not found.</p>"),i.scrollTop=0,t.classList.remove("hidden"),t.classList.add("modal-visible");let s=n=>{(n.target.closest("#lore-modal-content")||n.target.id==="lore-modal")&&(this.hideModal("lore-modal"),t.removeEventListener("click",s))};t.addEventListener("click",s)}hideModal(e){let t=document.getElementById(e);t&&!t.classList.contains("hidden")&&(t.classList.add("modal-hiding"),t.addEventListener("animationend",()=>{t.classList.add("hidden"),t.classList.remove("modal-hiding","modal-visible","dismiss-disabled","intro-fade-in"),this.modalQueue.length>0&&!document.querySelector(".modal-backdrop:not(.hidden)")&&this.processModalQueue()},{once:!0}))}showProcessingAnimation(e,t){let i=this.cache.processingModal;if(!i)return;let a=i.querySelector("#processing-title"),s=i.querySelector("#processing-progress-bar"),n=i.querySelector("#processing-status");a.textContent=`Processing application for ${e}...`,s.style.width="0%",n.textContent="",i.classList.remove("hidden"),setTimeout(()=>{s.style.width="100%"},100),setTimeout(()=>{n.textContent="Processing complete!",setTimeout(()=>{this.hideModal("processing-modal"),t&&t()},1e3)},4e3)}createFloatingText(e,t,i,a="#fde047"){let s=document.createElement("div");s.textContent=e,s.className="floating-text",s.style.left=`${t-20}px`,s.style.top=`${i-40}px`,s.style.color=a,document.body.appendChild(s),setTimeout(()=>s.remove(),2450)}showGraph(e,t){this.activeGraphAnchor=e;let i=this.cache.graphTooltip,a=e.dataset.action;if(a===b.SHOW_PRICE_GRAPH){let s=e.dataset.goodId,n=t.player.inventories[t.player.activeShipId][s];i.innerHTML=this._renderPriceGraph(s,t,n)}else a===b.SHOW_FINANCE_GRAPH&&(i.innerHTML=this._renderFinanceGraph(t));i.style.display="block",this.updateGraphTooltipPosition()}hideGraph(){this.activeGraphAnchor&&(this.cache.graphTooltip.style.display="none",this.activeGraphAnchor=null)}updateGraphTooltipPosition(){if(!this.activeGraphAnchor)return;let e=this.cache.graphTooltip;if(e.style.display==="none")return;let t=this.activeGraphAnchor.closest(".item-card-container").getBoundingClientRect(),i=e.offsetHeight,a=t.top-i-10,s=t.left;a<10&&(a=t.bottom+10),e.style.left=`${s}px`,e.style.top=`${a}px`}showGenericTooltip(e,t){this.activeGenericTooltipAnchor=e;let i=this.cache.genericTooltip;i.innerHTML=t,i.style.display="block",this.updateGenericTooltipPosition()}hideGenericTooltip(){this.activeGenericTooltipAnchor&&(this.cache.genericTooltip.style.display="none",this.activeGenericTooltipAnchor=null)}updateGenericTooltipPosition(){if(!this.activeGenericTooltipAnchor)return;let e=this.cache.genericTooltip,t=this.activeGenericTooltipAnchor.getBoundingClientRect(),i=e.offsetWidth,a=e.offsetHeight,s=t.right+10,n=t.top+t.height/2-a/2;n<10&&(n=t.bottom+10),s<10&&(s=10),s+i>window.innerWidth&&(s=window.innerWidth-i-10),e.style.left=`${s}px`,e.style.top=`${n}px`}_renderPriceGraph(e,t,i){let a=t.market.priceHistory[t.currentLocationId]?.[e];if(!a||a.length<2)return'<div class="text-gray-400 text-sm p-4">No Data Available!</div>';let s=d.COMMODITIES.find(R=>R.id===e),n=(s.basePriceRange[0]+s.basePriceRange[1])/2,r=280,o=140,c=35,h=a.map(R=>R.price),u=i?.avgCost>0?i.avgCost:null,p=[...h,n];u&&p.push(u);let m=Math.min(...p),f=Math.max(...p),v=f-m>0?f-m:1,g=R=>R/(a.length-1)*(r-c*2)+c,E=R=>o-c-(R-m)/v*(o-c*2.5),A=`<svg width="${r}" height="${o}" xmlns="http://www.w3.org/2000/svg"><rect width="100%" height="100%" fill="#0c101d" />`;A+='<g class="grid-lines" stroke="#1f2937" stroke-width="1">',A+=`<line x1="${c}" y1="${E(f)}" x2="${c}" y2="${o-c}" /><line x1="${c}" y1="${o-c}" x2="${r-c}" y2="${o-c}" />`,A+="</g>";let N=E(n);if(A+=`<line x1="${c}" y1="${N}" x2="${r-c}" y2="${N}" stroke="#facc15" stroke-width="1" stroke-dasharray="3 3" />`,A+=`<text x="${r-c+4}" y="${N+3}" fill="#facc15" font-size="10" font-family="Roboto Mono" text-anchor="start">Avg: ${y(n,!1)}</text>`,u){let R=E(u);A+=`<line x1="${c}" y1="${R}" x2="${r-c}" y2="${R}" stroke="#34d399" stroke-width="1" stroke-dasharray="3 3" />`,A+=`<text x="${r-c+4}" y="${R+3}" fill="#34d399" font-size="10" font-family="Roboto Mono" text-anchor="start">Paid: ${y(u,!1)}</text>`}let k=a.map((R,$)=>`${g($)},${E(R.price)}`).join(" ");A+=`<polyline fill="none" stroke="#60a5fa" stroke-width="2" points="${k}" />`;let w=a[0].day,D=a[a.length-1].day;return A+=`<text x="${c}" y="${o-c+15}" fill="#9ca3af" font-size="10" font-family="Roboto Mono" text-anchor="start">Day ${w}</text>`,A+=`<text x="${r-c}" y="${o-c+15}" fill="#9ca3af" font-size="10" font-family="Roboto Mono" text-anchor="end">Day ${D}</text>`,A+=`<text x="${c-8}" y="${E(m)+3}" fill="#9ca3af" font-size="10" font-family="Roboto Mono" text-anchor="end">${y(m,!1)}</text>`,A+=`<text x="${c-8}" y="${E(f)+3}" fill="#9ca3af" font-size="10" font-family="Roboto Mono" text-anchor="end">${y(f,!1)}</text>`,A+="</svg>",A}showTutorialToast({step:e,onSkip:t,onNext:i,gameState:a}){let s=this.cache.tutorialToastContainer,n=s.querySelector("#tt-arrow"),r=e.anchorElement==="body",o;r?o=this.cache.tutorialAnchorOverlay:(o=document.querySelector(e.anchorElement),o||(this.logger.error("TutorialService",`Anchor element "${e.anchorElement}" not found for step "${e.stepId}". Defaulting to overlay.`),o=this.cache.tutorialAnchorOverlay)),this.popperInstance&&(this.popperInstance.destroy(),this.popperInstance=null);let c=e.text;if(c.includes("{shipName}")){let f=a.player.activeShipId,v=f?d.SHIPS[f].name:"your ship";c=c.replace(/{shipName}/g,v)}if(c.includes("{playerName}")){let f=a.player.name||"Captain";c=c.replace(/{playerName}/g,f)}this.cache.tutorialToastText.innerHTML=c;let h=e.size?.width||"auto",u=e.size?.height||"auto";if(s.style.width=h,s.style.height=u,r){let f=e.positionX??50,v=e.positionY??50;s.style.left=`${f}%`,s.style.top=`${v}%`,s.style.transform="translate(-50%, -50%)",n.style.display="none",s.removeAttribute("data-popper-placement")}else{s.style.left="",s.style.top="",s.style.transform="",n.style.display="block";let f={placement:"auto",modifiers:[{name:"offset",options:{offset:[0,10]}},{name:"preventOverflow",options:{padding:{top:60,bottom:60,left:10,right:10}}},{name:"flip",options:{fallbackPlacements:["top","bottom","left","right"]}},{name:"arrow",options:{element:"#tt-arrow",padding:5}}]},v=e.popperOptions?.modifiers?.find(A=>A.name==="offset"),g=f.modifiers.filter(A=>A.name!=="offset");v?g.push(v):g.push(f.modifiers.find(A=>A.name==="offset")),e.popperOptions?.modifiers;let E={placement:e.placement||e.popperOptions?.placement||f.placement,modifiers:g};this.popperInstance=Popper.createPopper(o,s,E)}s.classList.remove("hidden");let p=e.completion.type==="INFO";this.cache.tutorialToastNextBtn.classList.toggle("hidden",!p),p&&(this.cache.tutorialToastNextBtn.onclick=i);let m=!1;this.cache.tutorialToastSkipBtn.style.display=m?"block":"none",this.cache.tutorialToastSkipBtn.onclick=t,this.cache.tutorialToastText.scrollTop=0,this.debugService&&this.debugService.setActiveTutorialStep(e)}hideTutorialToast(){this.cache.tutorialToastContainer.classList.add("hidden"),this.popperInstance&&(this.popperInstance.destroy(),this.popperInstance=null),this.applyTutorialHighlight(null),this.debugService&&this.debugService.clearActiveTutorialStep()}updateTutorialPopper(e){let t=this.cache.tutorialToastContainer,i=t.querySelector("#tt-arrow"),{isOverlayAnchor:a,width:s,height:n,percentX:r,percentY:o,placement:c,distance:h,skidding:u}=e;if(t.style.width=s>0?`${s}px`:"auto",t.style.height=n>0?`${n}px`:"auto",a)this.popperInstance&&(this.popperInstance.destroy(),this.popperInstance=null,t.removeAttribute("data-popper-placement"),t.style.transform=""),t.style.left=`${r}%`,t.style.top=`${o}%`,t.style.transform="translate(-50%, -50%)",i.style.display="none";else{t.style.left="",t.style.top="",t.style.transform="",i.style.display="block";let p={placement:c,modifiers:[{name:"offset",options:{offset:[u,h]}},{name:"preventOverflow",options:{padding:{top:60,bottom:60,left:10,right:10}}},{name:"flip",options:{fallbackPlacements:["top","bottom","left","right"]}},{name:"arrow",options:{element:"#tt-arrow",padding:5}}]};this.popperInstance?this.popperInstance.setOptions(p).catch(m=>{this.logger.error("UIManager","Error updating Popper options:",m)}):this.logger.warn("UIManager","Popper instance needed but not found during update. Re-trigger toast if anchor type changed.")}}applyTutorialHighlight(e){this.activeHighlightConfig=e,this._renderHighlightsFromConfig(this.activeHighlightConfig)}_renderHighlightsFromConfig(e){let t=this.cache.tutorialHighlightOverlay;if(t){if(t.innerHTML="",!e){t.classList.add("hidden");return}t.classList.remove("hidden"),e.forEach(i=>{let a=document.createElement("div");a.className="tutorial-cue",a.style.left=`${i.x}px`,a.style.top=`${i.y}px`,a.style.width=`${i.width}px`,a.style.height=`${i.height}px`,a.style.transform=`rotate(${i.rotation}deg)`,a.style.opacity=i.style.opacity,i.style.animation!=="None"&&a.classList.add(`anim-${i.style.animation.toLowerCase()}`);let s="";i.type==="Shape"?s=`
                ...
                </div>`}else{let h=a.shipStates[t],u=a.inventories[t],p=L(u),m=t===a.activeShipId,f=a.ownedShipIds.length>1&&!m,v=Math.floor(n.price*x.SHIP_SELL_MODIFIER);r=`
...
}`);let r=`// --- ${this.debugState.ttStepId} ---${s}${n}`;r=r.replace(/,\s*(\}|$)/g,"$1"),this.debugState.ttGeneratedCode=r}};var ue=()=>{let l=window.visualViewport?window.visualViewport.height:window.innerHeight;document.documentElement.style.setProperty("--app-height",`${l}px`)};document.addEventListener("DOMContentLoaded",()=>{let l=document.getElementById("splash-screen"),e=document.getElementById("start-game-btn"),t=document.getElementById("debug-start-btn"),i=!0;ue(),window.visualViewport?(window.visualViewport.addEventListener("resize",ue),window.visualViewport.addEventListener("scroll",ue)):window.addEventListener("resize",ue),e.addEventListener("click",()=>{l.classList.add("splash-screen-hiding"),l.addEventListener("animationend",()=>{l.style.display="none",a()},{once:!0})},{once:!0}),t.addEventListener("click",()=>{l.classList.add("splash-screen-hiding"),l.addEventListener("animationend",()=>{l.style.display="none",a(!0)},{once:!0})});function a(s=!1){let n=new j,r=new te(B),o=new ce(n,r,B),c=new J(n,r,B),h=new le(n,r,c,r.navStructure,B),u=null;i&&(u=new he(n,c,r,B),u.init(),r.setDebugService(u)),r.setMissionService(o),r.setSimulationService(c),c.setTutorialService(h),c.setMissionService(o),o.setSimulationService(c);let p=new oe(n,c,r,h,u,B);r.setEventManager(p),n.subscribe(()=>r.render(n.getState()));let m=n.loadGame();m||(s&&u?(n.startNewGame(""),u.simpleStart()):(n.startNewGame(""),c.timeService.advanceDays(7),c.startIntroSequence())),p.bindEvents(),(m||s)&&(r.showGameContainer(),r.render(n.getState())),h.checkState({type:"SCREEN_LOAD",screenId:n.activeScreen})}});})();
