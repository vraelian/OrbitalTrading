(()=>{var v=Object.freeze({STATUS:"status",NAVIGATION:"navigation",SERVICES:"services",MARKET:"market",CARGO:"cargo",HANGAR:"hangar",MISSIONS:"missions",FINANCE:"finance",INTEL:"intel"}),N=Object.freeze({SHIP:"ship",STARPORT:"starport",DATA:"data"}),A=Object.freeze({WANDERER:"starter",STALWART:"hauler_c1",MULE:"hauler_c2",PATHFINDER:"explorer_b1",NOMAD:"explorer_b2",VINDICATOR:"frigate_a1",AEGIS:"frigate_a2",ODYSSEY:"luxury_s1",MAJESTIC:"luxury_s2",TITAN_HAULER:"rare_s1",VOID_CHASER:"rare_s2",GUARDIAN:"rare_s3",STARGAZER:"rare_s4",BEHEMOTH:"rare_o1"}),L=Object.freeze({WATER_ICE:"water_ice",PLASTEEL:"plasteel",HYDROPONICS:"hydroponics",CYBERNETICS:"cybernetics",PROPELLANT:"propellant",PROCESSORS:"processors",GMO_SEEDS:"gmo_seeds",CRYO_PODS:"cryo_pods",ATMO_PROCESSORS:"atmos_processors",CLONED_ORGANS:"cloned_organs",XENO_GEOLOGICALS:"xeno_geologicals",SENTIENT_AI:"sentient_ai",ANTIMATTER:"antimatter",FOLDED_DRIVES:"folded_drives"}),y=Object.freeze({EARTH:"loc_earth",LUNA:"loc_luna",MARS:"loc_mars",VENUS:"loc_venus",BELT:"loc_belt",SATURN:"loc_saturn",JUPITER:"loc_jupiter",URANUS:"loc_uranus",NEPTUNE:"loc_neptune",PLUTO:"loc_pluto",EXCHANGE:"loc_exchange",KEPLER:"loc_kepler"}),_=Object.freeze({TRADEMASTER:"trademaster",NAVIGATOR:"navigator",VENETIAN_SYNDICATE:"venetian_syndicate",MERCHANT_GUILD_SHIP:"merchant_guild_ship"}),b=Object.freeze({SET_SCREEN:"set-screen",TRAVEL:"travel",BUY_SHIP:"buy-ship",SELL_SHIP:"sell-ship",SELECT_SHIP:"select-ship",PAY_DEBT:"pay-debt",TAKE_LOAN:"take-loan",PURCHASE_INTEL:"purchase-intel",ACQUIRE_LICENSE:"acquire-license",BUY_ITEM:"buy-item",SELL_ITEM:"sell-item",SET_MAX_BUY:"set-max-buy",SET_MAX_SELL:"set-max-sell",INCREMENT:"increment",DECREMENT:"decrement",SHOW_PRICE_GRAPH:"show-price-graph",SHOW_FINANCE_GRAPH:"show-finance-graph",TOGGLE_MARKET_CARD_VIEW:"toggle-market-card-view"}),D=Object.freeze({SCREEN_LOAD:"SCREEN_LOAD",ACTION:"ACTION",INFO:"INFO"}),R=Object.freeze({STARTING_CREDITS:5e3,STARTING_DEBT_INTEREST:125,REPAIR_COST_PER_HP:75,REPAIR_AMOUNT_PER_TICK:5,FUEL_SCALAR:3,INTEREST_INTERVAL:30,PASSIVE_REPAIR_RATE:.02,HULL_DECAY_PER_TRAVEL_DAY:1/7,SHIP_SELL_MODIFIER:.75,RARE_SHIP_CHANCE:.3,PRICE_HISTORY_LENGTH:65,FINANCE_HISTORY_LENGTH:10,DAILY_PRICE_VOLATILITY:.15,MEAN_REVERSION_STRENGTH:.07,MARKET_PRESSURE_DECAY:.7,LOAN_GARNISHMENT_DAYS:1095,LOAN_GARNISHMENT_PERCENT:.14,RANDOM_EVENT_CHANCE:.07}),ce=[{threshold:5e4,revealsTier:2},{threshold:45e4,revealsTier:3},{threshold:4e6,revealsTier:4},{threshold:35e6,revealsTier:5},{threshold:3e8,revealsTier:6},{threshold:25e8,revealsTier:7}];var me="orbitalTraderSave_v2";var F={START_YEAR:2140,START_DAY_OF_WEEK:1,DAYS_IN_MONTH:[31,28,31,30,31,30,31,31,30,31,30,31],MONTH_NAMES:["January","February","March","April","May","June","July","August","September","October","November","December"],DAY_NAMES:["Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"]},Re={NEUTRAL:{name:"Neutral System",duration:28,description:"Standard space-faring conditions. Markets are operating under normal parameters.",modifiers:{}}},d={CONFIG:{INTEL_COST_PERCENTAGE:.2,INTEL_MIN_CREDITS:5e3,INTEL_CHANCE:.3,INTEL_DEMAND_MOD:1.8,INTEL_DEPRESSION_MOD:.5},SYSTEM_STATES:Re,DATE_CONFIG:F,INTRO_SEQUENCE_V1:{modals:[{id:"lore_1",title:"Year 2140",description:'Humanity has expanded throughout the Solar System.<br><br> <span class="hl">Commerce</span> has thrived among the numerous colonies and stations longer than living memory.',buttonText:"Begin",contentClass:"text-center"},{id:"lore_2",title:"The Price of Freedom",description:"A dead-end job in the Belt paid the bills... yet you dream of <b class='hl-green font-bold'>wealth</b>.<br><br>The <span class='hl'>Merchant's Guild</span> is willing to finance your ambition at a steep price. It's not just a loan; it's a wager on your very future.",buttonText:"Apply for Loan",contentClass:"text-center",buttonClass:"btn-pulse-green"},{id:"charter",title:`<span class="hl">MERCHANT'S GUILD LOAN AGREEMENT</span>`,description:`
        ...
        <div class="ship-info">
            ...
            <div class="bottom-line">
                <div class="cargo-bar">${Array.from({length:Math.max(10,Math.min(25,Math.floor(s.cargoCapacity/8)))},(H,S)=>{let x=Math.round(f/s.cargoCapacity*Math.max(10,Math.min(25,Math.floor(s.cargoCapacity/8))));return`<div class="segment ${S<x?"filled":""}"></div>`}).join("")}</div>
    ...
    <div class="item-card-container ${f?"":"locked"} ${H?"minimized":""}" id="item-card-container-${c.id}">
        <div class="rounded-lg border ${c.styleClass} transition-colors shadow-md">
            <button class="card-toggle-btn" data-action="${b.TOGGLE_MARKET_CARD_VIEW}" data-good-id="${c.id}">${H?"+":"\u2212"}</button>
            
            <div class="max-view-content">
                <p class="font-bold commodity-name"><span class="commodity-name-tooltip" ${M}>${c.name}</span></p>
                <p class="avail-text">Avail: <span id="m-stock-${c.id}">${m.quantity}</span>, Own: <span id="p-inv-${c.id}">${k}</span></p>
                ...
                <div class="indicator-container" id="indicators-${c.id}">${S}</div>
    ...
    </div>`}function Te(c){let{player:e,day:t,currentLocationId:i}=c,a=d.SHIPS[e.activeShipId],s=e.shipStates[e.activeShipId],o=e.inventories[e.activeShipId],r=$(o),l=d.MARKETS.find(h=>h.id===i)?.navTheme||{gradient:"linear-gradient(135deg, #4a5568, #2d3748)",textColor:"#f0f0f0",borderColor:"#7a9ac0"};return`
        ...
        </div>`}function Ie(c){let{player:e,currentLocationId:t,TRAVEL_DATA:i,tutorials:a}=c,{navLock:s}=a,o=s&&s.screenId===v.NAVIGATION,r=o?s.enabledElementQuery:null;return`
        ...
        </div>`}function Ee(c){let{player:e,currentLocationId:t}=c,i=d.SHIPS[e.activeShipId],a=e.shipStates[e.activeShipId],s=d.MARKETS.find(u=>u.id===t),o=s?.navTheme||{gradient:"linear-gradient(135deg, #4a5568, #2d3748)",textColor:"#f0f0f0",borderColor:"#7a9ac0"},r=s.fuelPrice/2;e.activePerks[_.VENETIAN_SYNDICATE]&&t===y.VENUS&&(r*=1-d.PERKS[_.VENETIAN_SYNDICATE].fuelDiscount);let n=i.maxHealth*(R.REPAIR_AMOUNT_PER_TICK/100)*R.REPAIR_COST_PER_HP;e.activePerks[_.VENETIAN_SYNDICATE]&&t===y.VENUS&&(n*=1-d.PERKS[_.VENETIAN_SYNDICATE].repairDiscount);let l=a.fuel/i.maxFuel*100,h=a.health/i.maxHealth*100;return`
...
Avg. Cost: ${g(n.avgCost,!1)}`;return`
    ...
    `}function Me(c){let{player:e,day:t,currentLocationId:i}=c,s=d.MARKETS.find(n=>n.id===i)?.navTheme||{gradient:"linear-gradient(135deg, #4a5568, #2d3748)",textColor:"#f0f0f0",borderColor:"#7a9ac0"},o;if(e.debt>0){let n="";if(e.loanStartDate){let l=R.LOAN_GARNISHMENT_DAYS-(t-e.loanStartDate);l>0&&(n=`<p class="text-xs text-red-400/70 mt-2">Garnishment in ${l} days</p>`)}o=`
            <div>
    ...
    `}function xe(){return`
        <div class="text-center p-8 flex flex-col items-center gap-4">
            ...
            <div class="context-bar" style="background: ${T.gradient}; color: ${T.textColor};">
            ...
            </div>`,C=Object.keys(this.navStructure).map(S=>{let x=S===a,I=o[S]||Object.keys(this.navStructure[S].screens)[0],w=h&&h.navId!==S,O=r||w,P=x?`background: ${T.gradient}; color: ${T.textColor};`:"";return`<div class="tab ${S}-tab ${x?"active":""} ${O?"disabled":""}" style="${P}" data-action="${b.SET_SCREEN}" data-nav-id="${S}" data-screen-id="${I}">${this.navStructure[S].label}</div>`}).join(""),M="";if(p&&m&&f){let S=$(f),x=m.health/p.maxHealth*100,I=m.fuel/p.maxFuel*100,w=S/p.cargoCapacity*100;M=`
                <div class="status-pod">
                    ...
                    <div class="status-bar-group cargo-group" data-action="toggle-tooltip">
                        ...
                        <div class="status-tooltip">${S}/${p.cargoCapacity} Cargo</div>
                    </div>
                </div>`}let k=`<div class="nav-wrapper">${C}${M}</div>`,H=Object.keys(this.navStructure).map(S=>{let x=this.navStructure[S].screens,I=S===a,w=Object.keys(x).map(O=>{let P=h&&h.screenId!==O;return`<a href="#" class="${r||P?"disabled":""} ${O===s?"active":""}" style="color: ${T.textColor};" data-action="${b.SET_SCREEN}" data-nav-id="${S}" data-screen-id="${O}" draggable="false">${x[O]}</a>`}).join("");return`<div class="nav-sub ${!I||l?"hidden":""}" id="${S}-sub">${w}</div>`}).join("");this.cache.navBar.innerHTML=E+k,this.cache.subNavBar.innerHTML=H}renderActiveScreen(e){let t=document.getElementById(`${e.activeScreen}-screen`);switch(this.lastActiveScreenEl&&this.lastActiveScreenEl!==t&&(this.lastActiveScreenEl.style.display="none"),t&&(t.style.display="block",this.lastActiveScreenEl=t),e.activeScreen){case v.STATUS:this.cache.statusScreen.innerHTML=Te(e);break;case v.NAVIGATION:this.cache.navigationScreen.innerHTML=Ie(e);break;case v.SERVICES:this.cache.servicesScreen.innerHTML=Ee(e);break;case v.MARKET:this._saveMarketTransactionState(),this.cache.marketScreen.innerHTML=de(e,this.isMobile,this.getItemPrice,this.marketTransactionState),this._restoreMarketTransactionState();break;case v.CARGO:this.cache.cargoScreen.innerHTML=Ae(e);break;case v.HANGAR:this.cache.hangarScreen.innerHTML=be(e,this.isMobile);break;case v.MISSIONS:this.cache.missionsScreen.innerHTML=_e(e,this.missionService);break;case v.FINANCE:this.cache.financeScreen.innerHTML=Me(e);break;case v.INTEL:this.cache.intelScreen.innerHTML=xe();break}}updateStickyBar(e){this.cache.stickyBar.innerHTML="",this.cache.topBarContainer.classList.remove("has-sticky-bar")}updateServicesScreen(e){if(e.activeScreen!==v.SERVICES)return;let{player:t}=e,i=d.SHIPS[t.activeShipId],a=t.shipStates[t.activeShipId],s=document.getElementById("services-credits-display");s&&(s.innerHTML=`<span class="text-cyan-400">\u232C </span><span class="font-bold text-cyan-300 ml-auto">${g(t.credits,!1)}</span>`);let o=document.getElementById("fuel-bar"),r=document.getElementById("refuel-btn");if(o&&r){let h=a.fuel/i.maxFuel*100;o.style.width=`${h}%`,r.disabled=a.fuel>=i.maxFuel}let n=document.getElementById("repair-bar"),l=document.getElementById("repair-btn");if(n&&l){let h=a.health/i.maxHealth*100;n.style.width=`${h}%`,l.disabled=a.health>=i.maxHealth}}updateMarketScreen(e){e.activeScreen===v.MARKET&&(this._saveMarketTransactionState(),this.cache.marketScreen.innerHTML=de(e,this.isMobile,this.getItemPrice,this.marketTransactionState),this._restoreMarketTransactionState())}_saveMarketTransactionState(){if(!this.lastKnownState||this.lastKnownState.activeScreen!==v.MARKET)return;document.querySelectorAll(".transaction-controls").forEach(t=>{let i=t.dataset.goodId,a=t.querySelector("input"),s=t.dataset.mode;a&&(this.marketTransactionState[i]={quantity:a.value,mode:s})})}_restoreMarketTransactionState(){for(let e in this.marketTransactionState){let t=this.marketTransactionState[e],i=document.querySelector(`.transaction-controls[data-good-id="${e}"]`);if(i){let a=i.querySelector("input");a&&(a.value=t.quantity,i.setAttribute("data-mode",t.mode),this.updateMarketCardDisplay(e,parseInt(t.quantity,10)||0,t.mode))}}}getItemPrice(e,t,i=!1){let a=e.market.prices[e.currentLocationId][t],s=d.MARKETS.find(r=>r.id===e.currentLocationId);i&&s.specialDemand&&s.specialDemand[t]&&(a*=s.specialDemand[t].bonus);let o=e.intel.active;return o&&o.targetMarketId===e.currentLocationId&&o.commodityId===t&&(a*=o.type==="demand"?d.CONFIG.INTEL_DEMAND_MOD:d.CONFIG.INTEL_DEPRESSION_MOD),Math.max(1,Math.round(a))}_calculateSaleDetails(e,t){let i=this.lastKnownState;if(!i)return{totalPrice:0,effectivePricePerUnit:0,netProfit:0};let a=d.COMMODITIES.find(E=>E.id===e),s=i.market.inventory[i.currentLocationId][e].quantity,o=this.getItemPrice(i,e,!0),n=i.player.inventories[i.player.activeShipId]?.[e]?.avgCost||0;if(s<=0)return{totalPrice:0,effectivePricePerUnit:0,netProfit:0};let l=s*.1;if(t<=l){let E=o*t,C=n*t,M=E-C;if(M>0){let k=(i.player.activePerks[_.TRADEMASTER]?d.PERKS[_.TRADEMASTER].profitBonus:0)+(i.player.birthdayProfitBonus||0);M+=M*k}return{totalPrice:E,effectivePricePerUnit:o,netProfit:M}}let h=t/s,u=0;a.tier<=2?u=Math.min(.1,(h-.1)*.2):a.tier<=5?u=Math.min(.25,(h-.1)*.5):u=Math.min(.4,(h-.1)*.8);let p=o*(1-u),m=Math.floor(p*t),f=n*t,T=m-f;if(T>0){let E=(i.player.activePerks[_.TRADEMASTER]?d.PERKS[_.TRADEMASTER].profitBonus:0)+(i.player.birthdayProfitBonus||0);T+=T*E}return{totalPrice:m,effectivePricePerUnit:p,netProfit:T}}updateMarketCardPrice(e,t){let i=document.getElementById(`price-display-${e}`);if(i){i.dataset.basePrice=t;let a=i.closest(".item-card-container").querySelector(".transaction-controls");a&&a.dataset.mode==="buy"&&(i.textContent=g(t))}}updateMarketCardDisplay(e,t,i){let a=document.getElementById(`price-display-${e}`),s=document.getElementById(`effective-price-display-${e}`),o=document.getElementById(`indicators-${e}`),r=document.getElementById(`avg-cost-${e}`);if(!a||!s||!o||!this.lastKnownState)return;let n=this.lastKnownState,l=parseInt(a.dataset.basePrice,10),h=n.player.inventories[n.player.activeShipId]?.[e];if(r&&r.classList.toggle("visible",i==="sell"),i==="buy")a.textContent=g(l),a.className="font-roboto-mono font-bold price-text",s.textContent="",o.innerHTML=W({price:l,sellPrice:this.getItemPrice(n,e,!0),galacticAvg:n.market.galacticAverages[e],playerItem:h});else{let{effectivePricePerUnit:u,netProfit:p}=this._calculateSaleDetails(e,t);if(t>0){let m=`\u232C ${p>=0?"+":""}${g(p,!1)}`;a.textContent=m,s.textContent=`(${g(u,!1)}/unit)`,a.className=`font-roboto-mono font-bold ${p>=0?"profit-text":"loss-text"}`}else a.textContent="\u232C +0",a.className="font-roboto-mono font-bold profit-text",s.textContent="";o.innerHTML=W({price:l,sellPrice:u||this.getItemPrice(n,e,!0),galacticAvg:n.market.galacticAverages[e],playerItem:h})}}showTravelAnimation(e,t,i,a,s){let o=document.getElementById("travel-animation-modal"),r=document.getElementById("travel-status-text"),n=document.getElementById("travel-arrival-lore"),l=document.getElementById("travel-canvas"),h=l.getContext("2d"),u=document.getElementById("travel-progress-container"),p=document.getElementById("travel-progress-bar"),m=document.getElementById("travel-readout-container"),f=document.getElementById("travel-info-text"),T=document.getElementById("travel-hull-damage"),E=document.getElementById("travel-confirm-button"),C=null;r.textContent=`Traveling to ${t.name}...`,n.textContent="",n.style.opacity=0,m.classList.add("hidden"),m.style.opacity=0,E.classList.add("hidden"),E.style.opacity=0,u.classList.remove("hidden"),p.style.width="0%",o.classList.remove("hidden");let M=2500,k=null,H=d.LOCATION_VISUALS[e.id]||"\u2753",S=d.LOCATION_VISUALS[t.id]||"\u2753",x="\u{1F680}",I=[],w=150;l.width=l.clientWidth,l.height=l.clientHeight;for(let P=0;P<w;P++)I.push({x:Math.random()*l.width,y:Math.random()*l.height,radius:Math.random()*1.5,speed:.2+Math.random()*.8,alpha:.5+Math.random()*.5});let O=P=>{k||(k=P);let V=P-k,B=Math.min(V/M,1);B=1-Math.pow(1-B,3),l.width=l.clientWidth,l.height=l.clientHeight,h.clearRect(0,0,l.width,l.height),h.fillStyle="#FFF";for(let le=0;le<w;le++){let q=I[le];B<1&&(q.x-=q.speed,q.x<0&&(q.x=l.width)),h.beginPath(),h.arc(q.x,q.y,q.radius,0,Math.PI*2),h.globalAlpha=q.alpha,h.fill()}h.globalAlpha=1;let Q=60,K=Q,pe=l.width-Q,re=l.height/2;h.font="42px sans-serif",h.textAlign="center",h.textBaseline="middle",h.fillText(H,K,re),h.fillText(S,pe,re);let Ce=K+(pe-K)*B;h.save(),h.translate(Ce,re),h.font="17px sans-serif",h.fillText(x,0,0),h.restore(),p.style.width=`${B*100}%`,B<1?C=requestAnimationFrame(O):(r.textContent=`Arrived at ${t.name}`,n.innerHTML=t.arrivalLore||"You have arrived.",f.innerHTML=`
                ...
                </div>`}else{let h=a.shipStates[t],u=a.inventories[t],p=$(u),m=t===a.activeShipId,f=a.ownedShipIds.length>1&&!m,T=Math.floor(o.price*R.SHIP_SELL_MODIFIER);r=`
