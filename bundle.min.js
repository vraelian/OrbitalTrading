(()=>{var v=Object.freeze({MAP:"map",NAVIGATION:"navigation",SERVICES:"services",MARKET:"market",CARGO:"cargo",HANGAR:"hangar",MISSIONS:"missions",FINANCE:"finance",INTEL:"intel"}),A=Object.freeze({SHIP:"ship",STARPORT:"starport",DATA:"data"}),I=Object.freeze({WANDERER:"starter",STALWART:"hauler_c1",MULE:"hauler_c2",PATHFINDER:"explorer_b1",NOMAD:"explorer_b2",VINDICATOR:"frigate_a1",AEGIS:"frigate_a2",ODYSSEY:"luxury_s1",MAJESTIC:"luxury_s2",TITAN_HAULER:"rare_s1",VOID_CHASER:"rare_s2",GUARDIAN:"rare_s3",STARGAZER:"rare_s4",BEHEMOTH:"rare_o1"}),y=Object.freeze({WATER_ICE:"water_ice",PLASTEEL:"plasteel",HYDROPONICS:"hydroponics",CYBERNETICS:"cybernetics",PROPELLANT:"propellant",PROCESSORS:"processors",GMO_SEEDS:"gmo_seeds",CRYO_PODS:"cryo_pods",ATMO_PROCESSORS:"atmos_processors",CLONED_ORGANS:"cloned_organs",XENO_GEOLOGICALS:"xeno_geologicals",SENTIENT_AI:"sentient_ai",ANTIMATTER:"antimatter",FOLDED_DRIVES:"folded_drives"}),g=Object.freeze({EARTH:"loc_earth",LUNA:"loc_luna",MARS:"loc_mars",VENUS:"loc_venus",BELT:"loc_belt",SATURN:"loc_saturn",JUPITER:"loc_jupiter",URANUS:"loc_uranus",NEPTUNE:"loc_neptune",PLUTO:"loc_pluto",EXCHANGE:"loc_exchange",KEPLER:"loc_kepler"}),T=Object.freeze({TRADEMASTER:"trademaster",NAVIGATOR:"navigator",VENETIAN_SYNDICATE:"venetian_syndicate",MERCHANT_GUILD_SHIP:"merchant_guild_ship"}),S=Object.freeze({DEBUG_SIMPLE_START:"debug-simple-start",SET_SCREEN:"set-screen",TRAVEL:"travel",BUY_SHIP:"buy-ship",SELL_SHIP:"sell-ship",SELECT_SHIP:"select-ship",PAY_DEBT:"pay-debt",TAKE_LOAN:"take-loan",PURCHASE_INTEL:"purchase-intel",ACQUIRE_LICENSE:"acquire-license",BUY_ITEM:"buy-item",SELL_ITEM:"sell-item",SET_MAX_BUY:"set-max-buy",SET_MAX_SELL:"set-max-sell",INCREMENT:"increment",DECREMENT:"decrement",SHOW_PRICE_GRAPH:"show-price-graph",SHOW_FINANCE_GRAPH:"show-finance-graph",TOGGLE_MARKET_CARD_VIEW:"toggle-market-card-view",TOGGLE_HANGAR_MODE:"toggle-hangar-mode",SET_HANGAR_PAGE:"set-hangar-page"}),N=Object.freeze({SCREEN_LOAD:"SCREEN_LOAD",ACTION:"ACTION",INFO:"INFO"}),_=Object.freeze({STARTING_CREDITS:5e3,STARTING_DEBT_INTEREST:125,REPAIR_COST_PER_HP:75,REPAIR_AMOUNT_PER_TICK:5,FUEL_SCALAR:3,INTEREST_INTERVAL:30,PASSIVE_REPAIR_RATE:.02,HULL_DECAY_PER_TRAVEL_DAY:1/7,SHIP_SELL_MODIFIER:.75,RARE_SHIP_CHANCE:.3,PRICE_HISTORY_LENGTH:65,FINANCE_HISTORY_LENGTH:10,DAILY_PRICE_VOLATILITY:.15,MEAN_REVERSION_STRENGTH:.07,MARKET_PRESSURE_DECAY:.7,LOAN_GARNISHMENT_DAYS:1095,LOAN_GARNISHMENT_PERCENT:.14,RANDOM_EVENT_CHANCE:.07}),pe=[{threshold:5e4,revealsTier:2},{threshold:45e4,revealsTier:3},{threshold:4e6,revealsTier:4},{threshold:35e6,revealsTier:5},{threshold:3e8,revealsTier:6},{threshold:25e8,revealsTier:7}],Te="orbitalTraderSave_v2";var Ie={START_YEAR:2140,START_DAY_OF_WEEK:1,DAYS_IN_MONTH:[31,28,31,30,31,30,31,31,30,31,30,31],MONTH_NAMES:["January","February","March","April","May","June","July","August","September","October","November","December"],DAY_NAMES:["Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"]},Fe={NEUTRAL:{name:"Neutral System",duration:28,description:"Standard space-faring conditions. Markets are operating under normal parameters.",modifiers:{}}},h={CONFIG:{INTEL_COST_PERCENTAGE:.2,INTEL_MIN_CREDITS:5e3,INTEL_CHANCE:.3,INTEL_DEMAND_MOD:1.8,INTEL_DEPRESSION_MOD:.5},SYSTEM_STATES:Fe,DATE_CONFIG:Ie,INTRO_SEQUENCE_V1:{modals:[{id:"lore_1",title:"Year 2140",description:'Humanity has expanded throughout the Solar System.<br><br> <span class="hl">Commerce</span> has thrived among the numerous colonies and stations longer than living memory.',buttonText:"Begin",contentClass:"text-center"},{id:"lore_2",title:"The Price of Freedom",description:"A dead-end job in the Belt pays the bills, but it does not offer the <b class='hl-green font-bold'>prosperity</b> that you dream of.<br><br>The <span class='hl'>Merchant's Guild</span> will fund your ambition, but their price is steep.<br><br>This is no simple loan; it's a bet on yourself and your future.",buttonText:"Apply for Loan",contentClass:"text-center",buttonClass:"btn-pulse-green"},{id:"charter",title:`<span class="hl">MERCHANT'S GUILD LOAN AGREEMENT</span>`,description:`
        ...
        <div id="ship-terminal-container" class="flex flex-col h-full ${n}">
            ...
            <div class="carousel-container flex-grow overflow-hidden relative">
                <div id="hangar-carousel" class="flex h-full" style="transform: translateX(-${c*100}%)">
                    ${r.map(u=>je(l,u,s)).join("")||Ve(s)}
                </div>
            </div>

            <div id="hangar-pagination" class="flex justify-center items-center p-2 space-x-2 flex-nowrap overflow-x-auto">
                ${r.map((u,d)=>`<div class="pagination-dot w-2 h-2 rounded-full bg-gray-600 transition-all duration-300 ${d===c?"active":""}" data-action="${S.SET_HANGAR_PAGE}" data-index="${d}"></div>`).join("")}
            </div>
        </div>
    ...
    `}function je(l,e,t){let i=h.SHIPS[e],a=t?l.player.shipStates[e]:null,{player:s}=l,n="";if(t){let c=s.activeShipId===e;n=`<div class="status-badge" style="border-color: ${c?"var(--theme-color-primary)":"var(--ot-border-light)"}; color: ${c?"var(--theme-color-primary)":"var(--ot-text-secondary)"};">${c?"ACTIVE":"STORED"}</div>`}let r=`
    ...
    `}function Me(l,e,t,i,a,s){let n=t.class.toLowerCase();return s?`
        ...
        `}function xe(l,e,t,i,a){if(i){let s=t.activeShipId===l,n=t.ownedShipIds.length>1&&!s,r=Math.floor(e.price*_.SHIP_SELL_MODIFIER);return`
        ...
        `}else{let s=t.credits>=e.price,n=a.activeBatchId?h.TUTORIAL_DATA[a.activeBatchId]?.steps.find(c=>c.stepId===a.activeStepId):null,r=a.activeBatchId==="intro_hangar"&&!n?.unlockPurchase,o=!s||r;return`
            <button class="action-button w-full justify-center" data-action="${S.BUY_SHIP}" data-ship-id="${l}" ${o?"disabled":""} style="background-color: var(--ot-green-accent);">
    ...
    `}function Re(l,e,t,i){return`<div class="scroll-panel">
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">${h.COMMODITIES.filter(n=>n.tier<=l.player.revealedTier).map(n=>Ke(n,l,t,i)).join("")}</div>
            </div>`}function Ke(l,e,t,i){let{player:a,market:s,currentLocationId:n,tutorials:r,uiState:o}=e,c=a.inventories[a.activeShipId]?.[l.id],u=t(e,l.id),d=t(e,l.id,!0),m=s.galacticAverages[l.id],p=s.inventory[n]?.[l.id],b=!l.licenseId||a.unlockedLicenseIds.includes(l.licenseId),E=r.activeBatchId==="intro_missions"&&r.activeStepId==="mission_2_2",C=r.activeBatchId==="intro_missions"&&r.activeStepId==="mission_2_3",L=E&&l.id!==y.PLASTEEL||C,M=`data-tooltip="${l.lore}"`,D=c&&c.quantity>0?c.quantity:"0",F=o.marketCardMinimized[l.id],R=U({price:u,sellPrice:d,galacticAvg:m,playerItem:c}),w=c&&c.quantity>0?`<div class="avg-cost-display" id="avg-cost-${l.id}">Avg. Cost: ${f(c.avgCost,!1)}</div>`:"",x;b?x=`
    ...
    <div class="item-card-container ${b?"":"locked"} ${F?"minimized":""}" id="item-card-container-${l.id}">
    ...
    </div>`}function Le(){return'<div id="map-container" class="w-full h-full"></div>'}function Ne(l){let e=d3.select("#map-container");if(!e.node()||!e.select("svg").empty())return;let t=e.append("svg").attr("id","map-svg").attr("width","100%").attr("height","100%"),a=t.append("defs").append("radialGradient").attr("id","sun-gradient");a.append("stop").attr("offset","0%").attr("stop-color","#fef08a"),a.append("stop").attr("offset","100%").attr("stop-color","#fde047"),t.append("circle").attr("class","sun").attr("cx","50%").attr("cy",-195).attr("r",225).attr("fill","url(#sun-gradient)"),t.append("line").attr("class","central-axis").attr("x1","50%").attr("y1",0).attr("x2","50%").attr("y2","100%");let s={[g.VENUS]:1.035,[g.EARTH]:1.035,[g.LUNA]:.805,[g.MARS]:.9775,[g.BELT]:.805,[g.EXCHANGE]:.805,[g.JUPITER]:1.564,[g.SATURN]:1.46625,[g.URANUS]:1.27075,[g.NEPTUNE]:1.27075,[g.KEPLER]:.8625,[g.PLUTO]:.92},n=h.MARKETS.filter(d=>l.lastKnownState.player.unlockedLocationIds.includes(d.id)).map(d=>{let p=(d.parent?8:12)*(s[d.id]||1),b=d.distance;if(d.parent){let E=h.MARKETS.find(C=>C.id===d.parent);E&&(b=E.distance+.1)}return{...d,effectiveDistance:b,finalRadius:p}}).sort((d,m)=>d.effectiveDistance-m.effectiveDistance),r=d3.scalePoint().domain(n.map(d=>d.id)).range([120,e.node().clientHeight-80]).padding(.1),o=e.node().clientWidth/2,c=t.selectAll(".poi-group").data(n).enter().append("g").attr("class","poi-group").attr("data-location-id",d=>d.id).on("click",(d,m)=>{l.showMapDetailModal(m.id)});c.filter(d=>d.id!==g.BELT).append("circle").attr("cx","50%").attr("cy",d=>r(d.id)).attr("r",d=>d.finalRadius).attr("fill",d=>d.navTheme.borderColor);let u=c.filter(d=>d.id===g.BELT);if(!u.empty()){let d=u.datum().finalRadius;u.append("path").attr("d",`M 0,${-d} L ${d},0 L 0,${d} L ${-d},0 Z`).attr("transform",m=>`translate(${o}, ${r(m.id)})`).attr("fill",m=>m.navTheme.borderColor)}c.append("line").attr("class","leader-line").attr("x1","50%").attr("y1",d=>r(d.id)).attr("x2",(d,m)=>o+(m%2===0?-46:46)).attr("y2",d=>r(d.id)),c.append("text").attr("class","poi-label").attr("x",(d,m)=>o+(m%2===0?-52:52)).attr("y",d=>r(d.id)).attr("text-anchor",(d,m)=>m%2===0?"end":"start").attr("dominant-baseline","middle").text(d=>d.name)}function ke(l){let{player:e,currentLocationId:t,TRAVEL_DATA:i,tutorials:a}=l,{navLock:s}=a,n=s&&s.screenId===v.NAVIGATION,r=n?s.enabledElementQuery:null;return`
        <div class="scroll-panel p-1">
            <div class="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-6">
            ${h.MARKETS.filter(o=>e.unlockedLocationIds.includes(o.id)).map(o=>{let c=o.id===t,u=c?null:i[t][o.id],d=!1;if(n&&r){let p=document.createElement("div");p.innerHTML=`<div data-location-id="${o.id}"></div>`,d=!p.querySelector(r)}let m=d?"disabled-location":"";return`<div class="location-card p-6 rounded-lg text-center flex flex-col ${c?"highlight-current":""} ${o.color} ${o.bg} ${m}" 
                                 data-action="show-launch-modal" data-location-id="${o.id}" ${d?"disabled":""}>
        ...
        </div>`}function we(l){let{player:e,currentLocationId:t}=l,i=h.SHIPS[e.activeShipId],a=e.shipStates[e.activeShipId],s=h.MARKETS.find(d=>d.id===t),n=s?.navTheme||{gradient:"linear-gradient(135deg, #4a5568, #2d3748)",textColor:"#f0f0f0",borderColor:"#7a9ac0"},r=s.fuelPrice/2;e.activePerks[T.VENETIAN_SYNDICATE]&&t===g.VENUS&&(r*=1-h.PERKS[T.VENETIAN_SYNDICATE].fuelDiscount);let o=i.maxHealth*(_.REPAIR_AMOUNT_PER_TICK/100)*_.REPAIR_COST_PER_HP;e.activePerks[T.VENETIAN_SYNDICATE]&&t===g.VENUS&&(o*=1-h.PERKS[T.VENETIAN_SYNDICATE].repairDiscount);let c=a.fuel/i.maxFuel*100,u=a.health/i.maxHealth*100;return`
        <div class="services-scroll-panel">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl mx-auto mt-8">
                ...
                <div class="p-4 rounded-lg text-center shadow-lg panel-border border" style="border-color: ${n.borderColor}; color: ${n.textColor}; background: ${n.gradient};">
                    ...
                    <p class="mb-3">Price: <span class="font-bold">\u232C ${f(o,!1)}</span> / 5% repair</p>
        ...
        </div>`}function Oe(l){let e=l.player.inventories[l.player.activeShipId];if(!e)return'<p class="text-center text-gray-500 text-lg">No active ship.</p>';let t=Object.entries(e).filter(([,a])=>a.quantity>0);return t.length===0?'<p class="text-center text-gray-500 text-lg">Your cargo hold is empty.</p>':`<div class="cargo-scroll-panel"><div class="cargo-grid">${t.map(([a,s])=>{let n=h.COMMODITIES.find(r=>r.id===a);return We(n,s)}).join("")}</div></div>`}function We(l,e){let t=q(l.styleClass);return`
    ...
    `}function $e(l,e){let{missions:t,currentLocationId:i}=l,{activeMissionId:a,activeMissionObjectivesMet:s}=t,n=(c,u)=>{let d="";u==="active"&&(d="mission-active"),u==="completed"&&(d="mission-complete"),u==="active"&&s&&c.completion.locationId===i&&(d+=" mission-turn-in");let m=`host-${c.host.toLowerCase().replace(/[^a-z0-9]/g,"")}`,p=c.rewards.map(b=>b.type==="credits"?`\u232C ${b.amount.toLocaleString()}`:b.type.toUpperCase()).join(", ");return`
            <div class="mission-card sci-fi-frame ${m} ${d}" data-action="show-mission-modal" data-mission-id="${c.id}">
            ...
            </div>`},r="",o=a?h.MISSIONS[a]:null;return o&&(r+=n(o,"active")),e&&e.getAvailableMissions().forEach(u=>{r+=n(u,"available")}),r===""&&(r='<p class="text-center text-gray-500 text-lg">No missions available at this terminal.</p>'),`
    ...
    `}function Pe(l){let{player:e,day:t,currentLocationId:i}=l,s=h.MARKETS.find(o=>o.id===i)?.navTheme||{gradient:"linear-gradient(135deg, #4a5568, #2d3748)",textColor:"#f0f0f0",borderColor:"#7a9ac0"},n;if(e.debt>0){let o="";if(e.loanStartDate){let c=_.LOAN_GARNISHMENT_DAYS-(t-e.loanStartDate);c>0&&(o=`<p class="text-xs text-red-400/70 mt-2">Garnishment in ${c} days</p>`)}n=`
            <div>
            ...
            </div>`}else{let o=Math.floor(e.credits*3.5),c=Math.floor(o*.1),u=Math.floor(o*.04),m=[{key:"10000",amount:1e4,fee:600,interest:500},{key:"dynamic",...{amount:o,fee:c,interest:u}}].map(p=>`<button class="btn btn-loan w-full p-2 mt-2" data-action="${S.TAKE_LOAN}" data-loan-details='${JSON.stringify(p)}' ${e.credits<p.fee?"disabled":""}>
            ...
            <div class="grid grid-cols-4 gap-2 p-2 border-b border-slate-700 text-sm">
                ...
                <span class="${c} text-right">${u}${f(o.amount,!1)}</span>
            </div>
        `}).join("");return`
    ...
    `}function He(){return`
        <div class="intel-scroll-panel">
            ...
            <div class="context-bar" style="background: ${E.gradient}; color: ${E.textColor};">
                ...
                </div>`}else{let u=a.shipStates[t],d=a.inventories[t],m=k(d),p=t===a.activeShipId,b=a.ownedShipIds.length>1&&!p,E=Math.floor(n.price*_.SHIP_SELL_MODIFIER);r=`
