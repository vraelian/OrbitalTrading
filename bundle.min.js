(()=>{var S=Object.freeze({STATUS:"status",NAVIGATION:"navigation",SERVICES:"services",MARKET:"market",CARGO:"cargo",HANGAR:"hangar",MISSIONS:"missions",FINANCE:"finance",INTEL:"intel"}),R=Object.freeze({SHIP:"ship",STARPORT:"starport",DATA:"data"}),A=Object.freeze({WANDERER:"starter",STALWART:"hauler_c1",MULE:"hauler_c2",PATHFINDER:"explorer_b1",NOMAD:"explorer_b2",VINDICATOR:"frigate_a1",AEGIS:"frigate_a2",ODYSSEY:"luxury_s1",MAJESTIC:"luxury_s2",TITAN_HAULER:"rare_s1",VOID_CHASER:"rare_s2",GUARDIAN:"rare_s3",STARGAZER:"rare_s4",BEHEMOTH:"rare_o1"}),L=Object.freeze({WATER_ICE:"water_ice",PLASTEEL:"plasteel",HYDROPONICS:"hydroponics",CYBERNETICS:"cybernetics",PROPELLANT:"propellant",PROCESSORS:"processors",GMO_SEEDS:"gmo_seeds",CRYO_PODS:"cryo_pods",ATMO_PROCESSORS:"atmos_processors",CLONED_ORGANS:"cloned_organs",XENO_GEOLOGICALS:"xeno_geologicals",SENTIENT_AI:"sentient_ai",ANTIMATTER:"antimatter",FOLDED_DRIVES:"folded_drives"}),y=Object.freeze({EARTH:"loc_earth",LUNA:"loc_luna",MARS:"loc_mars",VENUS:"loc_venus",BELT:"loc_belt",SATURN:"loc_saturn",JUPITER:"loc_jupiter",URANUS:"loc_uranus",NEPTUNE:"loc_neptune",PLUTO:"loc_pluto",EXCHANGE:"loc_exchange",KEPLER:"loc_kepler"}),M=Object.freeze({TRADEMASTER:"trademaster",NAVIGATOR:"navigator",VENETIAN_SYNDICATE:"venetian_syndicate",MERCHANT_GUILD_SHIP:"merchant_guild_ship"}),b=Object.freeze({SET_SCREEN:"set-screen",TRAVEL:"travel",BUY_SHIP:"buy-ship",SELL_SHIP:"sell-ship",SELECT_SHIP:"select-ship",PAY_DEBT:"pay-debt",TAKE_LOAN:"take-loan",PURCHASE_INTEL:"purchase-intel",ACQUIRE_LICENSE:"acquire-license",BUY_ITEM:"buy-item",SELL_ITEM:"sell-item",SET_MAX_BUY:"set-max-buy",SET_MAX_SELL:"set-max-sell",INCREMENT:"increment",DECREMENT:"decrement",SHOW_PRICE_GRAPH:"show-price-graph",SHOW_FINANCE_GRAPH:"show-finance-graph",TOGGLE_MARKET_CARD_VIEW:"toggle-market-card-view"}),D=Object.freeze({SCREEN_LOAD:"SCREEN_LOAD",ACTION:"ACTION",INFO:"INFO"}),k=Object.freeze({STARTING_CREDITS:5e3,STARTING_DEBT_INTEREST:125,REPAIR_COST_PER_HP:75,REPAIR_AMOUNT_PER_TICK:5,FUEL_SCALAR:3,INTEREST_INTERVAL:30,PASSIVE_REPAIR_RATE:.02,HULL_DECAY_PER_TRAVEL_DAY:1/7,SHIP_SELL_MODIFIER:.75,RARE_SHIP_CHANCE:.3,PRICE_HISTORY_LENGTH:65,FINANCE_HISTORY_LENGTH:10,DAILY_PRICE_VOLATILITY:.15,MEAN_REVERSION_STRENGTH:.07,MARKET_PRESSURE_DECAY:.7,LOAN_GARNISHMENT_DAYS:1095,LOAN_GARNISHMENT_PERCENT:.14,RANDOM_EVENT_CHANCE:.07}),ue=[{threshold:5e4,revealsTier:2},{threshold:45e4,revealsTier:3},{threshold:4e6,revealsTier:4},{threshold:35e6,revealsTier:5},{threshold:3e8,revealsTier:6},{threshold:25e8,revealsTier:7}];var ye="orbitalTraderSave_v2";var F={START_YEAR:2140,START_DAY_OF_WEEK:1,DAYS_IN_MONTH:[31,28,31,30,31,30,31,31,30,31,30,31],MONTH_NAMES:["January","February","March","April","May","June","July","August","September","October","November","December"],DAY_NAMES:["Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"]},Le={NEUTRAL:{name:"Neutral System",duration:28,description:"Standard space-faring conditions. Markets are operating under normal parameters.",modifiers:{}}},d={CONFIG:{INTEL_COST_PERCENTAGE:.2,INTEL_MIN_CREDITS:5e3,INTEL_CHANCE:.3,INTEL_DEMAND_MOD:1.8,INTEL_DEPRESSION_MOD:.5},SYSTEM_STATES:Le,DATE_CONFIG:F,INTRO_SEQUENCE_V1:{modals:[{id:"lore_1",title:"Year 2140",description:'Humanity has expanded throughout the Solar System.<br><br> <span class="hl">Commerce</span> has thrived among the numerous colonies and stations longer than living memory.',buttonText:"Begin",contentClass:"text-center"},{id:"lore_2",title:"The Price of Freedom",description:"A dead-end job in the Belt pays the bills, but it does not offer the <b class='hl-green font-bold'>prosperity</b> that you dream of.<br><br>The <span class='hl'>Merchant's Guild</span> will fund your ambition, but their price is steep.<br><br>This is no simple loan; it's a bet on yourself and your future.",buttonText:"Apply for Loan",contentClass:"text-center",buttonClass:"btn-pulse-green"},{id:"charter",title:`<span class="hl">MERCHANT'S GUILD LOAN AGREEMENT</span>`,description:`
    ...
    `};function Ee(c){let{player:e}=c,t=Pe(c),i=t.length>0?t.map(([s])=>Ie(c,s,"shipyard")).join(""):'<p class="text-center text-gray-500 text-sm p-4">No new ships available at this location.</p>',a=e.ownedShipIds.length>0?e.ownedShipIds.map(s=>Ie(c,s,"hangar")).join(""):'<p class="text-center text-gray-500 text-sm p-4">Your hangar is empty.</p>';return`
        ...
        </div>`}function Ie(c,e,t){let{player:i,tutorials:a}=c,s=d.SHIPS[e],o=s.class.toLowerCase(),r=`
        <div class="ship-info">
            <span class="ship-name class-${o}">${s.name}</span>
            <span class="ship-class">Class ${s.class}</span>
        </div>`,n="",l="",h="",u=`ship-bar-wrapper bg-class-${o} class-${o}`;if(t==="shipyard"){let m=i.credits>=s.price,p=a.activeBatchId==="intro_hangar"&&a.activeStepId==="hangar_1";(!m||p)&&(u+=" opacity-60 pointer-events-none"),n=`<div class="ship-price">${g(s.price)}</div>`}else{let m=i.shipStates[e],p=i.inventories[e],f=O(p),T=f/s.cargoCapacity*100,E=Math.floor(m.health/s.maxHealth*100),x=Math.floor(m.fuel/s.maxFuel*100),_=e===i.activeShipId;h=`<div class="status-sidelabel ${_?"sidelabel-active":"sidelabel-stored"}">${_?"ACTIVE":"STORED"}</div>`,n=`
        ...
        <div class="${u}" data-action="show-ship-detail" data-ship-id="${e}" data-context="${t}">
        ...
        </div>`}function Pe(c){let{player:e,currentLocationId:t,market:i,introSequenceActive:a}=c;return a?e.ownedShipIds.length>0?[]:[A.WANDERER,A.STALWART,A.MULE].map(o=>[o,d.SHIPS[o]]):(i.shipyardStock[t]?.shipsForSale||[]).map(o=>[o,d.SHIPS[o]]).filter(([o,r])=>!e.ownedShipIds.includes(o))}function me(c,e,t,i){return`<div class="grid grid-cols-1 lg:grid-cols-2 gap-4">${d.COMMODITIES.filter(o=>o.tier<=c.player.revealedTier).map(o=>De(o,c,t,i)).join("")}</div>`}function De(c,e,t,i){let{player:a,market:s,currentLocationId:o,tutorials:r,uiState:n}=e,l=a.inventories[a.activeShipId]?.[c.id],h=t(e,c.id),u=t(e,c.id,!0),m=s.galacticAverages[c.id],p=s.inventory[o]?.[c.id],f=!c.licenseId||a.unlockedLicenseIds.includes(c.licenseId),T=r.activeBatchId==="intro_missions"&&r.activeStepId==="mission_2_2",E=r.activeBatchId==="intro_missions"&&r.activeStepId==="mission_2_3",x=T&&c.id!==L.PLASTEEL||E,_=`data-tooltip="${c.lore}"`,N=l&&l.quantity>0?l.quantity:"0",B=n.marketCardMinimized[c.id],v=z({price:h,sellPrice:u,galacticAvg:m,playerItem:l}),C=l&&l.quantity>0?`<div class="avg-cost-display" id="avg-cost-${c.id}">Avg. Cost: ${g(l.avgCost,!1)}</div>`:"",I;f?I=`
            ...
            </div>`;let w=l?.quantity>0?` (${l.quantity})`:"";return`
    <div class="item-card-container ${f?"":"locked"} ${B?"minimized":""}" id="item-card-container-${c.id}">
        <div class="rounded-lg border ${c.styleClass} transition-colors shadow-md">
            ...
            <div class="max-view-content">
                ...
                <p class="avail-text">Avail: <span id="m-stock-${c.id}">${p.quantity}</span>, Own: <span id="p-inv-${c.id}">${N}</span></p>
        ...
        <div class="ship-bar-wrapper bg-class-${h} class-${h}" style="cursor: default;">
            ...
            <div class="main-content">
                ...
                <div class="bottom-line">
                    ...
                    <div class="cargo-text">CARGO: <span class="value">${r}/${a.cargoCapacity}</span></div>
                </div>
            </div>
        </div>
    `;return`
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 bg-black/30 p-4 rounded-lg mb-6 items-start">
            <div class="md:col-span-2 h-full p-4 rounded-lg flex items-center justify-between transition-all duration-500 panel-border border" style="border-color: ${l.borderColor}; color: ${l.textColor}; background: ${l.gradient};">
                ...
                <div class="text-right flex flex-col items-end">
                    <p class="text-xs font-roboto-mono text-right" style="color: ${l.textColor}cc;">${Se(t)}</p>
        ...
        </div>`}function Me(c){let{player:e,currentLocationId:t,TRAVEL_DATA:i,tutorials:a}=c,{navLock:s}=a,o=s&&s.screenId===S.NAVIGATION,r=o?s.enabledElementQuery:null;return`
        <div class="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-6">
        ${d.MARKETS.filter(n=>e.unlockedLocationIds.includes(n.id)).map(n=>{let l=n.id===t,h=l?null:i[t][n.id],u=!1;if(o&&r){let p=document.createElement("div");p.innerHTML=`<div data-location-id="${n.id}"></div>`,u=!p.querySelector(r)}let m=u?"disabled-location":"";return`<div class="location-card p-6 rounded-lg text-center flex flex-col ${l?"highlight-current":""} ${n.color} ${n.bg} ${m}" 
        ...
        </div>`}function _e(c){let{player:e,currentLocationId:t}=c,i=d.SHIPS[e.activeShipId],a=e.shipStates[e.activeShipId],s=d.MARKETS.find(u=>u.id===t),o=s?.navTheme||{gradient:"linear-gradient(135deg, #4a5568, #2d3748)",textColor:"#f0f0f0",borderColor:"#7a9ac0"},r=s.fuelPrice/2;e.activePerks[M.VENETIAN_SYNDICATE]&&t===y.VENUS&&(r*=1-d.PERKS[M.VENETIAN_SYNDICATE].fuelDiscount);let n=i.maxHealth*(k.REPAIR_AMOUNT_PER_TICK/100)*k.REPAIR_COST_PER_HP;e.activePerks[M.VENETIAN_SYNDICATE]&&t===y.VENUS&&(n*=1-d.PERKS[M.VENETIAN_SYNDICATE].repairDiscount);let l=a.fuel/i.maxFuel*100,h=a.health/i.maxHealth*100;return`
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl mx-auto mt-8">
            <div class="p-4 rounded-lg text-center shadow-lg panel-border border" style="border-color: ${o.borderColor}; color: ${o.textColor}; background: ${o.gradient};">
                ...
                <p class="mb-3">Price: <span class="font-bold">\u232C ${g(r,!1)}</span> / 5 units</p>
...
Avg. Cost: ${g(n.avgCost,!1)}`;return`
        ...
        <div class="mt-4">
            ...
            </div>`},r="",n=a?d.MISSIONS[a]:null;return n&&(r+=o(n,"active")),e&&e.getAvailableMissions().forEach(h=>{r+=o(h,"available")}),r===""&&(r='<p class="text-center text-gray-500 text-lg">No missions available at this terminal.</p>'),`
        <h1 class="text-3xl font-orbitron text-center mb-6 text-cyan-300">Mission Terminal</h1>
        <div class="space-y-3 max-w-2xl mx-auto">
            ${r}
        </div>
    `}function Re(c){let{player:e,day:t,currentLocationId:i}=c,s=d.MARKETS.find(n=>n.id===i)?.navTheme||{gradient:"linear-gradient(135deg, #4a5568, #2d3748)",textColor:"#f0f0f0",borderColor:"#7a9ac0"},o;if(e.debt>0){let n="";if(e.loanStartDate){let l=k.LOAN_GARNISHMENT_DAYS-(t-e.loanStartDate);l>0&&(n=`<p class="text-xs text-red-400/70 mt-2">Garnishment in ${l} days</p>`)}o=`
            <div>
            ...
            </div>`}else{let n=Math.floor(e.credits*3.5),l=Math.floor(n*.1),h=Math.floor(n*.04),m=[{key:"10000",amount:1e4,fee:600,interest:500},{key:"dynamic",...{amount:n,fee:l,interest:h}}].map(p=>`<button class="btn btn-loan w-full p-2 mt-2" data-action="${b.TAKE_LOAN}" data-loan-details='${JSON.stringify(p)}' ${e.credits<p.fee?"disabled":""}>
            ...
            <div class="grid grid-cols-4 gap-2 p-2 border-b border-slate-700 text-sm">
                ...
                <span class="${l} text-right">${h}${g(n.amount,!1)}</span>
            </div>
        `}).join("");return`
    ...
    `}function ke(){return`
        <div class="text-center p-8 flex flex-col items-center gap-4">
            ...
            <div class="context-bar" style="background: ${T.gradient}; color: ${T.textColor};">
            ...
            </div>`,x=Object.keys(this.navStructure).map(v=>{let C=v===a,I=o[v]||Object.keys(this.navStructure[v].screens)[0],w=h&&h.navId!==v,$=r||w,P=C?`background: ${T.gradient}; color: ${T.textColor};`:"";return`<div class="tab ${v}-tab ${C?"active":""} ${$?"disabled":""}" style="${P}" data-action="${b.SET_SCREEN}" data-nav-id="${v}" data-screen-id="${I}">${this.navStructure[v].label}</div>`}).join(""),_="";if(m&&p&&f){let v=O(f),C=p.health/m.maxHealth*100,I=p.fuel/m.maxFuel*100,w=v/m.cargoCapacity*100;_=`
                <div class="status-pod">
                    ...
                    <div class="status-bar-group cargo-group" data-action="toggle-tooltip">
                        ...
                        <div class="status-tooltip">${v}/${m.cargoCapacity} Cargo</div>
                    </div>
                </div>`}let N=`<div class="nav-wrapper">${x}${_}</div>`,B=Object.keys(this.navStructure).map(v=>{let C=this.navStructure[v].screens,I=v===a,w=Object.keys(C).map($=>{let P=h&&h.screenId!==$,q=$===s,H=r||P,j=`style="color: ${T.textColor};"`;return q&&(j=`style="background: ${T.gradient}; color: ${T.textColor}; opacity: 1; font-weight: 700;"`),`<a href="#" class="${H?"disabled":""}" ${j} data-action="${b.SET_SCREEN}" data-nav-id="${v}" data-screen-id="${$}" draggable="false">${C[$]}</a>`}).join("");return`<div class="nav-sub ${!I||l?"hidden":""}" id="${v}-sub">${w}</div>`}).join("");this.cache.navBar.innerHTML=E+N,this.cache.subNavBar.innerHTML=B}renderActiveScreen(e){let t=this.cache[`${e.activeScreen}Screen`];switch(this.lastActiveScreenEl&&this.lastActiveScreenEl!==t&&(this.lastActiveScreenEl.style.display="none"),t&&(t.style.display="block",this.lastActiveScreenEl=t),e.activeScreen){case S.STATUS:this.cache.statusScreen.innerHTML=Ae(e);break;case S.NAVIGATION:this.cache.navigationScreen.innerHTML=Me(e);break;case S.SERVICES:this.cache.servicesScreen.innerHTML=_e(e);break;case S.MARKET:this._saveMarketTransactionState(),this.cache.marketScreen.innerHTML=me(e,this.isMobile,this.getItemPrice,this.marketTransactionState),this._restoreMarketTransactionState();break;case S.CARGO:this.cache.cargoScreen.innerHTML=xe(e);break;case S.HANGAR:this.cache.hangarScreen.innerHTML=Ee(e,this.isMobile);break;case S.MISSIONS:this.cache.missionsScreen.innerHTML=Ce(e,this.missionService);break;case S.FINANCE:this.cache.financeScreen.innerHTML=Re(e);break;case S.INTEL:this.cache.intelScreen.innerHTML=ke();break}}updateStickyBar(e){this.cache.stickyBar.innerHTML="",this.cache.topBarContainer.classList.remove("has-sticky-bar")}updateServicesScreen(e){if(e.activeScreen!==S.SERVICES)return;let{player:t}=e,i=d.SHIPS[t.activeShipId],a=t.shipStates[t.activeShipId],s=this.cache.servicesScreen.querySelector("#fuel-bar"),o=this.cache.servicesScreen.querySelector("#refuel-btn");if(s&&o){let l=a.fuel/i.maxFuel*100;s.style.width=`${l}%`,o.disabled=a.fuel>=i.maxFuel}let r=this.cache.servicesScreen.querySelector("#repair-bar"),n=this.cache.servicesScreen.querySelector("#repair-btn");if(r&&n){let l=a.health/i.maxHealth*100;r.style.width=`${l}%`,n.disabled=a.health>=i.maxHealth}}updateMarketScreen(e){e.activeScreen===S.MARKET&&(this._saveMarketTransactionState(),this.cache.marketScreen.innerHTML=me(e,this.isMobile,this.getItemPrice,this.marketTransactionState),this._restoreMarketTransactionState())}_saveMarketTransactionState(){if(!this.lastKnownState||this.lastKnownState.activeScreen!==S.MARKET)return;this.cache.marketScreen.querySelectorAll(".transaction-controls").forEach(t=>{let i=t.dataset.goodId,a=t.querySelector("input"),s=t.dataset.mode;a&&(this.marketTransactionState[i]={quantity:a.value,mode:s})})}_restoreMarketTransactionState(){for(let e in this.marketTransactionState){let t=this.marketTransactionState[e],i=this.cache.marketScreen.querySelector(`.transaction-controls[data-good-id="${e}"]`);if(i){let a=i.querySelector("input");a&&(a.value=t.quantity,i.setAttribute("data-mode",t.mode),this.updateMarketCardDisplay(e,parseInt(t.quantity,10)||0,t.mode))}}}getItemPrice(e,t,i=!1){let a=e.market.prices[e.currentLocationId][t],s=d.MARKETS.find(r=>r.id===e.currentLocationId);i&&s.specialDemand&&s.specialDemand[t]&&(a*=s.specialDemand[t].bonus);let o=e.intel.active;return o&&o.targetMarketId===e.currentLocationId&&o.commodityId===t&&(a*=o.type==="demand"?d.CONFIG.INTEL_DEMAND_MOD:d.CONFIG.INTEL_DEPRESSION_MOD),Math.max(1,Math.round(a))}_calculateSaleDetails(e,t){let i=this.lastKnownState;if(!i)return{totalPrice:0,effectivePricePerUnit:0,netProfit:0};let a=d.COMMODITIES.find(E=>E.id===e),s=i.market.inventory[i.currentLocationId][e].quantity,o=this.getItemPrice(i,e,!0),n=i.player.inventories[i.player.activeShipId]?.[e]?.avgCost||0;if(s<=0)return{totalPrice:0,effectivePricePerUnit:0,netProfit:0};let l=s*.1;if(t<=l){let E=o*t,x=n*t,_=E-x;if(_>0){let N=(i.player.activePerks[M.TRADEMASTER]?d.PERKS[M.TRADEMASTER].profitBonus:0)+(i.player.birthdayProfitBonus||0);_+=_*N}return{totalPrice:E,effectivePricePerUnit:o,netProfit:_}}let h=t/s,u=0;a.tier<=2?u=Math.min(.1,(h-.1)*.2):a.tier<=5?u=Math.min(.25,(h-.1)*.5):u=Math.min(.4,(h-.1)*.8);let m=o*(1-u),p=Math.floor(m*t),f=n*t,T=p-f;if(T>0){let E=(i.player.activePerks[M.TRADEMASTER]?d.PERKS[M.TRADEMASTER].profitBonus:0)+(i.player.birthdayProfitBonus||0);T+=T*E}return{totalPrice:p,effectivePricePerUnit:m,netProfit:T}}updateMarketCardPrice(e,t){let i=this.cache.marketScreen.querySelector(`#price-display-${e}`);if(i){i.dataset.basePrice=t;let a=i.closest(".item-card-container").querySelector(".transaction-controls");a&&a.dataset.mode==="buy"&&(i.textContent=g(t))}}updateMarketCardDisplay(e,t,i){let a=this.cache.marketScreen.querySelector(`#price-display-${e}`),s=this.cache.marketScreen.querySelector(`#effective-price-display-${e}`),o=this.cache.marketScreen.querySelector(`#indicators-${e}`),r=this.cache.marketScreen.querySelector(`#avg-cost-${e}`);if(!a||!s||!o||!this.lastKnownState)return;let n=this.lastKnownState,l=parseInt(a.dataset.basePrice,10),h=n.player.inventories[n.player.activeShipId]?.[e];if(r&&r.classList.toggle("visible",i==="sell"),i==="buy")a.textContent=g(l),a.className="font-roboto-mono font-bold price-text",s.textContent="",o.innerHTML=z({price:l,sellPrice:this.getItemPrice(n,e,!0),galacticAvg:n.market.galacticAverages[e],playerItem:h});else{let{effectivePricePerUnit:u,netProfit:m}=this._calculateSaleDetails(e,t);if(t>0){let p=`\u232C ${m>=0?"+":""}${g(m,!1)}`;a.textContent=p,s.textContent=`(${g(u,!1)}/unit)`,a.className=`font-roboto-mono font-bold ${m>=0?"profit-text":"loss-text"}`}else a.textContent="\u232C +0",a.className="font-roboto-mono font-bold profit-text",s.textContent="";o.innerHTML=z({price:l,sellPrice:u||this.getItemPrice(n,e,!0),galacticAvg:n.market.galacticAverages[e],playerItem:h})}}showTravelAnimation(e,t,i,a,s){let o=document.getElementById("travel-animation-modal"),r=document.getElementById("travel-status-text"),n=document.getElementById("travel-arrival-lore"),l=document.getElementById("travel-canvas"),h=l.getContext("2d"),u=document.getElementById("travel-progress-container"),m=document.getElementById("travel-progress-bar"),p=document.getElementById("travel-readout-container"),f=document.getElementById("travel-info-text"),T=document.getElementById("travel-hull-damage"),E=document.getElementById("travel-confirm-button"),x=null;r.textContent=`Traveling to ${t.name}...`,n.textContent="",n.style.opacity=0,p.classList.add("hidden"),p.style.opacity=0,E.classList.add("hidden"),E.style.opacity=0,u.classList.remove("hidden"),m.style.width="0%",o.classList.remove("hidden");let _=2500,N=null,B=d.LOCATION_VISUALS[e.id]||"\u2753",v=d.LOCATION_VISUALS[t.id]||"\u2753",C="\u{1F680}",I=[],w=150;l.width=l.clientWidth,l.height=l.clientHeight;for(let P=0;P<w;P++)I.push({x:Math.random()*l.width,y:Math.random()*l.height,radius:Math.random()*1.5,speed:.2+Math.random()*.8,alpha:.5+Math.random()*.5});let $=P=>{N||(N=P);let q=P-N,H=Math.min(q/_,1);H=1-Math.pow(1-H,3),l.width=l.clientWidth,l.height=l.clientHeight,h.clearRect(0,0,l.width,l.height),h.fillStyle="#FFF";for(let he=0;he<w;he++){let U=I[he];H<1&&(U.x-=U.speed,U.x<0&&(U.x=l.width)),h.beginPath(),h.arc(U.x,U.y,U.radius,0,Math.PI*2),h.globalAlpha=U.alpha,h.fill()}h.globalAlpha=1;let j=60,W=j,fe=l.width-j,de=l.height/2;h.font="42px sans-serif",h.textAlign="center",h.textBaseline="middle",h.fillText(B,W,de),h.fillText(v,fe,de);let Ne=W+(fe-W)*H;h.save(),h.translate(Ne,de),h.font="17px sans-serif",h.fillText(C,0,0),h.restore(),m.style.width=`${H*100}%`,H<1?x=requestAnimationFrame($):(r.textContent=`Arrived at ${t.name}`,n.innerHTML=t.arrivalLore||"You have arrived.",f.innerHTML=`
                ...
                <div class="ship-card p-4 flex flex-col space-y-3">
                    ...
                    <button class="btn w-full mt-2" data-action="${b.BUY_SHIP}" data-ship-id="${t}" ${m?"disabled":""}>Purchase</button>
                </div>`}else{let h=a.shipStates[t],u=a.inventories[t],m=O(u),p=t===a.activeShipId,f=a.ownedShipIds.length>1&&!p,T=Math.floor(o.price*k.SHIP_SELL_MODIFIER);r=`
                <div class="ship-card p-4 flex flex-col space-y-3 ${p?"border-yellow-400":""}">
                    ...
                    <div class="grid grid-cols-2 gap-2 mt-2">
                        ${p?'<button class="btn" disabled>ACTIVE</button>':`<button class="btn" data-action="${b.SELECT_SHIP}" data-ship-id="${t}">Board</button>`}
                        <button class="btn" data-action="${b.SELL_SHIP}" data-ship-id="${t}" ${f?"":"disabled"}>Sell<br>\u232C ${g(T,!1)}</button>
                    </div>
                </div>`}let n=this.cache.shipDetailModal,l=n.querySelector("#ship-detail-content");l.innerHTML=r,n.classList.remove("hidden"),n.classList.add("modal-visible")}showLaunchModal(e){let t=this.lastKnownState;if(!t)return;let i=d.MARKETS.find(f=>f.id===e);if(!i)return;let a=i.navTheme,s=t.TRAVEL_DATA[t.currentLocationId]?.[e],o=t.player.shipStates[t.player.activeShipId];if(!s)return;let r={water_ice:"RAW",plasteel:"IND",hydroponics:"AGRI",cybernetics:"TECH",propellant:"IND",processors:"TECH",gmo_seeds:"AGRI",cryo_pods:"CIV",atmos_processors:"IND",cloned_organs:"BIO",xeno_geologicals:"RAW",sentient_ai:"TECH",antimatter:"RARE",folded_drives:"RARE"},n=[],l=[];for(let f in i.availabilityModifier){let T=i.availabilityModifier[f],E=r[f];T<1&&!n.includes(E)?n.push(E):T>1&&!l.includes(E)&&l.push(E)}let h="";n.length>0&&(h+=`<p><b style="color: ${a.textColor};">Imports:</b> ${n.join(", ")}</p>`),l.length>0&&(h+=`<p><b style="color: ${a.textColor};">Exports:</b> ${l.join(", ")}</p>`),h===""&&(h="<p>Market data is unreliable.</p>");let u=`
