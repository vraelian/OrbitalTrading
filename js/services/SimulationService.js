...
export class SimulationService {
    ...
    payOffDebt() {
        ...
        this.gameState.setState({});
        this.uiManager.updateStickyBar(this.gameState.getState());
        this.uiManager.renderFinanceScreen(this.gameState.getState()); // Re-render the finance screen
    }
    ...
    showIntroSequence() {
        ...
        You've acquired a used C-Class freighter, the <span class="hl">${starterShip.name}</span>, with <span class="hl-blue">⌬ ${GAME_RULES.STARTING_CREDITS.toLocaleString()}</span> in starting capital. <div class="my-3 border-t-2 border-cyan-600/40"></div>
